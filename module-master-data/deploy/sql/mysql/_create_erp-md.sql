...
CREATE TABLE erp_md_material_category(
  ...
  PRICE_VALIDATION_LEVEL VARCHAR(20) default 'WARN'  NULL    COMMENT '价格校验级别',
...
CREATE TABLE erp_md_tax_rate(
  ...
  TAX_TYPE VARCHAR(20) NOT NULL    COMMENT '税种',
...
CREATE TABLE erp_md_partner(
  ...
  CODE VARCHAR(50) NOT NULL    COMMENT '编码',
  NAME VARCHAR(200) NOT NULL    COMMENT '名称',
  PARTNER_TYPE VARCHAR(20) NOT NULL    COMMENT '类型',
  STATUS VARCHAR(20) NOT NULL    COMMENT '状态',
  ...
  CUSTOMER_GROUP VARCHAR(100) NULL    COMMENT '客户组',
...
CREATE TABLE erp_md_settlement_method(
  ...
  CODE VARCHAR(50) NOT NULL    COMMENT '编码',
  NAME VARCHAR(200) NOT NULL    COMMENT '名称',
  SETTLEMENT_TYPE VARCHAR(20) NOT NULL    COMMENT '结算类型',
...
CREATE TABLE erp_md_subject(
  ...
  SUBJECT_CLASS VARCHAR(20) NOT NULL    COMMENT '科目类别',
  DIRECTION VARCHAR(20) NOT NULL    COMMENT '余额方向',
  BALANCE_TYPE VARCHAR(20) NULL    COMMENT '余额类型',
  ...
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  CASH_FLOW_TYPE VARCHAR(20) NULL    COMMENT '现金流分类',
...
CREATE TABLE erp_md_acct_schema(
  ...
  NATURE VARCHAR(20) NOT NULL    COMMENT '账套性质',
  FUNCTIONAL_CURRENCY_ID BIGINT NOT NULL    COMMENT '本位币',
  COSTING_METHOD VARCHAR(20) NULL    COMMENT '默认成本方法',
...
CREATE TABLE erp_md_material(
  ...
  MATERIAL_TYPE VARCHAR(20) NOT NULL    COMMENT '物料类型',
  CATEGORY_ID BIGINT NULL    COMMENT '分类ID',
  UOM_ID BIGINT NOT NULL    COMMENT '主计量单位',
  STATUS VARCHAR(20) NOT NULL    COMMENT '状态',
  COST_METHOD VARCHAR(20) NULL    COMMENT '存货计价方法',
  ...
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  VAT_RATE DECIMAL(6,4) NULL    COMMENT '增值税率(报关快查)',
  DRAWBACK_RATE DECIMAL(6,4) NULL    COMMENT '退税率(报关快查)',
  CUSTOMS_HS VARCHAR(12) NULL    COMMENT '海关HS编码',
  COUNTRY_OF_ORIGIN VARCHAR(2) NULL    COMMENT '原产地',
  PREFERENCE_CODE VARCHAR(20) NULL    COMMENT '优惠协定代码',
  CUSTOMS_NAME_CN VARCHAR(200) NULL    COMMENT '报关中文名',
  CUSTOMS_NAME_EN VARCHAR(200) NULL    COMMENT '报关英文名',
  DECLARATION_UNIT VARCHAR(20) NULL    COMMENT '申报计量单位',
  SUPERVISION_CONDITION VARCHAR(10) NULL    COMMENT '监管条件代码',
...
CREATE TABLE erp_md_material_customs(
  ID BIGINT NOT NULL    COMMENT 'ID',
  CODE VARCHAR(50) NOT NULL    COMMENT '报关记录编码',
  MATERIAL_ID BIGINT NOT NULL    COMMENT '物料',
  DECLARATION_NO VARCHAR(50) NOT NULL    COMMENT '报关单号',
  PARTNER_ID BIGINT NULL    COMMENT '报关行',
  DECLARATION_DATE DATE NOT NULL    COMMENT '报关日期',
  QTY_DECLARED DECIMAL(20,4) NOT NULL    COMMENT '申报数量',
  UOM_DECLARED VARCHAR(20) NOT NULL    COMMENT '申报计量单位',
  AMOUNT_DECLARED DECIMAL(18,2) NOT NULL    COMMENT '申报金额',
  CURRENCY_ID BIGINT NULL    COMMENT '申报币种',
  EXCHANGE_RATE DECIMAL(20,8) NULL    COMMENT '报关日汇率',
  AMOUNT_FUNCTIONAL DECIMAL(18,2) NULL    COMMENT '本位币金额',
  DUTY_AMOUNT DECIMAL(18,2) NULL    COMMENT '关税金额',
  VAT_AMOUNT DECIMAL(18,2) NULL    COMMENT '增值税金额',
  DRAWBACK_RECEIPT_NO VARCHAR(50) NULL    COMMENT '退税收据号',
  SOURCE_BILL_TYPE VARCHAR(50) NULL    COMMENT '业务单据类型',
  SOURCE_BILL_CODE VARCHAR(50) NULL    COMMENT '业务单据编码',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE erp_md_uom_conversion(
  ...
  constraint PK_erp_md_uom_conversion primary key (ID)
   ...
   ALTER TABLE erp_md_material_customs COMMENT '物料报关记录';
