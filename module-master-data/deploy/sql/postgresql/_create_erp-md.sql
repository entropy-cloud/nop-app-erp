...
CREATE TABLE erp_md_material_category(
  ...
  parent_id INT8  ,
  sort_num INT4  ,
  price_validation_level INT4 default 20   ,
...
CREATE TABLE erp_md_supplier_approval(
  ...
  status INT4 default 10  NOT NULL ,
