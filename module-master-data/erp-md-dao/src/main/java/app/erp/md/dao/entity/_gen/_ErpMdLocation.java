...
public class _ErpMdLocation extends DynamicOrmEntity{
    ...
    public _ErpMdLocation(){
        // for debug
    }

    protected ErpMdLocation newInstance(){
        ErpMdLocation entity = new ErpMdLocation();
    ...
    @Override
    public ErpMdLocation cloneInstance() {
        ErpMdLocation entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdLocation";
    }
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdLocation getParent(){
       return (app.erp.md.dao.entity.ErpMdLocation)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.md.dao.entity.ErpMdLocation refEntity){
