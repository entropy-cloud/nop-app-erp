...
/**
 *  成本中心: erp_md_cost_center
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdCostCenter extends DynamicOrmEntity{
    ...
    public _ErpMdCostCenter(){
        // for debug
    }

    protected ErpMdCostCenter newInstance(){
        ErpMdCostCenter entity = new ErpMdCostCenter();
    ...
    @Override
    public ErpMdCostCenter cloneInstance() {
        ErpMdCostCenter entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdCostCenter";
    }
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdEmployee getManager(){
       return (app.erp.md.dao.entity.ErpMdEmployee)internalGetRefEntity(PROP_NAME_manager);
    }

    public final void setManager(app.erp.md.dao.entity.ErpMdEmployee refEntity){
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdCostCenter getParent(){
       return (app.erp.md.dao.entity.ErpMdCostCenter)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.md.dao.entity.ErpMdCostCenter refEntity){
    ...
    private final OrmEntitySet<app.erp.md.dao.entity.ErpMdCostCenter> _children = new OrmEntitySet<>(this, PROP_NAME_children,
        null, null,app.erp.md.dao.entity.ErpMdCostCenter.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.md.dao.entity.ErpMdCostCenter> getChildren(){
       return _children;
    }
