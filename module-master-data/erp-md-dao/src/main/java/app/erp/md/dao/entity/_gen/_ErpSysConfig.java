...
public class _ErpSysConfig extends DynamicOrmEntity{
    ...
    public _ErpSysConfig(){
        // for debug
    }

    protected ErpSysConfig newInstance(){
        ErpSysConfig entity = new ErpSysConfig();
    ...
    @Override
    public ErpSysConfig cloneInstance() {
        ErpSysConfig entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpSysConfig";
    }
