...
public class _ErpMdEmployee extends DynamicOrmEntity{
    ...
    public _ErpMdEmployee(){
        // for debug
    }

    protected ErpMdEmployee newInstance(){
        ErpMdEmployee entity = new ErpMdEmployee();
    ...
    @Override
    public ErpMdEmployee cloneInstance() {
        ErpMdEmployee entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdEmployee";
    }
