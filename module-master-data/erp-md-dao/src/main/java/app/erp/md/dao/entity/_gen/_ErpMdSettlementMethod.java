...
/**
 *  结算方式: erp_md_settlement_method
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdSettlementMethod extends DynamicOrmEntity{
    ...
    /* 默认资金账户: DEFAULT_FUND_ACCOUNT_ID BIGINT */
    public static final String PROP_NAME_defaultFundAccountId = "defaultFundAccountId";
    public static final int PROP_ID_defaultFundAccountId = 5;
    
    /* 默认账期(天): DEFAULT_DAYS INTEGER */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_defaultFundAccountId] = PROP_NAME_defaultFundAccountId;
          PROP_NAME_TO_ID.put(PROP_NAME_defaultFundAccountId, PROP_ID_defaultFundAccountId);
      
          PROP_ID_TO_NAME[PROP_ID_defaultDays] = PROP_NAME_defaultDays;
          PROP_NAME_TO_ID.put(PROP_NAME_defaultDays, PROP_ID_defaultDays);
    ...
    public _ErpMdSettlementMethod(){
        // for debug
    }

    protected ErpMdSettlementMethod newInstance(){
        ErpMdSettlementMethod entity = new ErpMdSettlementMethod();
    ...
    @Override
    public ErpMdSettlementMethod cloneInstance() {
        ErpMdSettlementMethod entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdSettlementMethod";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_defaultFundAccountId:
               return getDefaultFundAccountId();
        
            case PROP_ID_defaultDays:
            ...
            case PROP_ID_defaultDays:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_defaultDays));
               }
               setDefaultDays(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_defaultDays:{
               onInitProp(propId);
               this._defaultDays = (java.lang.Integer)value;
     ...
     * 默认账期(天): DEFAULT_DAYS
     */
    public final java.lang.Integer getDefaultDays(){
         onPropGet(PROP_ID_defaultDays);
         return _defaultDays;
    }
     ...
     * 默认账期(天): DEFAULT_DAYS
     */
    public final void setDefaultDays(java.lang.Integer value){
        if(onPropSet(PROP_ID_defaultDays,value)){
            this._defaultDays = value;
            internalClearRefs(PROP_ID_defaultDays);
