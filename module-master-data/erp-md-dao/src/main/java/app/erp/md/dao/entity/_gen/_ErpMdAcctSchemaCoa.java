...
/**
 *  账套科目表: erp_md_acct_schema_coa
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdAcctSchemaCoa extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_acctSchemaId = 2;
    
    /* 科目表名称: NAME VARCHAR */
    public static final String PROP_NAME_name = "name";
    public static final int PROP_ID_name = 3;
    
    /* 是否主科目表: IS_PRIMARY BOOLEAN */
    ...
    public _ErpMdAcctSchemaCoa(){
        // for debug
    }

    protected ErpMdAcctSchemaCoa newInstance(){
        ErpMdAcctSchemaCoa entity = new ErpMdAcctSchemaCoa();
    ...
    @Override
    public ErpMdAcctSchemaCoa cloneInstance() {
        ErpMdAcctSchemaCoa entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdAcctSchemaCoa";
    }
