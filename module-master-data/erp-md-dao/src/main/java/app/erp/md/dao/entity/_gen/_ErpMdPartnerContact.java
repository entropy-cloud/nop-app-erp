...
/**
 *  往来单位联系人: erp_md_partner_contact
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdPartnerContact extends DynamicOrmEntity{
    ...
    /* 联系人姓名: CONTACT_PERSON VARCHAR */
    public static final String PROP_NAME_contactPerson = "contactPerson";
    public static final int PROP_ID_contactPerson = 3;
    ...
    public _ErpMdPartnerContact(){
        // for debug
    }

    protected ErpMdPartnerContact newInstance(){
        ErpMdPartnerContact entity = new ErpMdPartnerContact();
    ...
    @Override
    public ErpMdPartnerContact cloneInstance() {
        ErpMdPartnerContact entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdPartnerContact";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_position:{
               onInitProp(propId);
               this._position = (java.lang.String)value;
