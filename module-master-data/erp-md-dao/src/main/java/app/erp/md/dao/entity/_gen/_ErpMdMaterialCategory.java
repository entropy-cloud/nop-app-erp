...
/**
 *  物料分类: erp_md_material_category
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdMaterialCategory extends DynamicOrmEntity{
    ...
    public _ErpMdMaterialCategory(){
        // for debug
    }

    protected ErpMdMaterialCategory newInstance(){
        ErpMdMaterialCategory entity = new ErpMdMaterialCategory();
    ...
    @Override
    public ErpMdMaterialCategory cloneInstance() {
        ErpMdMaterialCategory entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdMaterialCategory";
    }
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdMaterialCategory getParent(){
       return (app.erp.md.dao.entity.ErpMdMaterialCategory)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.md.dao.entity.ErpMdMaterialCategory refEntity){
    ...
    private final OrmEntitySet<app.erp.md.dao.entity.ErpMdMaterialCategory> _children = new OrmEntitySet<>(this, PROP_NAME_children,
        null, null,app.erp.md.dao.entity.ErpMdMaterialCategory.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.md.dao.entity.ErpMdMaterialCategory> getChildren(){
       return _children;
    }
