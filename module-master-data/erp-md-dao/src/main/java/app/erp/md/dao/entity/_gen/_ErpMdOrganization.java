...
/**
 *  组织: erp_md_organization
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdOrganization extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_orgType] = PROP_NAME_orgType;
          PROP_NAME_TO_ID.put(PROP_NAME_orgType, PROP_ID_orgType);
    ...
    public _ErpMdOrganization(){
        // for debug
    }

    protected ErpMdOrganization newInstance(){
        ErpMdOrganization entity = new ErpMdOrganization();
    ...
    @Override
    public ErpMdOrganization cloneInstance() {
        ErpMdOrganization entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdOrganization";
    }
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdOrganization getParent(){
       return (app.erp.md.dao.entity.ErpMdOrganization)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.md.dao.entity.ErpMdOrganization refEntity){
    ...
    private final OrmEntitySet<app.erp.md.dao.entity.ErpMdOrganization> _children = new OrmEntitySet<>(this, PROP_NAME_children,
        null, null,app.erp.md.dao.entity.ErpMdOrganization.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.md.dao.entity.ErpMdOrganization> getChildren(){
       return _children;
    }
