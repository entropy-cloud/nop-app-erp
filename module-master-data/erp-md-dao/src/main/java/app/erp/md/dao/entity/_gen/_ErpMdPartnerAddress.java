...
/**
 *  往来单位地址: erp_md_partner_address
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMdPartnerAddress extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_addressType] = PROP_NAME_addressType;
          PROP_NAME_TO_ID.put(PROP_NAME_addressType, PROP_ID_addressType);
    ...
    public _ErpMdPartnerAddress(){
        // for debug
    }

    protected ErpMdPartnerAddress newInstance(){
        ErpMdPartnerAddress entity = new ErpMdPartnerAddress();
    ...
    @Override
    public ErpMdPartnerAddress cloneInstance() {
        ErpMdPartnerAddress entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdPartnerAddress";
    }
