...
public class _ErpMdWarehouse extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_address = 6;
    
    /* 负责人(职员): MANAGER_ID BIGINT */
    ...
    /* relation:  */
    public static final String PROP_NAME_locations = "locations";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_warehouseType] = PROP_NAME_warehouseType;
          PROP_NAME_TO_ID.put(PROP_NAME_warehouseType, PROP_ID_warehouseType);
    ...
    protected ErpMdWarehouse newInstance(){
        ErpMdWarehouse entity = new ErpMdWarehouse();
    ...
    @Override
    public ErpMdWarehouse cloneInstance() {
        ErpMdWarehouse entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.md.dao.entity.ErpMdWarehouse";
    }
    ...
    private final OrmEntitySet<app.erp.md.dao.entity.ErpMdLocation> _locations = new OrmEntitySet<>(this, PROP_NAME_locations,
        null, null,app.erp.md.dao.entity.ErpMdLocation.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.md.dao.entity.ErpMdLocation> getLocations(){
       return _locations;
    }
