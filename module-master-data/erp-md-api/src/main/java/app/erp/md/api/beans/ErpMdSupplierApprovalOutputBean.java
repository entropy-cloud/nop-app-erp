//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpMdSupplierApprovalOutputBean {
        ...
        private String _approvalType_label;

    
        public String getApprovalType_label(){
            return _approvalType_label;
        }

        public void setApprovalType_label(String value){
            this._approvalType_label = value;
        }
