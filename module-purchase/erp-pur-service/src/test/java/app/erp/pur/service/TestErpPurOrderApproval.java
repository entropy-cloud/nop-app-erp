...
public class TestErpPurOrderApproval extends JunitAutoTestCase {
    ...
    private ApiResponse<?> submit(String orderId) {
        return executeRpc(mutation, "ErpPurOrder__submitForApproval", ApiRequest.build(Map.of("id", orderId)));
    }

    private ApiResponse<?> withdrawApproval(String orderId) {
        return executeRpc(mutation, "ErpPurOrder__withdrawApproval", ApiRequest.build(Map.of("id", orderId)));
    }

    private ApiResponse<?> approve(String orderId) {
        return executeRpc(mutation, "ErpPurOrder__approve", ApiRequest.build(Map.of("id", orderId)));
    }

    private ApiResponse<?> reject(String orderId) {
        return executeRpc(mutation, "ErpPurOrder__reject", ApiRequest.build(Map.of("id", orderId)));
    }

    private ApiResponse<?> reverseApprove(String orderId) {
        return executeRpc(mutation, "ErpPurOrder__reverseApprove", ApiRequest.build(Map.of("id", orderId)));
    }
