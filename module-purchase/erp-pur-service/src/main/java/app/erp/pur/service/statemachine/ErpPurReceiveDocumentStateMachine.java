 ...
 * 不编码入边）。
 *
 * <p>接线方 {@code ErpPurReceiveCancelProcessor} 将 common 码映射为领域码
 * {@code ERR_ILLEGAL_DOC_STATUS_TRANSITION}（泛型命名漂移，路线图 Non-Goal 不重命名，successor 对齐）。
 */
public class ErpPurReceiveDocumentStateMachine {
     ...
     * 接线方 {@code ErpPurReceiveCancelProcessor} 映射为领域码 {@code ERR_ILLEGAL_DOC_STATUS_TRANSITION}。
     */
