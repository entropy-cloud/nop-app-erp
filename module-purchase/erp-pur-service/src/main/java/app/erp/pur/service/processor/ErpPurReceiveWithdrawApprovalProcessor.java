...
/**
 * ErpPurReceive withdrawApproval per-mutation Processor (plan 2026-07-25-1057-2；审批轴 Bean 接线 plan 2026-08-13-1950-1 M4.14)。
 *
...
public class ErpPurReceiveWithdrawApprovalProcessor extends AbstractWithdrawApprovalProcessor<ErpPurReceive> {
    ...
    @Override
    protected void validateTransitionForWithdraw(ErpPurReceive entity, IServiceContext context) {
        try {
