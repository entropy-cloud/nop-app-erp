...
/**
 * ErpPurReturn withdrawApproval per-mutation Processor (plan 2026-07-25-1057-2；审批轴 Bean 接线 plan 2026-08-13-1950-1 M4.20)。
 *
...
public class ErpPurReturnWithdrawApprovalProcessor extends AbstractWithdrawApprovalProcessor<ErpPurReturn> {
    ...
    @Override
    protected void validateTransitionForWithdraw(ErpPurReturn entity, IServiceContext context) {
        try {
