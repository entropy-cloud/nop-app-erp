...
/**
 * 采购订单（{@code ErpPurOrder}）实体级状态机 Bean —— 一 Bean 对应一实体一轴（{@code approveStatus} 审批轴）。
 *
 ...
 * （对 Order/Requisition 是经覆写绕过的死路径），其 §16.4 合规化移交显式 successor。
 */
public class ErpPurOrderApprovalStateMachine {
