 ...
 * Extends AbstractCancelProcessor to activate the abstract base class; delegates to ErpPurOrderProcessor
...
public class ErpPurOrderCancelProcessor extends AbstractCancelProcessor<ErpPurOrder> {
    ...
    @Override
    public ErpPurOrder cancel(String id, IServiceContext context) {
