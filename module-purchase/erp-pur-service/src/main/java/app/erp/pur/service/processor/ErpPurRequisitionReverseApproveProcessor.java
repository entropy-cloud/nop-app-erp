...
/**
 * ErpPurRequisition reverseApprove per-mutation Processor (plan 2026-07-25-1057-2；审批轴 Bean 接线 plan 2026-08-13-0945-1 M3.4)。
 *
 ...
 * reverseApprove 目标态=REJECTED（据 Phase 1 Decision 实仓纠正：Requisition {@code doReverseApprove} 已覆写为 REJECTED，
 * 已合规 §16.4；骨架 SUBMITTED 为经覆写绕过的死路径）。
 */
public class ErpPurRequisitionReverseApproveProcessor extends AbstractReverseApproveProcessor<ErpPurRequisition> {
    ...
    @Override
    protected void validateTransitionForReverseApprove(ErpPurRequisition entity, IServiceContext context) {
        try {
