 ...
 *
 * <p>非法边直抛领域码 {@link ErpPurErrors#ERR_INVOICE_ILLEGAL_DOC_STATUS_TRANSITION}（参数 {@code currentDocStatus}/
 ...
 * {@code ErpPurInvoiceCancelProcessor} 编排链调用）同码补参补齐 {@code invoiceCode} 元数据。
 */
