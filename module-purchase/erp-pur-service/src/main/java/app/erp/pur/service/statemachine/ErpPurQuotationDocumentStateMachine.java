 ...
 *
 * <p>非法边直抛领域码 {@link ErpPurErrors#ERR_QUOTATION_ILLEGAL_DOC_STATUS_TRANSITION}（参数 {@code currentDocStatus}/
...
public class ErpPurQuotationDocumentStateMachine {
    ...
    private static NopException illegal(String action, String currentStatus, String expectedStatus) {
        return new NopException(ErpPurErrors.ERR_QUOTATION_ILLEGAL_DOC_STATUS_TRANSITION)
