...
/**
 *  评分变量: erp_pur_supplier_scorecard_variable
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurSupplierScorecardVariable extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 评分维度: CRITERIA_ID BIGINT */
    public static final String PROP_NAME_criteriaId = "criteriaId";
    public static final int PROP_ID_criteriaId = 2;
    
    /* 变量名: VARIABLE_NAME VARCHAR */
    public static final String PROP_NAME_variableName = "variableName";
    public static final int PROP_ID_variableName = 3;
    
    /* 业务取值路径: PATH VARCHAR */
    public static final String PROP_NAME_path = "path";
    public static final int PROP_ID_path = 4;
    
    /* 取值: VALUE DECIMAL */
    public static final String PROP_NAME_value = "value";
    public static final int PROP_ID_value = 5;
    ...
    /* relation:  */
    public static final String PROP_NAME_criteria = "criteria";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_criteriaId] = PROP_NAME_criteriaId;
          PROP_NAME_TO_ID.put(PROP_NAME_criteriaId, PROP_ID_criteriaId);
      
          PROP_ID_TO_NAME[PROP_ID_variableName] = PROP_NAME_variableName;
          PROP_NAME_TO_ID.put(PROP_NAME_variableName, PROP_ID_variableName);
    ...
    public _ErpPurSupplierScorecardVariable(){
        // for debug
    }

    protected ErpPurSupplierScorecardVariable newInstance(){
        ErpPurSupplierScorecardVariable entity = new ErpPurSupplierScorecardVariable();
    ...
    @Override
    public ErpPurSupplierScorecardVariable cloneInstance() {
        ErpPurSupplierScorecardVariable entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurSupplierScorecardVariable";
    }
            ...
            case PROP_ID_variableName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_variableName));
               }
               setVariableName(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_variableName:{
               onInitProp(propId);
               this._variableName = (java.lang.String)value;
            ...
            case PROP_ID_value:{
               onInitProp(propId);
               this._value = (java.math.BigDecimal)value;
    ...
    public final java.lang.String getVariableName(){
         onPropGet(PROP_ID_variableName);
    ...
    public final void setVariableName(java.lang.String value){
        if(onPropSet(PROP_ID_variableName,value)){
            this._variableName = value;
            internalClearRefs(PROP_ID_variableName);
     ...
     * 
     */
    public final app.erp.pur.dao.entity.ErpPurSupplierScorecardCriteria getCriteria(){
       return (app.erp.pur.dao.entity.ErpPurSupplierScorecardCriteria)internalGetRefEntity(PROP_NAME_criteria);
    }

    public final void setCriteria(app.erp.pur.dao.entity.ErpPurSupplierScorecardCriteria refEntity){
   
           if(refEntity == null){
           
                   this.setCriteriaId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_criteria, refEntity,()->{
           
                           this.setCriteriaId(refEntity.getId());
