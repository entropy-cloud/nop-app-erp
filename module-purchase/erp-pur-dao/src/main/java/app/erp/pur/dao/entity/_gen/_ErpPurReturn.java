...
/**
 *  采购退货单: erp_pur_return
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurReturn extends DynamicOrmEntity{
    ...
    public _ErpPurReturn(){
        // for debug
    }

    protected ErpPurReturn newInstance(){
    ...
    @Override
    public ErpPurReturn cloneInstance() {
        ErpPurReturn entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurReturn";
    }
    ...
    private final OrmEntitySet<app.erp.pur.dao.entity.ErpPurReturnLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.pur.dao.entity.ErpPurReturnLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.pur.dao.entity.ErpPurReturnLine> getLines(){
       return _lines;
    }
