...
/**
 *  付款核销行: erp_pur_payment_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurPaymentLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 付款单ID: PAYMENT_ID BIGINT */
    public static final String PROP_NAME_paymentId = "paymentId";
    public static final int PROP_ID_paymentId = 2;
    
    /* 发票ID: INVOICE_ID BIGINT */
    public static final String PROP_NAME_invoiceId = "invoiceId";
    public static final int PROP_ID_invoiceId = 3;
    ...
    /* relation:  */
    public static final String PROP_NAME_payment = "payment";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_paymentId] = PROP_NAME_paymentId;
          PROP_NAME_TO_ID.put(PROP_NAME_paymentId, PROP_ID_paymentId);
    ...
    /* 付款单ID: PAYMENT_ID */
    private java.lang.Long _paymentId;
    ...
    public _ErpPurPaymentLine(){
        // for debug
    }

    protected ErpPurPaymentLine newInstance(){
        ErpPurPaymentLine entity = new ErpPurPaymentLine();
    ...
    @Override
    public ErpPurPaymentLine cloneInstance() {
        ErpPurPaymentLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurPaymentLine";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_paymentId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLong(value,
                       err-> newTypeConversionError(PROP_NAME_paymentId));
               }
               setPaymentId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_paymentId:{
               onInitProp(propId);
               this._paymentId = (java.lang.Long)value;
     ...
     * 付款单ID: PAYMENT_ID
     */
    public final java.lang.Long getPaymentId(){
         onPropGet(PROP_ID_paymentId);
         return _paymentId;
    }
     ...
     * 付款单ID: PAYMENT_ID
     */
    public final void setPaymentId(java.lang.Long value){
        if(onPropSet(PROP_ID_paymentId,value)){
            this._paymentId = value;
            internalClearRefs(PROP_ID_paymentId);
     ...
     * 
     */
    public final app.erp.pur.dao.entity.ErpPurPayment getPayment(){
       return (app.erp.pur.dao.entity.ErpPurPayment)internalGetRefEntity(PROP_NAME_payment);
    }

    public final void setPayment(app.erp.pur.dao.entity.ErpPurPayment refEntity){
           ...
           internalSetRefEntity(PROP_NAME_payment, refEntity,()->{
           
                           this.setPaymentId(refEntity.getId());
