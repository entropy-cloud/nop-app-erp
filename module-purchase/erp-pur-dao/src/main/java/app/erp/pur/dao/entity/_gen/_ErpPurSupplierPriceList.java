...
/**
 *  供应商价格清单: erp_pur_supplier_price_list
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurSupplierPriceList extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_supplierId = 2;
    ...
    public static final int PROP_ID_uoMId = 4;
    
    /* 币种: CURRENCY_ID BIGINT */
    public static final String PROP_NAME_currencyId = "currencyId";
    public static final int PROP_ID_currencyId = 5;
    
    /* 协议单价(不含税): UNIT_PRICE DECIMAL */
    ...
    public static final int PROP_ID_taxRate = 7;
    
    /* 最小起订量: MIN_ORDER_QUANTITY DECIMAL */
    public static final String PROP_NAME_minOrderQuantity = "minOrderQuantity";
    public static final int PROP_ID_minOrderQuantity = 8;
    
    /* 交货周期(天): LEAD_TIME_DAYS INTEGER */
    ...
    public static final int PROP_ID_validFrom = 10;
    
    /* 失效日期: VALID_TO DATE */
    public static final String PROP_NAME_validTo = "validTo";
    public static final int PROP_ID_validTo = 11;
    
    /* 优先级(数字小优先): PRIORITY INTEGER */
    public static final String PROP_NAME_priority = "priority";
    public static final int PROP_ID_priority = 12;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_minOrderQuantity] = PROP_NAME_minOrderQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_minOrderQuantity, PROP_ID_minOrderQuantity);
    ...
    public _ErpPurSupplierPriceList(){
        // for debug
    }

    protected ErpPurSupplierPriceList newInstance(){
        ErpPurSupplierPriceList entity = new ErpPurSupplierPriceList();
    ...
    @Override
    public ErpPurSupplierPriceList cloneInstance() {
        ErpPurSupplierPriceList entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurSupplierPriceList";
    }
