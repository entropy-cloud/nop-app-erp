...
/**
 *  采购订单行: erp_pur_order_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurOrderLine extends DynamicOrmEntity{
    ...
    /* 已收货数量: RECEIVED_QUANTITY DECIMAL */
    public static final String PROP_NAME_receivedQuantity = "receivedQuantity";
    public static final int PROP_ID_receivedQuantity = 14;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_receivedQuantity] = PROP_NAME_receivedQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_receivedQuantity, PROP_ID_receivedQuantity);
    ...
    public _ErpPurOrderLine(){
        // for debug
    }

    protected ErpPurOrderLine newInstance(){
        ErpPurOrderLine entity = new ErpPurOrderLine();
    ...
    @Override
    public ErpPurOrderLine cloneInstance() {
        ErpPurOrderLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurOrderLine";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_amountWithTax:{
               onInitProp(propId);
               this._amountWithTax = (java.lang.String)value;
     ...
     * 金额(含税): AMOUNT_WITH_TAX
     */
    public final java.lang.String getAmountWithTax(){
     ...
     * 金额(含税): AMOUNT_WITH_TAX
     */
    public final void setAmountWithTax(java.lang.String value){
     ...
     * 
     */
    public final app.erp.pur.dao.entity.ErpPurOrder getOrder(){
       return (app.erp.pur.dao.entity.ErpPurOrder)internalGetRefEntity(PROP_NAME_order);
    }

    public final void setOrder(app.erp.pur.dao.entity.ErpPurOrder refEntity){
