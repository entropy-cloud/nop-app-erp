...
public class _ErpPurReceiveLine extends DynamicOrmEntity{
     ...
     * 
     */
    public final app.erp.pur.dao.entity.ErpPurOrderLine getOrderLine(){
       return (app.erp.pur.dao.entity.ErpPurOrderLine)internalGetRefEntity(PROP_NAME_orderLine);
    }

    public final void setOrderLine(app.erp.pur.dao.entity.ErpPurOrderLine refEntity){
