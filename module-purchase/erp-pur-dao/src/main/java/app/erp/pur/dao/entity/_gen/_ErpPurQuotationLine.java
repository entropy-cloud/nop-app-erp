...
/**
 *  供应商报价单行: erp_pur_quotation_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurQuotationLine extends DynamicOrmEntity{
    ...
    public _ErpPurQuotationLine(){
        // for debug
    }

    protected ErpPurQuotationLine newInstance(){
        ErpPurQuotationLine entity = new ErpPurQuotationLine();
    ...
    @Override
    public ErpPurQuotationLine cloneInstance() {
        ErpPurQuotationLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurQuotationLine";
    }
