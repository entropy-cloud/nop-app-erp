...
public class _ErpPurPayment extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_supplierId = 4;
    
    /* 付款日期: BUSINESS_DATE DATE */
    ...
    /* 付款方式: PAYMENT_METHOD VARCHAR */
    public static final String PROP_NAME_paymentMethod = "paymentMethod";
    public static final int PROP_ID_paymentMethod = 12;
    
    /* 付款账户(资金账户): BANK_ACCOUNT_ID BIGINT */
    public static final String PROP_NAME_bankAccountId = "bankAccountId";
    public static final int PROP_ID_bankAccountId = 13;
    
    /* 供应商收款账户(银行账户主数据): PARTNER_BANK_ACCOUNT_ID BIGINT */
    ...
    /* 核销状态: WRITTEN_OFF_STATUS INTEGER */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_paymentMethod] = PROP_NAME_paymentMethod;
          PROP_NAME_TO_ID.put(PROP_NAME_paymentMethod, PROP_ID_paymentMethod);
    ...
    /* 付款账户(资金账户): BANK_ACCOUNT_ID */
    private java.lang.Long _bankAccountId;
    
    /* 供应商收款账户(银行账户主数据): PARTNER_BANK_ACCOUNT_ID */
    ...
    private java.lang.Integer _writtenOffStatus;
    ...
    public _ErpPurPayment(){
        // for debug
    }

    protected ErpPurPayment newInstance(){
        ErpPurPayment entity = new ErpPurPayment();
    ...
    @Override
    public ErpPurPayment cloneInstance() {
        ErpPurPayment entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurPayment";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_paymentMethod:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_paymentMethod));
               }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_paymentMethod:{
               onInitProp(propId);
               this._paymentMethod = (java.lang.String)value;
            ...
            case PROP_ID_writtenOffStatus:{
               onInitProp(propId);
               this._writtenOffStatus = (java.lang.Integer)value;
    ...
    public final java.lang.String getPaymentMethod(){
         onPropGet(PROP_ID_paymentMethod);
     ...
     * 付款方式: PAYMENT_METHOD
     */
    public final void setPaymentMethod(java.lang.String value){
        if(onPropSet(PROP_ID_paymentMethod,value)){
            this._paymentMethod = value;
            internalClearRefs(PROP_ID_paymentMethod);
     ...
     * 核销状态: WRITTEN_OFF_STATUS
     */
    public final java.lang.Integer getWrittenOffStatus(){
     ...
     * 核销状态: WRITTEN_OFF_STATUS
     */
    public final void setWrittenOffStatus(java.lang.Integer value){
    ...
    private final OrmEntitySet<app.erp.pur.dao.entity.ErpPurPaymentLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.pur.dao.entity.ErpPurPaymentLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.pur.dao.entity.ErpPurPaymentLine> getLines(){
       return _lines;
    }
