...
/**
 *  采购入库单: erp_pur_receive
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurReceive extends DynamicOrmEntity{
    ...
    public _ErpPurReceive(){
        // for debug
    }

    protected ErpPurReceive newInstance(){
        ErpPurReceive entity = new ErpPurReceive();
    ...
    @Override
    public ErpPurReceive cloneInstance() {
        ErpPurReceive entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurReceive";
    }
    ...
    private final OrmEntitySet<app.erp.pur.dao.entity.ErpPurReceiveLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.pur.dao.entity.ErpPurReceiveLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.pur.dao.entity.ErpPurReceiveLine> getLines(){
       return _lines;
    }
