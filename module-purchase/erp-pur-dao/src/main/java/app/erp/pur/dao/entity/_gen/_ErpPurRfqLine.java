...
/**
 *  采购询价单行: erp_pur_rfq_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurRfqLine extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_rfqId = 2;
    ...
    public _ErpPurRfqLine(){
        // for debug
    }

    protected ErpPurRfqLine newInstance(){
        ErpPurRfqLine entity = new ErpPurRfqLine();
    ...
    @Override
    public ErpPurRfqLine cloneInstance() {
        ErpPurRfqLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurRfqLine";
    }
