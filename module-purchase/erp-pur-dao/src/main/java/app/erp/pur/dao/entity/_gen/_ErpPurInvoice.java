...
/**
 *  采购发票: erp_pur_invoice
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPurInvoice extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_paidAmount] = PROP_NAME_paidAmount;
          PROP_NAME_TO_ID.put(PROP_NAME_paidAmount, PROP_ID_paidAmount);
          ...
          PROP_ID_TO_NAME[PROP_ID_paidStatus] = PROP_NAME_paidStatus;
          PROP_NAME_TO_ID.put(PROP_NAME_paidStatus, PROP_ID_paidStatus);
    ...
    public _ErpPurInvoice(){
        // for debug
    }

    protected ErpPurInvoice newInstance(){
        ErpPurInvoice entity = new ErpPurInvoice();
    ...
    @Override
    public ErpPurInvoice cloneInstance() {
        ErpPurInvoice entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.pur.dao.entity.ErpPurInvoice";
    }
    ...
    private final OrmEntitySet<app.erp.pur.dao.entity.ErpPurInvoiceLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.pur.dao.entity.ErpPurInvoiceLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.pur.dao.entity.ErpPurInvoiceLine> getLines(){
       return _lines;
    }
