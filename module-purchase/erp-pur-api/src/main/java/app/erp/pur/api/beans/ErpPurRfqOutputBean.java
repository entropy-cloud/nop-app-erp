//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpPurRfqOutputBean {
        ...
        private Map<String,Object> _requisition;

        public Map<String,Object> getRequisition(){
            return _requisition;
        }

        public void setRequisition(Map<String,Object> value){
        ...
        private List<Map<String,Object>> _quotations;

        public List<Map<String,Object>> getQuotations(){
            return _quotations;
        }

        public void setQuotations(List<Map<String,Object>> value){
