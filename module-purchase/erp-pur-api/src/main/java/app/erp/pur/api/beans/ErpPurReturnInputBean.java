//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpPurReturnInputBean extends CrudInputBase {
        ...
        private List<ErpPurReturnLineInputBean> _lines;

        public List<ErpPurReturnLineInputBean> getLines(){
            return _lines;
        }

        public void setLines(List<ErpPurReturnLineInputBean> value){
            this._lines = value;
        }
