//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpPurPaymentInputBean extends CrudInputBase {
        ...
        private List<ErpPurPaymentLineInputBean> _lines;

        public List<ErpPurPaymentLineInputBean> getLines(){
            return _lines;
        }

        public void setLines(List<ErpPurPaymentLineInputBean> value){
            this._lines = value;
        }
