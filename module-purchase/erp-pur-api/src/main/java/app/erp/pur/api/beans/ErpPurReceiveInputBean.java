//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpPurReceiveInputBean extends CrudInputBase {
        ...
        private List<ErpPurReceiveLineInputBean> _lines;

        public List<ErpPurReceiveLineInputBean> getLines(){
            return _lines;
        }

        public void setLines(List<ErpPurReceiveLineInputBean> value){
            this._lines = value;
        }
