//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpInvTransferOrderOutputBean {
        ...
        private Map<String,Object> _fromWarehouse;

        public Map<String,Object> getFromWarehouse(){
            return _fromWarehouse;
        }

        public void setFromWarehouse(Map<String,Object> value){
            this._fromWarehouse = value;
        }


        private Map<String,Object> _toWarehouse;

        public Map<String,Object> getToWarehouse(){
            return _toWarehouse;
        }

        public void setToWarehouse(Map<String,Object> value){
            this._toWarehouse = value;
        }


        private Map<String,Object> _inTransitWarehouse;

        public Map<String,Object> getInTransitWarehouse(){
            return _inTransitWarehouse;
        }
