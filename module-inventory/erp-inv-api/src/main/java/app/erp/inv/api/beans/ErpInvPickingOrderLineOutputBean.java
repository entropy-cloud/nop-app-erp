//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpInvPickingOrderLineOutputBean {
        ...
        public void setPickingId(String value){
        ...
        public java.math.BigDecimal getPickedQuantity(){
            return _pickedQuantity;
        }

        public void setPickedQuantity(java.math.BigDecimal value){
        ...
        private Map<String,Object> _picking;

        public Map<String,Object> getPicking(){
            return _picking;
        }

        public void setPicking(Map<String,Object> value){
            this._picking = value;
        }
