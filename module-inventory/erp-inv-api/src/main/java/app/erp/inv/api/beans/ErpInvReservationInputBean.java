//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpInvReservationInputBean extends CrudInputBase {
        ...
        private List<ErpInvReservationLineInputBean> _lines;

        public List<ErpInvReservationLineInputBean> getLines(){
            return _lines;
        }

        public void setLines(List<ErpInvReservationLineInputBean> value){
            this._lines = value;
        }
