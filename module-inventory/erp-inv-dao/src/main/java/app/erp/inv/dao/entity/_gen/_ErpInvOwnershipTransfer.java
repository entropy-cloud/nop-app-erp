...
/**
 *  所有权转移单: erp_inv_ownership_transfer
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvOwnershipTransfer extends DynamicOrmEntity{
    ...
    /* 转移类型: TRANSFER_TYPE VARCHAR */
    public static final String PROP_NAME_transferType = "transferType";
    public static final int PROP_ID_transferType = 4;
    
    /* 所有权对方(往来单位): PARTNER_ID BIGINT */
    ...
    /* 源库位(=目的库位): SOURCE_LOC_ID BIGINT */
    public static final String PROP_NAME_sourceLocId = "sourceLocId";
    public static final int PROP_ID_sourceLocId = 8;
    
    /* 目的库位(=源库位): DEST_LOC_ID BIGINT */
    public static final String PROP_NAME_destLocId = "destLocId";
    public static final int PROP_ID_destLocId = 9;
    
    /* 转前所有权类型: FROM_OWNERSHIP_TYPE VARCHAR */
    public static final String PROP_NAME_fromOwnershipType = "fromOwnershipType";
    public static final int PROP_ID_fromOwnershipType = 10;
    
    /* 转后所有权类型: TO_OWNERSHIP_TYPE VARCHAR */
    public static final String PROP_NAME_toOwnershipType = "toOwnershipType";
    public static final int PROP_ID_toOwnershipType = 11;
    ...
    /* relation:  */
    public static final String PROP_NAME_sourceLoc = "sourceLoc";
    
    /* relation:  */
    public static final String PROP_NAME_destLoc = "destLoc";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_transferType] = PROP_NAME_transferType;
          PROP_NAME_TO_ID.put(PROP_NAME_transferType, PROP_ID_transferType);
          ...
          PROP_ID_TO_NAME[PROP_ID_sourceLocId] = PROP_NAME_sourceLocId;
          PROP_NAME_TO_ID.put(PROP_NAME_sourceLocId, PROP_ID_sourceLocId);
      
          PROP_ID_TO_NAME[PROP_ID_destLocId] = PROP_NAME_destLocId;
          PROP_NAME_TO_ID.put(PROP_NAME_destLocId, PROP_ID_destLocId);
      
          PROP_ID_TO_NAME[PROP_ID_fromOwnershipType] = PROP_NAME_fromOwnershipType;
          PROP_NAME_TO_ID.put(PROP_NAME_fromOwnershipType, PROP_ID_fromOwnershipType);
      
          PROP_ID_TO_NAME[PROP_ID_toOwnershipType] = PROP_NAME_toOwnershipType;
          PROP_NAME_TO_ID.put(PROP_NAME_toOwnershipType, PROP_ID_toOwnershipType);
    ...
    public _ErpInvOwnershipTransfer(){
        // for debug
    }

    protected ErpInvOwnershipTransfer newInstance(){
        ErpInvOwnershipTransfer entity = new ErpInvOwnershipTransfer();
    ...
    @Override
    public ErpInvOwnershipTransfer cloneInstance() {
        ErpInvOwnershipTransfer entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvOwnershipTransfer";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_sourceLocId:
               return getSourceLocId();
        
            case PROP_ID_destLocId:
               return getDestLocId();
        
            case PROP_ID_fromOwnershipType:
               return getFromOwnershipType();
        
            case PROP_ID_toOwnershipType:
               return getToOwnershipType();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_transferType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_transferType));
               }
               setTransferType(typedValue);
               break;
            }
            ...
            case PROP_ID_fromOwnershipType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_fromOwnershipType));
               }
               setFromOwnershipType(typedValue);
               break;
            }
            ...
            case PROP_ID_toOwnershipType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_toOwnershipType));
               }
               setToOwnershipType(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_transferType:{
               onInitProp(propId);
               this._transferType = (java.lang.String)value;
            ...
            case PROP_ID_fromOwnershipType:{
               onInitProp(propId);
               this._fromOwnershipType = (java.lang.String)value;
            ...
            case PROP_ID_toOwnershipType:{
               onInitProp(propId);
               this._toOwnershipType = (java.lang.String)value;
    ...
    public final java.lang.String getTransferType(){
         onPropGet(PROP_ID_transferType);
     ...
     * 转移类型: TRANSFER_TYPE
     */
    public final void setTransferType(java.lang.String value){
        if(onPropSet(PROP_ID_transferType,value)){
            this._transferType = value;
            internalClearRefs(PROP_ID_transferType);
     ...
     * 转前所有权类型: FROM_OWNERSHIP_TYPE
     */
    public final java.lang.String getFromOwnershipType(){
         onPropGet(PROP_ID_fromOwnershipType);
     ...
     * 转前所有权类型: FROM_OWNERSHIP_TYPE
     */
    public final void setFromOwnershipType(java.lang.String value){
        if(onPropSet(PROP_ID_fromOwnershipType,value)){
            this._fromOwnershipType = value;
            internalClearRefs(PROP_ID_fromOwnershipType);
     ...
     * 转后所有权类型: TO_OWNERSHIP_TYPE
     */
    public final java.lang.String getToOwnershipType(){
         onPropGet(PROP_ID_toOwnershipType);
     ...
     * 转后所有权类型: TO_OWNERSHIP_TYPE
     */
    public final void setToOwnershipType(java.lang.String value){
        if(onPropSet(PROP_ID_toOwnershipType,value)){
            this._toOwnershipType = value;
            internalClearRefs(PROP_ID_toOwnershipType);
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdLocation getSourceLoc(){
       return (app.erp.md.dao.entity.ErpMdLocation)internalGetRefEntity(PROP_NAME_sourceLoc);
    }

    public final void setSourceLoc(app.erp.md.dao.entity.ErpMdLocation refEntity){
   
           if(refEntity == null){
           
                   this.setSourceLocId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_sourceLoc, refEntity,()->{
           
                           this.setSourceLocId(refEntity.getId());
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdLocation getDestLoc(){
       return (app.erp.md.dao.entity.ErpMdLocation)internalGetRefEntity(PROP_NAME_destLoc);
    }

    public final void setDestLoc(app.erp.md.dao.entity.ErpMdLocation refEntity){
   
           if(refEntity == null){
           
                   this.setDestLocId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_destLoc, refEntity,()->{
           
                           this.setDestLocId(refEntity.getId());
    ...
    private final OrmEntitySet<app.erp.inv.dao.entity.ErpInvOwnershipTransferLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.inv.dao.entity.ErpInvOwnershipTransferLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.inv.dao.entity.ErpInvOwnershipTransferLine> getLines(){
       return _lines;
    }
