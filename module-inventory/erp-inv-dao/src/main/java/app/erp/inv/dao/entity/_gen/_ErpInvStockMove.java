...
/**
 *  库存移动单: erp_inv_stock_move
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvStockMove extends DynamicOrmEntity{
    ...
    /* 源仓库: SOURCE_WAREHOUSE_ID BIGINT */
    ...
    public static final int PROP_ID_relatedBillType = 15;
    
    /* 关联单据号: RELATED_BILL_CODE VARCHAR */
    public static final String PROP_NAME_relatedBillCode = "relatedBillCode";
    public static final int PROP_ID_relatedBillCode = 16;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_moveType] = PROP_NAME_moveType;
          PROP_NAME_TO_ID.put(PROP_NAME_moveType, PROP_ID_moveType);
          ...
          PROP_ID_TO_NAME[PROP_ID_destLocationId] = PROP_NAME_destLocationId;
          PROP_NAME_TO_ID.put(PROP_NAME_destLocationId, PROP_ID_destLocationId);
    ...
    private java.lang.String _originMoveId;
    
    /* 原退货移动单: ORIGIN_RETURNED_MOVE_ID */
    private java.lang.String _originReturnedMoveId;
    ...
    protected ErpInvStockMove newInstance(){
        ErpInvStockMove entity = new ErpInvStockMove();
    ...
    @Override
    public ErpInvStockMove cloneInstance() {
        ErpInvStockMove entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvStockMove";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_originMoveId:{
               onInitProp(propId);
               this._originMoveId = (java.lang.String)value;
            ...
            case PROP_ID_originReturnedMoveId:{
               onInitProp(propId);
               this._originReturnedMoveId = (java.lang.String)value;
     ...
     * 上游移动单: ORIGIN_MOVE_ID
     */
    public final java.lang.String getOriginMoveId(){
     ...
     * 上游移动单: ORIGIN_MOVE_ID
     */
    public final void setOriginMoveId(java.lang.String value){
     ...
     * 原退货移动单: ORIGIN_RETURNED_MOVE_ID
     */
    public final java.lang.String getOriginReturnedMoveId(){
     ...
     * 原退货移动单: ORIGIN_RETURNED_MOVE_ID
     */
    public final void setOriginReturnedMoveId(java.lang.String value){
     ...
     */
    public final IOrmEntitySet<app.erp.inv.dao.entity.ErpInvStockMoveLine> getLines(){
       return _lines;
    }
