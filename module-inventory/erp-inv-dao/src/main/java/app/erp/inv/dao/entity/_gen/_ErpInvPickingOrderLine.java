...
/**
 *  拣货单行: erp_inv_picking_order_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvPickingOrderLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 拣货单ID: PICKING_ID BIGINT */
    public static final String PROP_NAME_pickingId = "pickingId";
    public static final int PROP_ID_pickingId = 2;
    ...
    /* 拣货库位: SOURCE_LOCATION_ID BIGINT */
    public static final String PROP_NAME_sourceLocationId = "sourceLocationId";
    public static final int PROP_ID_sourceLocationId = 7;
    
    /* 应拣数量: QUANTITY DECIMAL */
    public static final String PROP_NAME_quantity = "quantity";
    public static final int PROP_ID_quantity = 8;
    
    /* 已拣数量: PICKED_QUANTITY DECIMAL */
    public static final String PROP_NAME_pickedQuantity = "pickedQuantity";
    public static final int PROP_ID_pickedQuantity = 9;
    
    /* 批号: BATCH_NO VARCHAR */
    public static final String PROP_NAME_batchNo = "batchNo";
    public static final int PROP_ID_batchNo = 10;
    ...
    /* relation:  */
    public static final String PROP_NAME_picking = "picking";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_pickingId] = PROP_NAME_pickingId;
          PROP_NAME_TO_ID.put(PROP_NAME_pickingId, PROP_ID_pickingId);
          ...
          PROP_ID_TO_NAME[PROP_ID_sourceLocationId] = PROP_NAME_sourceLocationId;
          PROP_NAME_TO_ID.put(PROP_NAME_sourceLocationId, PROP_ID_sourceLocationId);
      
          PROP_ID_TO_NAME[PROP_ID_quantity] = PROP_NAME_quantity;
          PROP_NAME_TO_ID.put(PROP_NAME_quantity, PROP_ID_quantity);
      
          PROP_ID_TO_NAME[PROP_ID_pickedQuantity] = PROP_NAME_pickedQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_pickedQuantity, PROP_ID_pickedQuantity);
    ...
    public _ErpInvPickingOrderLine(){
        // for debug
    }

    protected ErpInvPickingOrderLine newInstance(){
        ErpInvPickingOrderLine entity = new ErpInvPickingOrderLine();
    ...
    @Override
    public ErpInvPickingOrderLine cloneInstance() {
        ErpInvPickingOrderLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvPickingOrderLine";
    }
     ...
     * 
     */
    public final app.erp.inv.dao.entity.ErpInvPickingOrder getPicking(){
       return (app.erp.inv.dao.entity.ErpInvPickingOrder)internalGetRefEntity(PROP_NAME_picking);
    }

    public final void setPicking(app.erp.inv.dao.entity.ErpInvPickingOrder refEntity){
   
           if(refEntity == null){
           
                   this.setPickingId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_picking, refEntity,()->{
           
                           this.setPickingId(refEntity.getId());
