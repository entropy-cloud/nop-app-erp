...
/**
 *  成本层: erp_inv_cost_layer
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvCostLayer extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_costMethod = 7;
    
    /* 入库数量: INCOMING_QUANTITY DECIMAL */
    public static final String PROP_NAME_incomingQuantity = "incomingQuantity";
    public static final int PROP_ID_incomingQuantity = 8;
    
    /* 剩余数量: REMAINING_QUANTITY DECIMAL */
    public static final String PROP_NAME_remainingQuantity = "remainingQuantity";
    public static final int PROP_ID_remainingQuantity = 9;
    ...
    /* 入库日期: INCOMING_DATE DATE */
    public static final String PROP_NAME_incomingDate = "incomingDate";
    public static final int PROP_ID_incomingDate = 13;
    
    /* 入库移动单: INCOMING_MOVE_ID BIGINT */
    public static final String PROP_NAME_incomingMoveId = "incomingMoveId";
    public static final int PROP_ID_incomingMoveId = 14;
    
    /* 账套: ACCT_SCHEMA_ID BIGINT */
    public static final String PROP_NAME_acctSchemaId = "acctSchemaId";
    public static final int PROP_ID_acctSchemaId = 15;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_incomingQuantity] = PROP_NAME_incomingQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_incomingQuantity, PROP_ID_incomingQuantity);
      
          PROP_ID_TO_NAME[PROP_ID_remainingQuantity] = PROP_NAME_remainingQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_remainingQuantity, PROP_ID_remainingQuantity);
          ...
          PROP_ID_TO_NAME[PROP_ID_incomingDate] = PROP_NAME_incomingDate;
          PROP_NAME_TO_ID.put(PROP_NAME_incomingDate, PROP_ID_incomingDate);
      
          PROP_ID_TO_NAME[PROP_ID_incomingMoveId] = PROP_NAME_incomingMoveId;
          PROP_NAME_TO_ID.put(PROP_NAME_incomingMoveId, PROP_ID_incomingMoveId);
    ...
    /* 入库移动单: INCOMING_MOVE_ID */
    private java.lang.String _incomingMoveId;
    ...
    public _ErpInvCostLayer(){
        // for debug
    }

    protected ErpInvCostLayer newInstance(){
        ErpInvCostLayer entity = new ErpInvCostLayer();
    ...
    @Override
    public ErpInvCostLayer cloneInstance() {
        ErpInvCostLayer entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvCostLayer";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_incomingDate:
               return getIncomingDate();
        
            case PROP_ID_incomingMoveId:
               return getIncomingMoveId();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_incomingDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_incomingDate));
               }
               setIncomingDate(typedValue);
               break;
            }
            ...
            case PROP_ID_incomingMoveId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_incomingMoveId));
               }
               setIncomingMoveId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_incomingDate:{
               onInitProp(propId);
               this._incomingDate = (java.time.LocalDate)value;
            ...
            case PROP_ID_incomingMoveId:{
               onInitProp(propId);
               this._incomingMoveId = (java.lang.String)value;
     ...
     * 入库日期: INCOMING_DATE
     */
    public final java.time.LocalDate getIncomingDate(){
         onPropGet(PROP_ID_incomingDate);
     ...
     * 入库日期: INCOMING_DATE
     */
    public final void setIncomingDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_incomingDate,value)){
            this._incomingDate = value;
            internalClearRefs(PROP_ID_incomingDate);
     ...
     * 入库移动单: INCOMING_MOVE_ID
     */
    public final java.lang.String getIncomingMoveId(){
         onPropGet(PROP_ID_incomingMoveId);
     ...
     * 入库移动单: INCOMING_MOVE_ID
     */
    public final void setIncomingMoveId(java.lang.String value){
        if(onPropSet(PROP_ID_incomingMoveId,value)){
            this._incomingMoveId = value;
            internalClearRefs(PROP_ID_incomingMoveId);
