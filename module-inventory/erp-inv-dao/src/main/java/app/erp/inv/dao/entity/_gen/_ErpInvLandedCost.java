...
/**
 *  到岸成本单: erp_inv_landed_cost
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvLandedCost extends DynamicOrmEntity{
    ...
    /* 采购入库单: RECEIVE_ID BIGINT */
    public static final String PROP_NAME_receiveId = "receiveId";
    public static final int PROP_ID_receiveId = 4;
    
    /* 采购供应商: SUPPLIER_ID BIGINT */
    ...
    /* 到岸成本合计: TOTAL_COST_AMOUNT DECIMAL */
    public static final String PROP_NAME_totalCostAmount = "totalCostAmount";
    public static final int PROP_ID_totalCostAmount = 8;
    
    /* 分摊方法: ALLOCATION_METHOD VARCHAR */
    public static final String PROP_NAME_allocationMethod = "allocationMethod";
    public static final int PROP_ID_allocationMethod = 9;
    ...
    /* 采购入库单: RECEIVE_ID */
    private java.lang.String _receiveId;
    ...
    /* 到岸成本合计: TOTAL_COST_AMOUNT */
    private java.math.BigDecimal _totalCostAmount;
    
    /* 分摊方法: ALLOCATION_METHOD */
    ...
    public _ErpInvLandedCost(){
        // for debug
    }

    protected ErpInvLandedCost newInstance(){
        ErpInvLandedCost entity = new ErpInvLandedCost();
    ...
    @Override
    public ErpInvLandedCost cloneInstance() {
        ErpInvLandedCost entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvLandedCost";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_receiveId:{
               onInitProp(propId);
               this._receiveId = (java.lang.String)value;
     ...
     * 采购入库单: RECEIVE_ID
     */
    public final java.lang.String getReceiveId(){
     ...
     * 采购入库单: RECEIVE_ID
     */
    public final void setReceiveId(java.lang.String value){
    ...
    private final OrmEntitySet<app.erp.inv.dao.entity.ErpInvLandedCostLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.inv.dao.entity.ErpInvLandedCostLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.inv.dao.entity.ErpInvLandedCostLine> getLines(){
       return _lines;
    }
