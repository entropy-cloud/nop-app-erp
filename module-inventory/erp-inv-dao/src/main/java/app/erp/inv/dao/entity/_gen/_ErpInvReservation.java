...
/**
 *  库存预留单: erp_inv_reservation
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvReservation extends DynamicOrmEntity{
    ...
    /* 来源单据类型(如 SALES_ORDER/WORK_ORDER): SOURCE_BILL_TYPE VARCHAR */
    ...
    /* 为谁预留(往来单位): RESERVED_FOR_PARTNER_ID BIGINT */
    public static final String PROP_NAME_reservedForPartnerId = "reservedForPartnerId";
    public static final int PROP_ID_reservedForPartnerId = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_reservedForPartnerId] = PROP_NAME_reservedForPartnerId;
          PROP_NAME_TO_ID.put(PROP_NAME_reservedForPartnerId, PROP_ID_reservedForPartnerId);
    ...
    /* 来源单据类型(如 SALES_ORDER/WORK_ORDER): SOURCE_BILL_TYPE */
    ...
    public _ErpInvReservation(){
        // for debug
    }

    protected ErpInvReservation newInstance(){
        ErpInvReservation entity = new ErpInvReservation();
    ...
    @Override
    public ErpInvReservation cloneInstance() {
        ErpInvReservation entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvReservation";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_reservedForPartnerId:
               return getReservedForPartnerId();
     ...
     */
    public final IOrmEntitySet<app.erp.inv.dao.entity.ErpInvReservationLine> getLines(){
       return _lines;
    }
