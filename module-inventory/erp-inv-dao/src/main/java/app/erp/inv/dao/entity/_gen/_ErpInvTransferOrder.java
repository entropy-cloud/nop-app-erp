...
/**
 *  调拨单: erp_inv_transfer_order
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvTransferOrder extends DynamicOrmEntity{
    ...
    /* 调出仓库: FROM_WAREHOUSE_ID BIGINT */
    public static final String PROP_NAME_fromWarehouseId = "fromWarehouseId";
    public static final int PROP_ID_fromWarehouseId = 5;
    
    /* 调入仓库: TO_WAREHOUSE_ID BIGINT */
    public static final String PROP_NAME_toWarehouseId = "toWarehouseId";
    public static final int PROP_ID_toWarehouseId = 6;
    
    /* 在途仓库: IN_TRANSIT_WAREHOUSE_ID BIGINT */
    public static final String PROP_NAME_inTransitWarehouseId = "inTransitWarehouseId";
    public static final int PROP_ID_inTransitWarehouseId = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_fromWarehouseId] = PROP_NAME_fromWarehouseId;
          PROP_NAME_TO_ID.put(PROP_NAME_fromWarehouseId, PROP_ID_fromWarehouseId);
      
          PROP_ID_TO_NAME[PROP_ID_toWarehouseId] = PROP_NAME_toWarehouseId;
          PROP_NAME_TO_ID.put(PROP_NAME_toWarehouseId, PROP_ID_toWarehouseId);
      
          PROP_ID_TO_NAME[PROP_ID_inTransitWarehouseId] = PROP_NAME_inTransitWarehouseId;
          PROP_NAME_TO_ID.put(PROP_NAME_inTransitWarehouseId, PROP_ID_inTransitWarehouseId);
    ...
    public _ErpInvTransferOrder(){
        // for debug
    }

    protected ErpInvTransferOrder newInstance(){
        ErpInvTransferOrder entity = new ErpInvTransferOrder();
    ...
    @Override
    public ErpInvTransferOrder cloneInstance() {
        ErpInvTransferOrder entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvTransferOrder";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_fromWarehouseId:
               return getFromWarehouseId();
        
            case PROP_ID_toWarehouseId:
               return getToWarehouseId();
        
            case PROP_ID_inTransitWarehouseId:
               return getInTransitWarehouseId();
     ...
     */
    public final IOrmEntitySet<app.erp.inv.dao.entity.ErpInvTransferOrderLine> getLines(){
       return _lines;
    }
