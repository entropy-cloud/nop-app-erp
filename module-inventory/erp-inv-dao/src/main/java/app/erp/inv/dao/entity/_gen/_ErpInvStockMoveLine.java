...
/**
 *  库存移动单行: erp_inv_stock_move_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvStockMoveLine extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_moveId = 2;
    ...
    public _ErpInvStockMoveLine(){
        // for debug
    }

    protected ErpInvStockMoveLine newInstance(){
        ErpInvStockMoveLine entity = new ErpInvStockMoveLine();
    ...
    @Override
    public ErpInvStockMoveLine cloneInstance() {
        ErpInvStockMoveLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvStockMoveLine";
    }
