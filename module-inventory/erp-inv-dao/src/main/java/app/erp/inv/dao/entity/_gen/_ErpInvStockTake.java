...
/**
 *  盘点单: erp_inv_stock_take
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpInvStockTake extends DynamicOrmEntity{
    ...
    /* 盘点日期: BUSINESS_DATE DATE */
    public static final String PROP_NAME_businessDate = "businessDate";
    public static final int PROP_ID_businessDate = 4;
    
    /* 盘点类型: TAKE_TYPE INTEGER */
    public static final String PROP_NAME_takeType = "takeType";
    public static final int PROP_ID_takeType = 5;
    
    /* 盘点仓库: WAREHOUSE_ID BIGINT */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_takeType] = PROP_NAME_takeType;
          PROP_NAME_TO_ID.put(PROP_NAME_takeType, PROP_ID_takeType);
    ...
    /* 盘点类型: TAKE_TYPE */
    private java.lang.Integer _takeType;
    ...
    public _ErpInvStockTake(){
        // for debug
    }

    protected ErpInvStockTake newInstance(){
        ErpInvStockTake entity = new ErpInvStockTake();
    ...
    @Override
    public ErpInvStockTake cloneInstance() {
        ErpInvStockTake entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.inv.dao.entity.ErpInvStockTake";
    }
            ...
            case PROP_ID_takeType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_takeType));
               }
               setTakeType(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_takeType:{
               onInitProp(propId);
               this._takeType = (java.lang.Integer)value;
     ...
     * 盘点类型: TAKE_TYPE
     */
    public final java.lang.Integer getTakeType(){
         onPropGet(PROP_ID_takeType);
         return _takeType;
    }
     ...
     * 盘点类型: TAKE_TYPE
     */
    public final void setTakeType(java.lang.Integer value){
        if(onPropSet(PROP_ID_takeType,value)){
            this._takeType = value;
            internalClearRefs(PROP_ID_takeType);
    ...
    private final OrmEntitySet<app.erp.inv.dao.entity.ErpInvStockTakeLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.inv.dao.entity.ErpInvStockTakeLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.inv.dao.entity.ErpInvStockTakeLine> getLines(){
       return _lines;
    }
