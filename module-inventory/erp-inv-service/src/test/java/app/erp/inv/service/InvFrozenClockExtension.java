...
/**
 * 冻结 {@link CoreMetrics} 时钟到 inventory 日期敏感型 auto-test 快照的参考日 {@link #REFERENCE_DATE}，
 * 使依赖 {@code CoreMetrics.currentDate()} 派生的快照（如 cost layer incomingDate、batch productionDate/expiryDate）
 * 跨日稳定，不再随系统日历翻页而漂移。
 *
 ...
 */
public final class InvFrozenClockExtension implements BeforeAllCallback, AfterAllCallback {
