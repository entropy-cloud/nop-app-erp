...
public class SpecificCostingStrategy implements CostingStrategy {
     ...
     */
    private List<ErpInvCostLayer> findSpecificLayers(String orgId, String materialId, String skuId, String warehouseId,
                                                     String batchNo, String serialNo, String acctSchemaId,
