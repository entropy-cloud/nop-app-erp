...
CREATE TABLE erp_cs_sla_policy(
  ...
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  SECOND_ESCALATION_USER_ID BIGINT NULL    COMMENT '二级升级通知人',
  ESCALATION_DELAY_HOURS INTEGER NULL    COMMENT '升级等待小时数',
...
CREATE TABLE erp_cs_ticket(
  ...
  DEADLINE_DATE_TIME DATETIME(3) NULL    COMMENT 'SLA 截止时间',
  IS_SLA_COMPLETED BOOLEAN default 0  NULL    COMMENT 'SLA 是否完成',
  START_DATE_TIME DATETIME(3) NULL    COMMENT '开始处理时间',
  END_DATE_TIME DATETIME(3) NULL    COMMENT '关闭时间',
  ...
  BUSINESS_DATE DATE NOT NULL    COMMENT '业务日期',
  LAST_ESCALATION_LEVEL INTEGER NULL    COMMENT '最近升级级别',
  ESCALATION_COUNT INTEGER NULL    COMMENT '升级通知次数',
  LAST_ESCALATION_AT DATETIME(3) NULL    COMMENT '最近升级时间',
...
CREATE TABLE erp_cs_survey(
  ...
  SURVEY_SENT_AT DATETIME(3) NULL    COMMENT '调查发送时间',
  ...
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  STATUS VARCHAR(20) NULL    COMMENT '调查状态',
  FAILURE_COUNT INTEGER NULL    COMMENT '发送失败次数',
