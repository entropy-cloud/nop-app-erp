...
public class _ErpCsTeam extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_teamLeaderId = 4;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_teamLeaderId] = PROP_NAME_teamLeaderId;
          PROP_NAME_TO_ID.put(PROP_NAME_teamLeaderId, PROP_ID_teamLeaderId);
    ...
    protected ErpCsTeam newInstance(){
        ErpCsTeam entity = new ErpCsTeam();
    ...
    @Override
    public ErpCsTeam cloneInstance() {
        ErpCsTeam entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsTeam";
    }
