...
/**
 *  支持合同: erp_cs_contract
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsContract extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_billingCycle] = PROP_NAME_billingCycle;
          PROP_NAME_TO_ID.put(PROP_NAME_billingCycle, PROP_ID_billingCycle);
    ...
    public _ErpCsContract(){
        // for debug
    }

    protected ErpCsContract newInstance(){
        ErpCsContract entity = new ErpCsContract();
    ...
    @Override
    public ErpCsContract cloneInstance() {
        ErpCsContract entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsContract";
    }
