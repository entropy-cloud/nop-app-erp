...
/**
 *  目录分类: erp_cs_catalog_category
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsCatalogCategory extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_icon = 6;
    ...
    public _ErpCsCatalogCategory(){
        // for debug
    }

    protected ErpCsCatalogCategory newInstance(){
        ErpCsCatalogCategory entity = new ErpCsCatalogCategory();
    ...
    @Override
    public ErpCsCatalogCategory cloneInstance() {
        ErpCsCatalogCategory entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsCatalogCategory";
    }
     ...
     * 
     */
    public final app.erp.cs.dao.entity.ErpCsCatalogCategory getParent(){
       return (app.erp.cs.dao.entity.ErpCsCatalogCategory)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.cs.dao.entity.ErpCsCatalogCategory refEntity){
