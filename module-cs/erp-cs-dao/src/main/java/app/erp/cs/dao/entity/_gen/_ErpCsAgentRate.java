...
/**
 *  客服费率: erp_cs_agent_rate
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsAgentRate extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_serviceType = 4;
    
    /* 费率(元/小时): RATE DECIMAL */
    public static final String PROP_NAME_rate = "rate";
    public static final int PROP_ID_rate = 5;
    
    /* 生效日期: EFFECTIVE_DATE DATE */
    public static final String PROP_NAME_effectiveDate = "effectiveDate";
    public static final int PROP_ID_effectiveDate = 6;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_effectiveDate] = PROP_NAME_effectiveDate;
          PROP_NAME_TO_ID.put(PROP_NAME_effectiveDate, PROP_ID_effectiveDate);
    ...
    public _ErpCsAgentRate(){
        // for debug
    }

    protected ErpCsAgentRate newInstance(){
        ErpCsAgentRate entity = new ErpCsAgentRate();
    ...
    @Override
    public ErpCsAgentRate cloneInstance() {
        ErpCsAgentRate entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsAgentRate";
    }
            ...
            case PROP_ID_effectiveDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_effectiveDate));
               }
               setEffectiveDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_effectiveDate:{
               onInitProp(propId);
               this._effectiveDate = (java.time.LocalDate)value;
     ...
     * 生效日期: EFFECTIVE_DATE
     */
    public final java.time.LocalDate getEffectiveDate(){
         onPropGet(PROP_ID_effectiveDate);
     ...
     * 生效日期: EFFECTIVE_DATE
     */
    public final void setEffectiveDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_effectiveDate,value)){
            this._effectiveDate = value;
            internalClearRefs(PROP_ID_effectiveDate);
