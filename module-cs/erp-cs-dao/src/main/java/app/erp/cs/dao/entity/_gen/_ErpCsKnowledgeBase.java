...
/**
 *  知识库: erp_cs_knowledge_base
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsKnowledgeBase extends DynamicOrmEntity{
    ...
    /* 分类: CATEGORY_ID BIGINT */
    public static final String PROP_NAME_categoryId = "categoryId";
    public static final int PROP_ID_categoryId = 5;
    
    /* 是否发布: IS_PUBLISHED BOOLEAN */
    public static final String PROP_NAME_isPublished = "isPublished";
    public static final int PROP_ID_isPublished = 6;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_isPublished] = PROP_NAME_isPublished;
          PROP_NAME_TO_ID.put(PROP_NAME_isPublished, PROP_ID_isPublished);
    ...
    /* 是否发布: IS_PUBLISHED */
    private java.lang.Boolean _isPublished;
    ...
    public _ErpCsKnowledgeBase(){
        // for debug
    }

    protected ErpCsKnowledgeBase newInstance(){
        ErpCsKnowledgeBase entity = new ErpCsKnowledgeBase();
    ...
    @Override
    public ErpCsKnowledgeBase cloneInstance() {
        ErpCsKnowledgeBase entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsKnowledgeBase";
    }
            ...
            case PROP_ID_isPublished:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBoolean(value,
                       err-> newTypeConversionError(PROP_NAME_isPublished));
               }
               setIsPublished(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_isPublished:{
               onInitProp(propId);
               this._isPublished = (java.lang.Boolean)value;
     ...
     * 是否发布: IS_PUBLISHED
     */
    public final java.lang.Boolean getIsPublished(){
         onPropGet(PROP_ID_isPublished);
         return _isPublished;
    }
     ...
     * 是否发布: IS_PUBLISHED
     */
    public final void setIsPublished(java.lang.Boolean value){
        if(onPropSet(PROP_ID_isPublished,value)){
            this._isPublished = value;
            internalClearRefs(PROP_ID_isPublished);
