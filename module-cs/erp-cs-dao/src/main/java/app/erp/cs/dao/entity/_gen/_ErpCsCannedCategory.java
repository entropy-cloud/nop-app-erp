...
/**
 *  预设应答分类: erp_cs_canned_category
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsCannedCategory extends DynamicOrmEntity{
    ...
    public _ErpCsCannedCategory(){
        // for debug
    }

    protected ErpCsCannedCategory newInstance(){
        ErpCsCannedCategory entity = new ErpCsCannedCategory();
    ...
    @Override
    public ErpCsCannedCategory cloneInstance() {
        ErpCsCannedCategory entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsCannedCategory";
    }
     ...
     * 
     */
    public final app.erp.cs.dao.entity.ErpCsCannedCategory getParent(){
       return (app.erp.cs.dao.entity.ErpCsCannedCategory)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.cs.dao.entity.ErpCsCannedCategory refEntity){
