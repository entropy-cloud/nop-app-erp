...
/**
 *  工单类型: erp_cs_ticket_type
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsTicketType extends DynamicOrmEntity{
    ...
    /* 默认 SLA 策略: DEFAULT_SLA_POLICY_ID BIGINT */
    public static final String PROP_NAME_defaultSlaPolicyId = "defaultSlaPolicyId";
    public static final int PROP_ID_defaultSlaPolicyId = 5;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_defaultPriority] = PROP_NAME_defaultPriority;
          PROP_NAME_TO_ID.put(PROP_NAME_defaultPriority, PROP_ID_defaultPriority);
      
          PROP_ID_TO_NAME[PROP_ID_defaultSlaPolicyId] = PROP_NAME_defaultSlaPolicyId;
          PROP_NAME_TO_ID.put(PROP_NAME_defaultSlaPolicyId, PROP_ID_defaultSlaPolicyId);
    ...
    public _ErpCsTicketType(){
        // for debug
    }

    protected ErpCsTicketType newInstance(){
        ErpCsTicketType entity = new ErpCsTicketType();
    ...
    @Override
    public ErpCsTicketType cloneInstance() {
        ErpCsTicketType entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsTicketType";
    }
