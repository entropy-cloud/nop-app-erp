...
/**
 *  目录项履行映射: erp_cs_catalog_fulfillment
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCsCatalogFulfillment extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_catalogItemId = 4;
    ...
    /* 动作配置: ACTION_CONFIG VARCHAR */
    public static final String PROP_NAME_actionConfig = "actionConfig";
    public static final int PROP_ID_actionConfig = 7;
    
    /* 执行角色: ASSIGN_TO_ROLE VARCHAR */
    public static final String PROP_NAME_assignToRole = "assignToRole";
    public static final int PROP_ID_assignToRole = 8;
    
    /* 预估时长(分钟): ESTIMATED_DURATION INTEGER */
    public static final String PROP_NAME_estimatedDuration = "estimatedDuration";
    public static final int PROP_ID_estimatedDuration = 9;
    
    /* 是否必须执行: IS_MANDATORY BOOLEAN */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_assignToRole] = PROP_NAME_assignToRole;
          PROP_NAME_TO_ID.put(PROP_NAME_assignToRole, PROP_ID_assignToRole);
      
          PROP_ID_TO_NAME[PROP_ID_estimatedDuration] = PROP_NAME_estimatedDuration;
          PROP_NAME_TO_ID.put(PROP_NAME_estimatedDuration, PROP_ID_estimatedDuration);
    ...
    /* 执行角色: ASSIGN_TO_ROLE */
    private java.lang.String _assignToRole;
    
    /* 预估时长(分钟): ESTIMATED_DURATION */
    private java.lang.Integer _estimatedDuration;
    ...
    public _ErpCsCatalogFulfillment(){
        // for debug
    }

    protected ErpCsCatalogFulfillment newInstance(){
        ErpCsCatalogFulfillment entity = new ErpCsCatalogFulfillment();
    ...
    @Override
    public ErpCsCatalogFulfillment cloneInstance() {
        ErpCsCatalogFulfillment entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.cs.dao.entity.ErpCsCatalogFulfillment";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_assignToRole:
               return getAssignToRole();
        
            case PROP_ID_estimatedDuration:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_assignToRole:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_assignToRole));
               }
               setAssignToRole(typedValue);
               break;
            }
            ...
            case PROP_ID_estimatedDuration:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_estimatedDuration));
               }
               setEstimatedDuration(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_assignToRole:{
               onInitProp(propId);
               this._assignToRole = (java.lang.String)value;
            ...
            case PROP_ID_estimatedDuration:{
               onInitProp(propId);
               this._estimatedDuration = (java.lang.Integer)value;
     ...
     * 执行角色: ASSIGN_TO_ROLE
     */
    public final java.lang.String getAssignToRole(){
         onPropGet(PROP_ID_assignToRole);
     ...
     * 执行角色: ASSIGN_TO_ROLE
     */
    public final void setAssignToRole(java.lang.String value){
        if(onPropSet(PROP_ID_assignToRole,value)){
            this._assignToRole = value;
            internalClearRefs(PROP_ID_assignToRole);
    ...
    public final java.lang.Integer getEstimatedDuration(){
         onPropGet(PROP_ID_estimatedDuration);
     ...
     * 预估时长(分钟): ESTIMATED_DURATION
     */
    public final void setEstimatedDuration(java.lang.Integer value){
        if(onPropSet(PROP_ID_estimatedDuration,value)){
            this._estimatedDuration = value;
            internalClearRefs(PROP_ID_estimatedDuration);
