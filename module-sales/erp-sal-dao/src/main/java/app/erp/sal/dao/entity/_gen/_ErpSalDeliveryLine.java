...
/**
 *  销售出库单行: erp_sal_delivery_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalDeliveryLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 出库单ID: DELIVERY_ID BIGINT */
    public static final String PROP_NAME_deliveryId = "deliveryId";
    public static final int PROP_ID_deliveryId = 2;
    ...
    public static final int PROP_ID_batchNo = 14;
    ...
    /* relation:  */
    public static final String PROP_NAME_orderLine = "orderLine";
    ...
    /* 订单行ID: ORDER_LINE_ID */
    private java.lang.String _orderLineId;
    ...
    public _ErpSalDeliveryLine(){
        // for debug
    }

    protected ErpSalDeliveryLine newInstance(){
        ErpSalDeliveryLine entity = new ErpSalDeliveryLine();
    ...
    @Override
    public ErpSalDeliveryLine cloneInstance() {
        ErpSalDeliveryLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalDeliveryLine";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_orderLineId:{
               onInitProp(propId);
               this._orderLineId = (java.lang.String)value;
     ...
     * 订单行ID: ORDER_LINE_ID
     */
    public final java.lang.String getOrderLineId(){
     ...
     * 订单行ID: ORDER_LINE_ID
     */
    public final void setOrderLineId(java.lang.String value){
    ...
    public final app.erp.sal.dao.entity.ErpSalDelivery getDelivery(){
       return (app.erp.sal.dao.entity.ErpSalDelivery)internalGetRefEntity(PROP_NAME_delivery);
    }

    public final void setDelivery(app.erp.sal.dao.entity.ErpSalDelivery refEntity){
     ...
     * 
     */
    public final app.erp.sal.dao.entity.ErpSalOrderLine getOrderLine(){
       return (app.erp.sal.dao.entity.ErpSalOrderLine)internalGetRefEntity(PROP_NAME_orderLine);
    }

    public final void setOrderLine(app.erp.sal.dao.entity.ErpSalOrderLine refEntity){
   
           if(refEntity == null){
           
                   this.setOrderLineId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_orderLine, refEntity,()->{
           
                           this.setOrderLineId(refEntity.getId());
