...
/**
 *  收款核销行: erp_sal_receipt_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalReceiptLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 收款单ID: RECEIPT_ID BIGINT */
    public static final String PROP_NAME_receiptId = "receiptId";
    public static final int PROP_ID_receiptId = 2;
    ...
    /* relation:  */
    public static final String PROP_NAME_receipt = "receipt";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_receiptId] = PROP_NAME_receiptId;
          PROP_NAME_TO_ID.put(PROP_NAME_receiptId, PROP_ID_receiptId);
    ...
    public _ErpSalReceiptLine(){
        // for debug
    }

    protected ErpSalReceiptLine newInstance(){
        ErpSalReceiptLine entity = new ErpSalReceiptLine();
    ...
    @Override
    public ErpSalReceiptLine cloneInstance() {
        ErpSalReceiptLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalReceiptLine";
    }
     ...
     * 
     */
    public final app.erp.sal.dao.entity.ErpSalReceipt getReceipt(){
       return (app.erp.sal.dao.entity.ErpSalReceipt)internalGetRefEntity(PROP_NAME_receipt);
    }

    public final void setReceipt(app.erp.sal.dao.entity.ErpSalReceipt refEntity){
           ...
           internalSetRefEntity(PROP_NAME_receipt, refEntity,()->{
           
                           this.setReceiptId(refEntity.getId());
