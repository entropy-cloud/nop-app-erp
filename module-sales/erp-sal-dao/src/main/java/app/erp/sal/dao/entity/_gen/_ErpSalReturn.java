...
/**
 *  销售退货单: erp_sal_return
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalReturn extends DynamicOrmEntity{
    ...
    /* 出库单: DELIVERY_ID BIGINT */
    public static final String PROP_NAME_deliveryId = "deliveryId";
    public static final int PROP_ID_deliveryId = 4;
    ...
    private java.lang.String _exchangeDeliveryId;
    ...
    protected ErpSalReturn newInstance(){
    ...
    @Override
    public ErpSalReturn cloneInstance() {
        ErpSalReturn entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalReturn";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_exchangeDeliveryId:{
               onInitProp(propId);
               this._exchangeDeliveryId = (java.lang.String)value;
     ...
     * 换货出库单: EXCHANGE_DELIVERY_ID
     */
    public final java.lang.String getExchangeDeliveryId(){
     ...
     * 换货出库单: EXCHANGE_DELIVERY_ID
     */
    public final void setExchangeDeliveryId(java.lang.String value){
    ...
    private final OrmEntitySet<app.erp.sal.dao.entity.ErpSalReturnLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.sal.dao.entity.ErpSalReturnLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.sal.dao.entity.ErpSalReturnLine> getLines(){
       return _lines;
    }
