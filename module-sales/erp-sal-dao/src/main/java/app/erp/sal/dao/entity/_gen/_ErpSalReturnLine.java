...
/**
 *  销售退货单行: erp_sal_return_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalReturnLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 退货单ID: RETURN_ID BIGINT */
    public static final String PROP_NAME_returnId = "returnId";
    public static final int PROP_ID_returnId = 2;
    ...
    public static final int PROP_ID_unitPrice = 9;
    ...
    public static final int PROP_ID_reason = 13;
    ...
    /* relation:  */
    public static final String PROP_NAME_return = "return";
    ...
    /* relation:  */
    public static final String PROP_NAME_deliveryLine = "deliveryLine";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_returnId] = PROP_NAME_returnId;
          PROP_NAME_TO_ID.put(PROP_NAME_returnId, PROP_ID_returnId);
    ...
    /* 退货单ID: RETURN_ID */
    private java.lang.String _returnId;
    
    /* 出库行ID: DELIVERY_LINE_ID */
    private java.lang.String _deliveryLineId;
    ...
    public _ErpSalReturnLine(){
        // for debug
    }

    protected ErpSalReturnLine newInstance(){
        ErpSalReturnLine entity = new ErpSalReturnLine();
    ...
    @Override
    public ErpSalReturnLine cloneInstance() {
        ErpSalReturnLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalReturnLine";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_returnId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_returnId));
               }
               setReturnId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_returnId:{
               onInitProp(propId);
               this._returnId = (java.lang.String)value;
            ...
            case PROP_ID_deliveryLineId:{
               onInitProp(propId);
               this._deliveryLineId = (java.lang.String)value;
     ...
     * 退货单ID: RETURN_ID
     */
    public final java.lang.String getReturnId(){
         onPropGet(PROP_ID_returnId);
         return _returnId;
    }
     ...
     * 退货单ID: RETURN_ID
     */
    public final void setReturnId(java.lang.String value){
        if(onPropSet(PROP_ID_returnId,value)){
            this._returnId = value;
            internalClearRefs(PROP_ID_returnId);
     ...
     * 出库行ID: DELIVERY_LINE_ID
     */
    public final java.lang.String getDeliveryLineId(){
     ...
     * 出库行ID: DELIVERY_LINE_ID
     */
    public final void setDeliveryLineId(java.lang.String value){
     ...
     * 
     */
    public final app.erp.sal.dao.entity.ErpSalReturn getReturn(){
       return (app.erp.sal.dao.entity.ErpSalReturn)internalGetRefEntity(PROP_NAME_return);
    }

    public final void setReturn(app.erp.sal.dao.entity.ErpSalReturn refEntity){
           ...
           internalSetRefEntity(PROP_NAME_return, refEntity,()->{
           
                           this.setReturnId(refEntity.getId());
     ...
     * 
     */
    public final app.erp.sal.dao.entity.ErpSalDeliveryLine getDeliveryLine(){
       return (app.erp.sal.dao.entity.ErpSalDeliveryLine)internalGetRefEntity(PROP_NAME_deliveryLine);
    }

    public final void setDeliveryLine(app.erp.sal.dao.entity.ErpSalDeliveryLine refEntity){
   
           if(refEntity == null){
           
                   this.setDeliveryLineId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_deliveryLine, refEntity,()->{
           
                           this.setDeliveryLineId(refEntity.getId());
