...
/**
 *  销售价格清单: erp_sal_price_list
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalPriceList extends DynamicOrmEntity{
    ...
    public _ErpSalPriceList(){
        // for debug
    }

    protected ErpSalPriceList newInstance(){
        ErpSalPriceList entity = new ErpSalPriceList();
    ...
    @Override
    public ErpSalPriceList cloneInstance() {
        ErpSalPriceList entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalPriceList";
    }
    ...
    private final OrmEntitySet<app.erp.sal.dao.entity.ErpSalPriceListLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.sal.dao.entity.ErpSalPriceListLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.sal.dao.entity.ErpSalPriceListLine> getLines(){
       return _lines;
    }
