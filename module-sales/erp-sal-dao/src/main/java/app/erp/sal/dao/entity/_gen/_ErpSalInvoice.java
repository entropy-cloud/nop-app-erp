...
/**
 *  销售发票: erp_sal_invoice
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalInvoice extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_receivedAmount = 15;
    ...
    /* 收款进度: RECEIVED_STATUS INTEGER */
    public static final String PROP_NAME_receivedStatus = "receivedStatus";
    public static final int PROP_ID_receivedStatus = 18;
    ...
    private java.lang.Integer _receivedStatus;
    ...
    public _ErpSalInvoice(){
        // for debug
    }

    protected ErpSalInvoice newInstance(){
        ErpSalInvoice entity = new ErpSalInvoice();
    ...
    @Override
    public ErpSalInvoice cloneInstance() {
        ErpSalInvoice entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalInvoice";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_invoiceNo:{
               onInitProp(propId);
               this._invoiceNo = (java.lang.String)value;
            ...
            case PROP_ID_receivedStatus:{
               onInitProp(propId);
               this._receivedStatus = (java.lang.Integer)value;
     ...
     * 发票号码: INVOICE_NO
     */
    public final void setInvoiceNo(java.lang.String value){
     ...
     * 收款进度: RECEIVED_STATUS
     */
    public final java.lang.Integer getReceivedStatus(){
     ...
     * 收款进度: RECEIVED_STATUS
     */
    public final void setReceivedStatus(java.lang.Integer value){
    ...
    private final OrmEntitySet<app.erp.sal.dao.entity.ErpSalInvoiceLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.sal.dao.entity.ErpSalInvoiceLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.sal.dao.entity.ErpSalInvoiceLine> getLines(){
       return _lines;
    }
