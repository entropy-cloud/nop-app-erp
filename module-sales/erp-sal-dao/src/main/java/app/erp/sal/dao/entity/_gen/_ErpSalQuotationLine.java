...
/**
 *  销售报价单行: erp_sal_quotation_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSalQuotationLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 报价单ID: QUOTATION_ID BIGINT */
    public static final String PROP_NAME_quotationId = "quotationId";
    public static final int PROP_ID_quotationId = 2;
    ...
    public _ErpSalQuotationLine(){
        // for debug
    }

    protected ErpSalQuotationLine newInstance(){
        ErpSalQuotationLine entity = new ErpSalQuotationLine();
    ...
    @Override
    public ErpSalQuotationLine cloneInstance() {
        ErpSalQuotationLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.sal.dao.entity.ErpSalQuotationLine";
    }
