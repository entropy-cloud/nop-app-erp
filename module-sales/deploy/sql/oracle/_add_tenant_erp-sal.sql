...
alter table erp_sal_price_list add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_sal_pricing_rule add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_sal_receipt add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_sal_price_list_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
