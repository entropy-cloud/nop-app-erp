//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpSalPricingRuleOutputBean {
        ...
        private String _targetType_label;

    
        public String getTargetType_label(){
            return _targetType_label;
        }

        public void setTargetType_label(String value){
            this._targetType_label = value;
        }
        ...
        private Map<String,Object> _giftMaterial;

        public Map<String,Object> getGiftMaterial(){
            return _giftMaterial;
        }

        public void setGiftMaterial(Map<String,Object> value){
            this._giftMaterial = value;
        }


        private Map<String,Object> _giftSku;

        public Map<String,Object> getGiftSku(){
            return _giftSku;
        }

        public void setGiftSku(Map<String,Object> value){
            this._giftSku = value;
        }
