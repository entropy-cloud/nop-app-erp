//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpSalQuotationInputBean extends CrudInputBase {
        ...
        private List<ErpSalQuotationLineInputBean> _lines;

        public List<ErpSalQuotationLineInputBean> getLines(){
            return _lines;
        }

        public void setLines(List<ErpSalQuotationLineInputBean> value){
            this._lines = value;
        }
