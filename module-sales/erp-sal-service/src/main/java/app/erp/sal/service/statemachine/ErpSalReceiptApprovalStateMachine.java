 ...
 *
 * <p>非法边直抛领域码 {@link ErpSalErrors#ERR_RECEIPT_ILLEGAL_STATUS_TRANSITION}（参数 {@code action}/
 * {@code currentStatus}/{@code expectedStatus}；plan 2026-09-07-2200-1）；实体元数据（{@code receiptCode}）
