...
/**
 * ErpSalReceipt reject per-mutation Processor (plan 2026-07-30-1433-2 R5.2；审批轴 Bean 接线 plan 2026-08-13-1950-2 M4.26)。
 *
...
public class ErpSalReceiptRejectProcessor extends AbstractRejectProcessor<ErpSalReceipt> {
    ...
    @Override
    protected void validateTransitionForReject(ErpSalReceipt entity, IServiceContext context) {
        try {
