...
/**
 * ErpSalQuotation cancel per-mutation Processor (plan 2026-07-25-1057-2).
 * Extends AbstractCancelProcessor to activate the abstract base class; delegates to ErpSalQuotationProcessor
...
public class ErpSalQuotationCancelProcessor extends AbstractCancelProcessor<ErpSalQuotation> {
    ...
    @Override
    public ErpSalQuotation cancel(String id, IServiceContext context) {
