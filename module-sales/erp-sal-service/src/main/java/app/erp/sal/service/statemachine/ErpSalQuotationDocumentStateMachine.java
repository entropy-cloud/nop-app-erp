 ...
 *
 * <p>非法边直抛领域码 {@link ErpSalErrors#ERR_QUOTATION_ILLEGAL_DOC_STATUS_TRANSITION}（参数 {@code action}/
 * {@code currentDocStatus}/{@code expectedDocStatus}；plan 2026-09-07-2200-1）；实体元数据（{@code quotationCode}）
...
public class ErpSalQuotationDocumentStateMachine {
     ...
     *
     * <p>对 CANCELLED 直抛领域码 {@code ERR_QUOTATION_ILLEGAL_DOC_STATUS_TRANSITION}
