...
/**
 * ErpSalQuotation reject per-mutation Processor (plan 2026-07-30-1433-2 R5.2；审批轴 Bean 接线 plan 2026-08-13-0945-2 M3.6)。
 *
...
public class ErpSalQuotationRejectProcessor extends AbstractRejectProcessor<ErpSalQuotation> {
    ...
    @Override
    protected void validateTransitionForReject(ErpSalQuotation entity, IServiceContext context) {
        try {
