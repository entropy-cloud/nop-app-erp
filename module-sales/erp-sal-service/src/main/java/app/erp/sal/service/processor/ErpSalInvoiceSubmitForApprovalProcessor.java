...
/**
 * ErpSalInvoice submitForApproval per-mutation Processor (plan 2026-07-30-1433-2 R5.2；审批轴 Bean 接线 plan 2026-08-13-1950-2 M4.24)。
 *
 ...
 * 动态业务守卫（requireLinesNonEmpty/requireCustomerActive）保留原位。
 */
public class ErpSalInvoiceSubmitForApprovalProcessor extends AbstractSubmitForApprovalProcessor<ErpSalInvoice> {
    ...
    @Override
    protected void validateTransitionForSubmit(ErpSalInvoice entity, IServiceContext context) {
        try {
