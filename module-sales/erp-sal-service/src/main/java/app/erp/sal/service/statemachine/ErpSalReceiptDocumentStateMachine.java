 ...
 *
 * <p>接线方 {@code ErpSalReceiptCancelProcessor} 将 common 码映射为领域码
 * {@code ERR_RECEIPT_ILLEGAL_DOC_STATUS_TRANSITION}。
 */
public class ErpSalReceiptDocumentStateMachine {
     ...
     * 接线方 {@code ErpSalReceiptCancelProcessor} 映射为领域码 {@code ERR_RECEIPT_ILLEGAL_DOC_STATUS_TRANSITION}。
     */
