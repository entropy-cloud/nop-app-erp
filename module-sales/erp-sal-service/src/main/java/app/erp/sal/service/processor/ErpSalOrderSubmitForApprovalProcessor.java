...
/**
 * ErpSalOrder submitForApproval per-mutation Processor (plan 2026-07-30-1433-2 R5.2).
 * Runs the AbstractSubmitForApprovalProcessor skeleton; delegates domain-specific hooks to ErpSalOrderProcessor.
 */
