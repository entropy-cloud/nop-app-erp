...
// 族 A/U20 豁免登记：本类为非 BizModel 服务组件（processor-extension-pattern 惯例）；daoFor 目标（ErpSalDelivery）=同域实体批量聚合，只读批量聚合，逐条 I*Biz 管道不适用批量场景。
/**
 * ErpSalDelivery reject per-mutation Processor (plan 2026-07-30-1433-2 R5.2；审批轴 Bean 接线 plan 2026-08-13-1950-2 M4.22)。
 *
...
public class ErpSalDeliveryRejectProcessor extends AbstractRejectProcessor<ErpSalDelivery> {
    ...
    @Override
    protected void validateTransitionForReject(ErpSalDelivery entity, IServiceContext context) {
        try {
