 ...
 * 不编码入边）。
 *
 * <p>接线方 {@code ErpSalDeliveryCancelProcessor} 将 common 码映射为领域码
 * {@code ERR_ILLEGAL_DOC_STATUS_TRANSITION}（泛型命名漂移，路线图 Non-Goal 不重命名）。
 */
public class ErpSalDeliveryDocumentStateMachine {
     ...
     * 接线方 {@code ErpSalDeliveryCancelProcessor} 映射为领域码 {@code ERR_ILLEGAL_DOC_STATUS_TRANSITION}。
     */
