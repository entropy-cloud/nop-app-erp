...
/**
 * 销售过账执行器：跨域经凭证聚合根 Facade {@link IErpFinVoucherBiz} 调用财务过账引擎
 ...
 * {@code InvPostingExecutor.java} / {@code PurPostingExecutor.java}。调用方（SalInvoicePostingDispatcher /
 * SalReceiptPostingDispatcher）以 try/catch 包裹本方法返回值/异常。
 */
public class SalPostingExecutor {
