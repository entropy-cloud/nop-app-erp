...
/**
 *  DRP仿真参数: erp_drp_scenario_param
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpDrpScenarioParam extends DynamicOrmEntity{
    ...
    public _ErpDrpScenarioParam(){
        // for debug
    }

    protected ErpDrpScenarioParam newInstance(){
        ErpDrpScenarioParam entity = new ErpDrpScenarioParam();
    ...
    @Override
    public ErpDrpScenarioParam cloneInstance() {
        ErpDrpScenarioParam entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.drp.dao.entity.ErpDrpScenarioParam";
    }
