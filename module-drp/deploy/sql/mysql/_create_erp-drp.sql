...
CREATE TABLE erp_drp_plan(
  ...
  RUN_AT DATETIME(3) NULL    COMMENT '运行时间',
...
CREATE TABLE erp_inv_drp_safety_stock_calc(
  ...
  METHOD VARCHAR(20) NOT NULL    COMMENT '计算方法',
  SERVICE_LEVEL VARCHAR(20) NOT NULL    COMMENT '服务水平',
...
CREATE TABLE erp_drp_parameter(
  ...
  REPLENISHMENT_METHOD VARCHAR(20) NOT NULL    COMMENT '补货方法',
...
CREATE TABLE erp_drp_line(
  ...
  REPLENISHMENT_TYPE VARCHAR(20) NOT NULL    COMMENT '补货类型',
...
CREATE TABLE erp_inv_drp_cross_dock(
  ...
  DOCK_SLOT_TIME DATETIME(3) NULL    COMMENT '月台时间窗口',
  STATUS VARCHAR(20) NOT NULL    COMMENT '状态',
  MATCHED_AT DATETIME(3) NULL    COMMENT '匹配时间',
  LOADED_AT DATETIME(3) NULL    COMMENT '装车完成时间',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
...
CREATE TABLE erp_inv_drp_dock_appointment(
  ...
  SLOT_START DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '时间窗口开始',
  SLOT_END DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '时间窗口结束',
