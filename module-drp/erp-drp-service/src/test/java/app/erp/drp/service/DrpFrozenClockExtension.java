...
/**
 * 冻结 {@link CoreMetrics} 时钟到 drp 日期敏感型 auto-test 快照的参考日 {@link #REFERENCE_DATE}，
 * 使依赖 {@code CoreMetrics.today()}/{@code CoreMetrics.currentDate()} 派生的快照跨日稳定，
 * 不再随系统日历翻页而漂移。
 *
 ...
 */
public final class DrpFrozenClockExtension implements BeforeAllCallback, AfterAllCallback {
