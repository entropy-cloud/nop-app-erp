 ...
 *
 * <p>非法边直抛领域码 {@link ErpDrpErrors#ERR_DRP_PLAN_ILLEGAL_TRANSITION}（参数 {@code currentStatus}/
 * {@code expectedStatus}/{@code action}；plan 2026-09-07-2200-1 直抛领域码）；实体元数据（planCode）
 * 经调用点同码补参补齐。
 *
...
public class ErpDrpPlanStateMachine {
    ...
    private static NopException illegal(String action, String currentStatus, String expectedStatus) {
        return new NopException(ErpDrpErrors.ERR_DRP_PLAN_ILLEGAL_TRANSITION)
