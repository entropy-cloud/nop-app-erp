//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpDrpScenarioVersionOutputBean {
        ...
        private Map<String,Object> _computedDrpPlan;

        public Map<String,Object> getComputedDrpPlan(){
            return _computedDrpPlan;
        }

        public void setComputedDrpPlan(Map<String,Object> value){
            this._computedDrpPlan = value;
        }
