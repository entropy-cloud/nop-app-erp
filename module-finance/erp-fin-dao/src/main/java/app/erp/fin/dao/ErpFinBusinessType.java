...
public enum ErpFinBusinessType {
    ...
    MAINTENANCE_CAPITALIZATION(480),
    LANDED_COST(490),
    MAINTENANCE_ISSUE(492),
    MAINTENANCE_LABOR(493),
    MANUFACTURING_RECEIPT(500),
    MANUFACTURING_ISSUE(501),
    SUBCONTRACT_ISSUE(502),
    SUBCONTRACT_RECEIPT(503),
    SUBCONTRACT_FEE(504);
