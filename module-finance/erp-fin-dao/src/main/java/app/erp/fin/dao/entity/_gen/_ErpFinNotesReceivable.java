...
/**
 *  应收票据: erp_fin_notes_receivable
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinNotesReceivable extends DynamicOrmEntity{
    ...
    /* 票据号: NOTES_NO VARCHAR */
    public static final String PROP_NAME_notesNo = "notesNo";
    public static final int PROP_ID_notesNo = 5;
    
    /* 出票人: DRAWER_NAME VARCHAR */
    public static final String PROP_NAME_drawerName = "drawerName";
    public static final int PROP_ID_drawerName = 6;
    
    /* 出票行: DRAWER_BANK VARCHAR */
    public static final String PROP_NAME_drawerBank = "drawerBank";
    public static final int PROP_ID_drawerBank = 7;
    
    /* 收款人: PAYEE_NAME VARCHAR */
    public static final String PROP_NAME_payeeName = "payeeName";
    public static final int PROP_ID_payeeName = 8;
    
    /* 出票日: ISSUE_DATE DATE */
    public static final String PROP_NAME_issueDate = "issueDate";
    public static final int PROP_ID_issueDate = 9;
    
    /* 到期日: DUE_DATE DATE */
    public static final String PROP_NAME_dueDate = "dueDate";
    public static final int PROP_ID_dueDate = 10;
    ...
    /* 出票客户往来: PARTNER_ID BIGINT */
    public static final String PROP_NAME_partnerId = "partnerId";
    public static final int PROP_ID_partnerId = 15;
    
    /* 背书来源票据: ENDORSEMENT_FROM_ID BIGINT */
    public static final String PROP_NAME_endorsementFromId = "endorsementFromId";
    public static final int PROP_ID_endorsementFromId = 16;
    
    /* 来源单据类型: SOURCE_BILL_TYPE VARCHAR */
    public static final String PROP_NAME_sourceBillType = "sourceBillType";
    public static final int PROP_ID_sourceBillType = 17;
    
    /* 来源单据号: SOURCE_BILL_CODE VARCHAR */
    public static final String PROP_NAME_sourceBillCode = "sourceBillCode";
    public static final int PROP_ID_sourceBillCode = 18;
    
    /* 贴现明细: DISCOUNT_ID BIGINT */
    public static final String PROP_NAME_discountId = "discountId";
    public static final int PROP_ID_discountId = 19;
    
    /* 票据状态: STATUS VARCHAR */
    public static final String PROP_NAME_status = "status";
    public static final int PROP_ID_status = 20;
    ...
    /* relation:  */
    public static final String PROP_NAME_endorsementFrom = "endorsementFrom";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_notesType] = PROP_NAME_notesType;
          PROP_NAME_TO_ID.put(PROP_NAME_notesType, PROP_ID_notesType);
      
          PROP_ID_TO_NAME[PROP_ID_notesNo] = PROP_NAME_notesNo;
          PROP_NAME_TO_ID.put(PROP_NAME_notesNo, PROP_ID_notesNo);
      
          PROP_ID_TO_NAME[PROP_ID_drawerName] = PROP_NAME_drawerName;
          PROP_NAME_TO_ID.put(PROP_NAME_drawerName, PROP_ID_drawerName);
      
          PROP_ID_TO_NAME[PROP_ID_drawerBank] = PROP_NAME_drawerBank;
          PROP_NAME_TO_ID.put(PROP_NAME_drawerBank, PROP_ID_drawerBank);
      
          PROP_ID_TO_NAME[PROP_ID_payeeName] = PROP_NAME_payeeName;
          PROP_NAME_TO_ID.put(PROP_NAME_payeeName, PROP_ID_payeeName);
      
          PROP_ID_TO_NAME[PROP_ID_issueDate] = PROP_NAME_issueDate;
          PROP_NAME_TO_ID.put(PROP_NAME_issueDate, PROP_ID_issueDate);
          ...
          PROP_ID_TO_NAME[PROP_ID_endorsementFromId] = PROP_NAME_endorsementFromId;
          PROP_NAME_TO_ID.put(PROP_NAME_endorsementFromId, PROP_ID_endorsementFromId);
          ...
          PROP_ID_TO_NAME[PROP_ID_discountId] = PROP_NAME_discountId;
          PROP_NAME_TO_ID.put(PROP_NAME_discountId, PROP_ID_discountId);
    ...
    /* 出票人: DRAWER_NAME */
    private java.lang.String _drawerName;
    
    /* 出票行: DRAWER_BANK */
    private java.lang.String _drawerBank;
    
    /* 收款人: PAYEE_NAME */
    private java.lang.String _payeeName;
    ...
    /* 源币种票面金额: AMOUNT_SOURCE */
    private java.math.BigDecimal _amountSource;
    
    /* 本位币票面金额: AMOUNT_FUNCTIONAL */
    ...
    public _ErpFinNotesReceivable(){
        // for debug
    }

    protected ErpFinNotesReceivable newInstance(){
        ErpFinNotesReceivable entity = new ErpFinNotesReceivable();
    ...
    @Override
    public ErpFinNotesReceivable cloneInstance() {
        ErpFinNotesReceivable entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinNotesReceivable";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_notesNo:
               return getNotesNo();
        
            case PROP_ID_drawerName:
               return getDrawerName();
        
            case PROP_ID_drawerBank:
               return getDrawerBank();
        
            case PROP_ID_payeeName:
               return getPayeeName();
        
            case PROP_ID_issueDate:
               return getIssueDate();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_notesNo:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_notesNo));
               }
               setNotesNo(typedValue);
               break;
            }
            ...
            case PROP_ID_drawerName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_drawerName));
               }
               setDrawerName(typedValue);
               break;
            }
            ...
            case PROP_ID_drawerBank:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_drawerBank));
               }
               setDrawerBank(typedValue);
               break;
            }
            ...
            case PROP_ID_payeeName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_payeeName));
               }
               setPayeeName(typedValue);
               break;
            }
            ...
            case PROP_ID_issueDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_issueDate));
               }
               setIssueDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_notesNo:{
               onInitProp(propId);
               this._notesNo = (java.lang.String)value;
            ...
            case PROP_ID_drawerName:{
               onInitProp(propId);
               this._drawerName = (java.lang.String)value;
            ...
            case PROP_ID_drawerBank:{
               onInitProp(propId);
               this._drawerBank = (java.lang.String)value;
            ...
            case PROP_ID_payeeName:{
               onInitProp(propId);
               this._payeeName = (java.lang.String)value;
            ...
            case PROP_ID_issueDate:{
               onInitProp(propId);
               this._issueDate = (java.time.LocalDate)value;
     ...
     * 票据号: NOTES_NO
     */
    public final java.lang.String getNotesNo(){
         onPropGet(PROP_ID_notesNo);
         return _notesNo;
    }
     ...
     * 票据号: NOTES_NO
     */
    public final void setNotesNo(java.lang.String value){
        if(onPropSet(PROP_ID_notesNo,value)){
            this._notesNo = value;
            internalClearRefs(PROP_ID_notesNo);
     ...
     * 出票人: DRAWER_NAME
     */
    public final java.lang.String getDrawerName(){
         onPropGet(PROP_ID_drawerName);
         return _drawerName;
    }
     ...
     * 出票人: DRAWER_NAME
     */
    public final void setDrawerName(java.lang.String value){
        if(onPropSet(PROP_ID_drawerName,value)){
            this._drawerName = value;
            internalClearRefs(PROP_ID_drawerName);
     ...
     * 出票行: DRAWER_BANK
     */
    public final java.lang.String getDrawerBank(){
         onPropGet(PROP_ID_drawerBank);
         return _drawerBank;
    }
     ...
     * 出票行: DRAWER_BANK
     */
    public final void setDrawerBank(java.lang.String value){
        if(onPropSet(PROP_ID_drawerBank,value)){
            this._drawerBank = value;
            internalClearRefs(PROP_ID_drawerBank);
     ...
     * 收款人: PAYEE_NAME
     */
    public final void setPayeeName(java.lang.String value){
        if(onPropSet(PROP_ID_payeeName,value)){
            this._payeeName = value;
            internalClearRefs(PROP_ID_payeeName);
     ...
     * 出票日: ISSUE_DATE
     */
    public final java.time.LocalDate getIssueDate(){
         onPropGet(PROP_ID_issueDate);
         return _issueDate;
    }
     ...
     * 出票日: ISSUE_DATE
     */
    public final void setIssueDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_issueDate,value)){
            this._issueDate = value;
            internalClearRefs(PROP_ID_issueDate);
     ...
     * 
     */
    public final app.erp.fin.dao.entity.ErpFinNotesReceivable getEndorsementFrom(){
       return (app.erp.fin.dao.entity.ErpFinNotesReceivable)internalGetRefEntity(PROP_NAME_endorsementFrom);
    }

    public final void setEndorsementFrom(app.erp.fin.dao.entity.ErpFinNotesReceivable refEntity){
   
           if(refEntity == null){
           
                   this.setEndorsementFromId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_endorsementFrom, refEntity,()->{
           
                           this.setEndorsementFromId(refEntity.getId());
