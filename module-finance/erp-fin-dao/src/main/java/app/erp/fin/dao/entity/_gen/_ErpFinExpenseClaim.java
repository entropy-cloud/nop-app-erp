...
/**
 *  费用报销单: erp_fin_expense_claim
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinExpenseClaim extends DynamicOrmEntity{
    ...
    /* 报销人: CLAIMANT_ID BIGINT */
    public static final String PROP_NAME_claimantId = "claimantId";
    public static final int PROP_ID_claimantId = 4;
    
    /* 部门: DEPARTMENT_ID BIGINT */
    public static final String PROP_NAME_departmentId = "departmentId";
    public static final int PROP_ID_departmentId = 5;
    ...
    public static final int PROP_ID_amountWithoutTax = 12;
    
    /* 税额: TAX_AMOUNT DECIMAL */
    public static final String PROP_NAME_taxAmount = "taxAmount";
    public static final int PROP_ID_taxAmount = 13;
    
    /* 价税合计: AMOUNT_WITH_TAX DECIMAL */
    public static final String PROP_NAME_amountWithTax = "amountWithTax";
    public static final int PROP_ID_amountWithTax = 14;
    
    /* 抵扣借款单: SETTLE_ADVANCE_ID BIGINT */
    public static final String PROP_NAME_settleAdvanceId = "settleAdvanceId";
    public static final int PROP_ID_settleAdvanceId = 15;
    ...
    public static final int PROP_ID_approvedBy = 19;
    
    /* 审核时间: APPROVED_AT DATETIME */
    public static final String PROP_NAME_approvedAt = "approvedAt";
    public static final int PROP_ID_approvedAt = 20;
    ...
    /* relation:  */
    public static final String PROP_NAME_claimant = "claimant";
    ...
    /* relation:  */
    public static final String PROP_NAME_settleAdvance = "settleAdvance";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_claimantId] = PROP_NAME_claimantId;
          PROP_NAME_TO_ID.put(PROP_NAME_claimantId, PROP_ID_claimantId);
          ...
          PROP_ID_TO_NAME[PROP_ID_paymentMode] = PROP_NAME_paymentMode;
          PROP_NAME_TO_ID.put(PROP_NAME_paymentMode, PROP_ID_paymentMode);
          ...
          PROP_ID_TO_NAME[PROP_ID_settleAdvanceId] = PROP_NAME_settleAdvanceId;
          PROP_NAME_TO_ID.put(PROP_NAME_settleAdvanceId, PROP_ID_settleAdvanceId);
    ...
    public _ErpFinExpenseClaim(){
        // for debug
    }

    protected ErpFinExpenseClaim newInstance(){
        ErpFinExpenseClaim entity = new ErpFinExpenseClaim();
    ...
    @Override
    public ErpFinExpenseClaim cloneInstance() {
        ErpFinExpenseClaim entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinExpenseClaim";
    }
     ...
     * 
     */
    public final app.erp.md.dao.entity.ErpMdEmployee getClaimant(){
       return (app.erp.md.dao.entity.ErpMdEmployee)internalGetRefEntity(PROP_NAME_claimant);
    }

    public final void setClaimant(app.erp.md.dao.entity.ErpMdEmployee refEntity){
   
           if(refEntity == null){
           
                   this.setClaimantId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_claimant, refEntity,()->{
           
                           this.setClaimantId(refEntity.getId());
     ...
     * 
     */
    public final app.erp.fin.dao.entity.ErpFinEmployeeAdvance getSettleAdvance(){
       return (app.erp.fin.dao.entity.ErpFinEmployeeAdvance)internalGetRefEntity(PROP_NAME_settleAdvance);
    }

    public final void setSettleAdvance(app.erp.fin.dao.entity.ErpFinEmployeeAdvance refEntity){
   
           if(refEntity == null){
           
                   this.setSettleAdvanceId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_settleAdvance, refEntity,()->{
           
                           this.setSettleAdvanceId(refEntity.getId());
    ...
    private final OrmEntitySet<app.erp.fin.dao.entity.ErpFinExpenseClaimLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.fin.dao.entity.ErpFinExpenseClaimLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.fin.dao.entity.ErpFinExpenseClaimLine> getLines(){
       return _lines;
    }
