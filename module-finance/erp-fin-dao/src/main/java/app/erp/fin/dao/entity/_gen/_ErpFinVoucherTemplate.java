...
/**
 *  凭证模板: erp_fin_voucher_template
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinVoucherTemplate extends DynamicOrmEntity{
    ...
    /* 账套(空表示所有账套通用): ACCT_SCHEMA_ID BIGINT */
    ...
    /* 模板类型: TEMPLATE_TYPE VARCHAR */
    public static final String PROP_NAME_templateType = "templateType";
    public static final int PROP_ID_templateType = 7;
    ...
    public _ErpFinVoucherTemplate(){
        // for debug
    }

    protected ErpFinVoucherTemplate newInstance(){
        ErpFinVoucherTemplate entity = new ErpFinVoucherTemplate();
    ...
    @Override
    public ErpFinVoucherTemplate cloneInstance() {
        ErpFinVoucherTemplate entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinVoucherTemplate";
    }
     ...
     */
    public final IOrmEntitySet<app.erp.fin.dao.entity.ErpFinVoucherTemplateLine> getLines(){
       return _lines;
    }
