...
/**
 *  AP 文档处理日志: erp_fin_ap_document_log
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinApDocumentLog extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* AP 文档: DOCUMENT_ID BIGINT */
    public static final String PROP_NAME_documentId = "documentId";
    public static final int PROP_ID_documentId = 2;
    
    /* 处理步骤: STEP VARCHAR */
    public static final String PROP_NAME_step = "step";
    public static final int PROP_ID_step = 3;
    ...
    public static final int PROP_ID_detail = 5;
    ...
    /* relation:  */
    public static final String PROP_NAME_document = "document";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_documentId] = PROP_NAME_documentId;
          PROP_NAME_TO_ID.put(PROP_NAME_documentId, PROP_ID_documentId);
      
          PROP_ID_TO_NAME[PROP_ID_step] = PROP_NAME_step;
          PROP_NAME_TO_ID.put(PROP_NAME_step, PROP_ID_step);
    ...
    public _ErpFinApDocumentLog(){
        // for debug
    }

    protected ErpFinApDocumentLog newInstance(){
        ErpFinApDocumentLog entity = new ErpFinApDocumentLog();
    ...
    @Override
    public ErpFinApDocumentLog cloneInstance() {
        ErpFinApDocumentLog entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinApDocumentLog";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_documentId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_documentId));
               }
               setDocumentId(typedValue);
               break;
            }
            ...
            case PROP_ID_step:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_step));
               }
               setStep(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_documentId:{
               onInitProp(propId);
               this._documentId = (java.lang.String)value;
            ...
            case PROP_ID_step:{
               onInitProp(propId);
               this._step = (java.lang.String)value;
    ...
    public final void setDocumentId(java.lang.String value){
        if(onPropSet(PROP_ID_documentId,value)){
            this._documentId = value;
            internalClearRefs(PROP_ID_documentId);
     ...
     * 处理步骤: STEP
     */
    public final void setStep(java.lang.String value){
        if(onPropSet(PROP_ID_step,value)){
            this._step = value;
            internalClearRefs(PROP_ID_step);
     ...
     * 
     */
    public final app.erp.fin.dao.entity.ErpFinApDocument getDocument(){
       return (app.erp.fin.dao.entity.ErpFinApDocument)internalGetRefEntity(PROP_NAME_document);
    }

    public final void setDocument(app.erp.fin.dao.entity.ErpFinApDocument refEntity){
           ...
           internalSetRefEntity(PROP_NAME_document, refEntity,()->{
           
                           this.setDocumentId(refEntity.getId());
