...
/**
 *  核销单: erp_fin_reconciliation
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinReconciliation extends DynamicOrmEntity{
    ...
    /* 核销总额(源币): TOTAL_AMOUNT_SOURCE DECIMAL */
    public static final String PROP_NAME_totalAmountSource = "totalAmountSource";
    public static final int PROP_ID_totalAmountSource = 10;
    
    /* 核销总额(本位币): TOTAL_AMOUNT_FUNCTIONAL DECIMAL */
    public static final String PROP_NAME_totalAmountFunctional = "totalAmountFunctional";
    public static final int PROP_ID_totalAmountFunctional = 11;
    
    /* 汇兑损益: FX_GAIN_LOSS DECIMAL */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_totalAmountSource] = PROP_NAME_totalAmountSource;
          PROP_NAME_TO_ID.put(PROP_NAME_totalAmountSource, PROP_ID_totalAmountSource);
      
          PROP_ID_TO_NAME[PROP_ID_totalAmountFunctional] = PROP_NAME_totalAmountFunctional;
          PROP_NAME_TO_ID.put(PROP_NAME_totalAmountFunctional, PROP_ID_totalAmountFunctional);
      
          PROP_ID_TO_NAME[PROP_ID_fxGainLoss] = PROP_NAME_fxGainLoss;
          PROP_NAME_TO_ID.put(PROP_NAME_fxGainLoss, PROP_ID_fxGainLoss);
    ...
    public _ErpFinReconciliation(){
        // for debug
    }

    protected ErpFinReconciliation newInstance(){
        ErpFinReconciliation entity = new ErpFinReconciliation();
    ...
    @Override
    public ErpFinReconciliation cloneInstance() {
        ErpFinReconciliation entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinReconciliation";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_totalAmountSource:
               return getTotalAmountSource();
        
            case PROP_ID_totalAmountFunctional:
               return getTotalAmountFunctional();
        
            case PROP_ID_fxGainLoss:
               return getFxGainLoss();
    ...
    private final OrmEntitySet<app.erp.fin.dao.entity.ErpFinReconciliationLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.fin.dao.entity.ErpFinReconciliationLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.fin.dao.entity.ErpFinReconciliationLine> getLines(){
       return _lines;
    }
