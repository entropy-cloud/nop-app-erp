...
/**
 *  总账余额: erp_fin_gl_balance
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinGlBalance extends DynamicOrmEntity{
    ...
    /* 期初借方(本位币): OPENING_DEBIT DECIMAL */
    public static final String PROP_NAME_openingDebit = "openingDebit";
    public static final int PROP_ID_openingDebit = 7;
    
    /* 期初贷方(本位币): OPENING_CREDIT DECIMAL */
    public static final String PROP_NAME_openingCredit = "openingCredit";
    public static final int PROP_ID_openingCredit = 8;
    
    /* 本期借方发生(本位币): PERIOD_DEBIT DECIMAL */
    public static final String PROP_NAME_periodDebit = "periodDebit";
    public static final int PROP_ID_periodDebit = 9;
    
    /* 本期贷方发生(本位币): PERIOD_CREDIT DECIMAL */
    public static final String PROP_NAME_periodCredit = "periodCredit";
    public static final int PROP_ID_periodCredit = 10;
    
    /* 期末借方(本位币): CLOSING_DEBIT DECIMAL */
    public static final String PROP_NAME_closingDebit = "closingDebit";
    public static final int PROP_ID_closingDebit = 11;
    
    /* 期末贷方(本位币): CLOSING_CREDIT DECIMAL */
    public static final String PROP_NAME_closingCredit = "closingCredit";
    public static final int PROP_ID_closingCredit = 12;
    
    /* 年初借方: YEAR_OPENING_DEBIT DECIMAL */
    public static final String PROP_NAME_yearOpeningDebit = "yearOpeningDebit";
    public static final int PROP_ID_yearOpeningDebit = 13;
    
    /* 年初贷方: YEAR_OPENING_CREDIT DECIMAL */
    public static final String PROP_NAME_yearOpeningCredit = "yearOpeningCredit";
    public static final int PROP_ID_yearOpeningCredit = 14;
    ...
    public static final int PROP_ID_warehouseId = 18;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_yearOpeningDebit] = PROP_NAME_yearOpeningDebit;
          PROP_NAME_TO_ID.put(PROP_NAME_yearOpeningDebit, PROP_ID_yearOpeningDebit);
      
          PROP_ID_TO_NAME[PROP_ID_yearOpeningCredit] = PROP_NAME_yearOpeningCredit;
          PROP_NAME_TO_ID.put(PROP_NAME_yearOpeningCredit, PROP_ID_yearOpeningCredit);
    ...
    public _ErpFinGlBalance(){
        // for debug
    }

    protected ErpFinGlBalance newInstance(){
        ErpFinGlBalance entity = new ErpFinGlBalance();
    ...
    @Override
    public ErpFinGlBalance cloneInstance() {
        ErpFinGlBalance entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinGlBalance";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_yearOpeningDebit:
               return getYearOpeningDebit();
        
            case PROP_ID_yearOpeningCredit:
               return getYearOpeningCredit();
