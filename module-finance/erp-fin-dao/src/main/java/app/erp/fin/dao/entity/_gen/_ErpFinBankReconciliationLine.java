...
/**
 *  银行对账调整行: erp_fin_bank_reconciliation_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinBankReconciliationLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 对账记录ID: RECONCILIATION_ID BIGINT */
    ...
    public static final int PROP_ID_adjustmentType = 4;
    ...
    public static final int PROP_ID_side = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_adjustmentType] = PROP_NAME_adjustmentType;
          PROP_NAME_TO_ID.put(PROP_NAME_adjustmentType, PROP_ID_adjustmentType);
    ...
    public _ErpFinBankReconciliationLine(){
        // for debug
    }

    protected ErpFinBankReconciliationLine newInstance(){
        ErpFinBankReconciliationLine entity = new ErpFinBankReconciliationLine();
    ...
    @Override
    public ErpFinBankReconciliationLine cloneInstance() {
        ErpFinBankReconciliationLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinBankReconciliationLine";
    }
     ...
     * 
     */
    public final app.erp.fin.dao.entity.ErpFinBankReconciliation getReconciliation(){
       return (app.erp.fin.dao.entity.ErpFinBankReconciliation)internalGetRefEntity(PROP_NAME_reconciliation);
    }

    public final void setReconciliation(app.erp.fin.dao.entity.ErpFinBankReconciliation refEntity){
