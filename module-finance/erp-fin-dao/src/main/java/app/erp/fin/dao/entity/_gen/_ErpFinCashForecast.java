...
/**
 *  现金预测: erp_fin_cash_forecast
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinCashForecast extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_fundAccountId = 3;
    
    /* 预测日期: FORECAST_DATE DATE */
    public static final String PROP_NAME_forecastDate = "forecastDate";
    public static final int PROP_ID_forecastDate = 4;
    ...
    public static final int PROP_ID_partnerId = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_forecastDate] = PROP_NAME_forecastDate;
          PROP_NAME_TO_ID.put(PROP_NAME_forecastDate, PROP_ID_forecastDate);
    ...
    public _ErpFinCashForecast(){
        // for debug
    }

    protected ErpFinCashForecast newInstance(){
        ErpFinCashForecast entity = new ErpFinCashForecast();
    ...
    @Override
    public ErpFinCashForecast cloneInstance() {
        ErpFinCashForecast entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinCashForecast";
    }
            ...
            case PROP_ID_forecastDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_forecastDate));
               }
               setForecastDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_forecastDate:{
               onInitProp(propId);
               this._forecastDate = (java.time.LocalDate)value;
     ...
     * 预测日期: FORECAST_DATE
     */
    public final java.time.LocalDate getForecastDate(){
         onPropGet(PROP_ID_forecastDate);
     ...
     * 预测日期: FORECAST_DATE
     */
    public final void setForecastDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_forecastDate,value)){
            this._forecastDate = value;
            internalClearRefs(PROP_ID_forecastDate);
