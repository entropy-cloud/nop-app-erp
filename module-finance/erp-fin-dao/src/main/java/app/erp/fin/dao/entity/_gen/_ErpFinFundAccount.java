...
/**
 *  资金账户: erp_fin_fund_account
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinFundAccount extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_bankName = 7;
    
    /* 银行账号: BANK_ACCOUNT VARCHAR */
    public static final String PROP_NAME_bankAccount = "bankAccount";
    public static final int PROP_ID_bankAccount = 8;
    ...
    /* 期初余额: OPENING_BALANCE DECIMAL */
    public static final String PROP_NAME_openingBalance = "openingBalance";
    public static final int PROP_ID_openingBalance = 10;
    
    /* 当前余额: CURRENT_BALANCE DECIMAL */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_openingBalance] = PROP_NAME_openingBalance;
          PROP_NAME_TO_ID.put(PROP_NAME_openingBalance, PROP_ID_openingBalance);
      
          PROP_ID_TO_NAME[PROP_ID_currentBalance] = PROP_NAME_currentBalance;
          PROP_NAME_TO_ID.put(PROP_NAME_currentBalance, PROP_ID_currentBalance);
    ...
    private java.lang.String _openingBalance;
    
    /* 当前余额: CURRENT_BALANCE */
    private java.lang.String _currentBalance;
    ...
    public _ErpFinFundAccount(){
        // for debug
    }

    protected ErpFinFundAccount newInstance(){
        ErpFinFundAccount entity = new ErpFinFundAccount();
    ...
    @Override
    public ErpFinFundAccount cloneInstance() {
        ErpFinFundAccount entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinFundAccount";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_openingBalance:
               return getOpeningBalance();
        
            case PROP_ID_currentBalance:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_openingBalance:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_openingBalance));
               }
               setOpeningBalance(typedValue);
               break;
            }
            ...
            case PROP_ID_currentBalance:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_currentBalance));
               }
               setCurrentBalance(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_openingBalance:{
               onInitProp(propId);
               this._openingBalance = (java.lang.String)value;
            ...
            case PROP_ID_currentBalance:{
               onInitProp(propId);
               this._currentBalance = (java.lang.String)value;
     ...
     * 期初余额: OPENING_BALANCE
     */
    public final java.lang.String getOpeningBalance(){
         onPropGet(PROP_ID_openingBalance);
     ...
     * 期初余额: OPENING_BALANCE
     */
    public final void setOpeningBalance(java.lang.String value){
        if(onPropSet(PROP_ID_openingBalance,value)){
            this._openingBalance = value;
            internalClearRefs(PROP_ID_openingBalance);
     ...
     * 当前余额: CURRENT_BALANCE
     */
    public final java.lang.String getCurrentBalance(){
         onPropGet(PROP_ID_currentBalance);
     ...
     * 当前余额: CURRENT_BALANCE
     */
    public final void setCurrentBalance(java.lang.String value){
        if(onPropSet(PROP_ID_currentBalance,value)){
            this._currentBalance = value;
            internalClearRefs(PROP_ID_currentBalance);
