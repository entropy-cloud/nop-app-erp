...
/**
 *  核销单行: erp_fin_reconciliation_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpFinReconciliationLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 核销单ID: RECONCILIATION_ID BIGINT */
    public static final String PROP_NAME_reconciliationId = "reconciliationId";
    public static final int PROP_ID_reconciliationId = 2;
    
    /* 行号: LINE_NO INTEGER */
    public static final String PROP_NAME_lineNo = "lineNo";
    public static final int PROP_ID_lineNo = 3;
    
    /* 付款/收款项(invoice or payment item): PAYMENT_ITEM_ID BIGINT */
    public static final String PROP_NAME_paymentItemId = "paymentItemId";
    public static final int PROP_ID_paymentItemId = 4;
    
    /* 被核销发票项: INVOICE_ITEM_ID BIGINT */
    public static final String PROP_NAME_invoiceItemId = "invoiceItemId";
    public static final int PROP_ID_invoiceItemId = 5;
    
    /* 核销金额(源币): SETTLED_AMOUNT_SOURCE DECIMAL */
    public static final String PROP_NAME_settledAmountSource = "settledAmountSource";
    public static final int PROP_ID_settledAmountSource = 6;
    
    /* 核销金额(本位币): SETTLED_AMOUNT_FUNCTIONAL DECIMAL */
    public static final String PROP_NAME_settledAmountFunctional = "settledAmountFunctional";
    public static final int PROP_ID_settledAmountFunctional = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_reconciliationId] = PROP_NAME_reconciliationId;
          PROP_NAME_TO_ID.put(PROP_NAME_reconciliationId, PROP_ID_reconciliationId);
      
          PROP_ID_TO_NAME[PROP_ID_lineNo] = PROP_NAME_lineNo;
          PROP_NAME_TO_ID.put(PROP_NAME_lineNo, PROP_ID_lineNo);
      
          PROP_ID_TO_NAME[PROP_ID_paymentItemId] = PROP_NAME_paymentItemId;
          PROP_NAME_TO_ID.put(PROP_NAME_paymentItemId, PROP_ID_paymentItemId);
      
          PROP_ID_TO_NAME[PROP_ID_invoiceItemId] = PROP_NAME_invoiceItemId;
          PROP_NAME_TO_ID.put(PROP_NAME_invoiceItemId, PROP_ID_invoiceItemId);
    ...
    public _ErpFinReconciliationLine(){
        // for debug
    }

    protected ErpFinReconciliationLine newInstance(){
        ErpFinReconciliationLine entity = new ErpFinReconciliationLine();
    ...
    @Override
    public ErpFinReconciliationLine cloneInstance() {
        ErpFinReconciliationLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.fin.dao.entity.ErpFinReconciliationLine";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_reconciliationId:
               return getReconciliationId();
        
            case PROP_ID_lineNo:
               return getLineNo();
        
            case PROP_ID_paymentItemId:
               return getPaymentItemId();
     ...
     * 
     */
    public final app.erp.fin.dao.entity.ErpFinReconciliation getReconciliation(){
       return (app.erp.fin.dao.entity.ErpFinReconciliation)internalGetRefEntity(PROP_NAME_reconciliation);
    }

    public final void setReconciliation(app.erp.fin.dao.entity.ErpFinReconciliation refEntity){
   
           if(refEntity == null){
           
                   this.setReconciliationId(null);
