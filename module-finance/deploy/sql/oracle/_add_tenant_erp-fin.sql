...
alter table erp_fin_ap_document add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_fin_accounting_period add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_fund_account add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_reconciliation add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_notes_receivable add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_employee_advance add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_gl_mapping_rule add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_intercompany_transfer_price add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_ap_document_log add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_voucher_template_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_voucher add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_accounting_period_status add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_ar_ap_item add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_gl_balance add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_trial_balance add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_bank_statement add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_credit_facility add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_cash_forecast add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_notes_discount add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_expense_claim add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_fin_intercompany_match add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_reconciliation_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_bad_debt add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_bank_reconciliation add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_notes_payable add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_expense_claim_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_bank_statement_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_budget_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_budget_rollforward_log add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_budget_carry_forward_log add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_consolidation_elimination add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_bank_reconciliation_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_fin_budget_control_log add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_fin_gl_mapping_rule drop constraint PK_erp_fin_gl_mapping_rule;
alter table erp_fin_gl_mapping_rule add constraint PK_erp_fin_gl_mapping_rule primary key (NOP_TENANT_ID, ID);
...
alter table erp_fin_intercompany_match drop constraint PK_erp_fin_intercompany_match;
alter table erp_fin_intercompany_match add constraint PK_erp_fin_intercompany_match primary key (NOP_TENANT_ID, ID);
...
alter table erp_fin_bad_debt drop constraint PK_erp_fin_bad_debt;
alter table erp_fin_bad_debt add constraint PK_erp_fin_bad_debt primary key (NOP_TENANT_ID, ID);
...
alter table erp_fin_budget_line drop constraint PK_erp_fin_budget_line;
alter table erp_fin_budget_line add constraint PK_erp_fin_budget_line primary key (NOP_TENANT_ID, ID);

alter table erp_fin_budget_rollforward_log drop constraint PK_erp_fin_budget_rollforward_log;
alter table erp_fin_budget_rollforward_log add constraint PK_erp_fin_budget_rollforward_log primary key (NOP_TENANT_ID, ID);

alter table erp_fin_budget_carry_forward_log drop constraint PK_erp_fin_budget_carry_forward_log;
alter table erp_fin_budget_carry_forward_log add constraint PK_erp_fin_budget_carry_forward_log primary key (NOP_TENANT_ID, ID);

alter table erp_fin_consolidation_elimination drop constraint PK_erp_fin_consolidation_elimination;
alter table erp_fin_consolidation_elimination add constraint PK_erp_fin_consolidation_elimination primary key (NOP_TENANT_ID, ID);
...
alter table erp_fin_budget_control_log drop constraint PK_erp_fin_budget_control_log;
alter table erp_fin_budget_control_log add constraint PK_erp_fin_budget_control_log primary key (NOP_TENANT_ID, ID);
