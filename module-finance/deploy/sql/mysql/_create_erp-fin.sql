...
CREATE TABLE erp_fin_accounting_period(
  ...
  CLOSED_AT DATETIME(3) NULL    COMMENT '结账时间',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  REVERSED_BY VARCHAR(36) NULL    COMMENT '反结账人',
  REVERSE_CLOSE_REASON VARCHAR(500) NULL    COMMENT '反结账原因',
  REVERSE_CLOSE_AT DATETIME(3) NULL    COMMENT '反结账时间',
...
CREATE TABLE erp_fin_bank_statement(
  ...
  IMPORT_TIME DATETIME(3) NULL    COMMENT '导入时间',
  DOC_STATUS VARCHAR(20) NOT NULL    COMMENT '状态',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_fin_posting_exception(
  ID BIGINT NOT NULL    COMMENT 'ID',
  TRACE_ID VARCHAR(50) NULL    COMMENT '追踪ID',
  BILL_HEAD_CODE VARCHAR(50) NULL    COMMENT '单据编号',
  BUSINESS_TYPE VARCHAR(30) NULL    COMMENT '业务类型',
  POSTING_TYPE VARCHAR(20) NULL    COMMENT '过账类型',
  ERROR_CODE VARCHAR(100) NOT NULL    COMMENT '错误码',
  ERROR_MESSAGE VARCHAR(500) NULL    COMMENT '错误信息',
  FAILED_STAGE VARCHAR(50) NULL    COMMENT '失败阶段',
  VOUCHER_DATE DATE NULL    COMMENT '凭证日期',
  ORG_ID BIGINT NULL    COMMENT '核算组织',
  ACCT_SCHEMA_ID BIGINT NULL    COMMENT '账套',
  STATUS VARCHAR(20) NOT NULL    COMMENT '处置状态',
  RETRY_COUNT INTEGER default 0  NULL    COMMENT '重试次数',
  RESOLUTION VARCHAR(20) NULL    COMMENT '处置动作',
  RESOLUTION_NOTE VARCHAR(500) NULL    COMMENT '处置说明',
  RESOLVED_BY VARCHAR(36) NULL    COMMENT '处置人',
  RESOLVED_AT DATETIME(3) NULL    COMMENT '处置时间',
  VOUCHER_ID BIGINT NULL    COMMENT '关联凭证ID',
  OCCURRENCE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '发生时间',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  ...
  EXCHANGE_RATE DECIMAL(20,8) NULL    COMMENT '汇率',
  EVENT_DATA VARCHAR(4000) NULL    COMMENT '原始事件数据(JSON)',
...
CREATE TABLE erp_fin_bank_reconciliation(
  ...
  RECONCILED_AT DATETIME(3) NULL    COMMENT '对账完成时间',
...
CREATE TABLE erp_fin_bank_statement_line(
  ...
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  COUNTERPARTY_ACCOUNT VARCHAR(50) NULL    COMMENT '对方账号',
  COUNTERPARTY_NAME VARCHAR(200) NULL    COMMENT '对方户名',
  COUNTERPARTY_BANK VARCHAR(200) NULL    COMMENT '对方开户行',
...
CREATE TABLE erp_fin_budget_control_log(
  ...
  OPERATED_AT DATETIME(3) NULL    COMMENT '操作时间',
  ...
  constraint PK_erp_fin_budget_control_log primary key (ID)
   ...
   ALTER TABLE erp_fin_posting_exception COMMENT '过账异常记录';
