...
drop table  if exists  erp_fin_ap_document;
...
drop table  if exists  erp_fin_notes_receivable;
drop table  if exists  erp_fin_employee_advance;
drop table  if exists  erp_fin_gl_mapping_rule;
drop table  if exists  erp_fin_intercompany_transfer_price;
drop table  if exists  erp_fin_ap_document_log;
...
drop table  if exists  erp_fin_credit_facility;
drop table  if exists  erp_fin_cash_forecast;
drop table  if exists  erp_fin_notes_discount;
...
drop table  if exists  erp_fin_budget_scenario;
drop table  if exists  erp_fin_intercompany_match;
...
drop table  if exists  erp_fin_budget_line;
drop table  if exists  erp_fin_budget_rollforward_log;
drop table  if exists  erp_fin_budget_carry_forward_log;
drop table  if exists  erp_fin_consolidation_elimination;
drop table  if exists  erp_fin_bank_reconciliation_line;
drop table  if exists  erp_fin_budget_control_log;
