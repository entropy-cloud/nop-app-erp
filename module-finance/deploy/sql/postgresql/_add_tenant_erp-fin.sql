...
alter table erp_fin_intercompany_match add NOP_TENANT_ID VARCHAR(32) DEFAULT '0' NOT NULL;
...
alter table erp_fin_consolidation_elimination add NOP_TENANT_ID VARCHAR(32) DEFAULT '0' NOT NULL;
