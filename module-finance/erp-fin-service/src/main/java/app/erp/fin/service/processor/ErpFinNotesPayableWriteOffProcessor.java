...
/**
 * ErpFinNotesPayable writeOff per-mutation Processor（R6.1，{@code processor-extension-pattern.md} 每 mutation 一 Processor）。
 * 自包含核销编排；共享 protected helper 单一真相源在 {@link ErpFinNotesPayableProcessor}。
 * 下游可经 Delta beans.xml 同名 bean id 覆盖本类。
 */
public class ErpFinNotesPayableWriteOffProcessor {
