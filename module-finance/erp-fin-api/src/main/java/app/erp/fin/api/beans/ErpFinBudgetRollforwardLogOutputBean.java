//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpFinBudgetRollforwardLogOutputBean {
        ...
        private String _strategy_label;

    
        public String getStrategy_label(){
            return _strategy_label;
        }

        public void setStrategy_label(String value){
            this._strategy_label = value;
        }
