...
/**
 *  通知已读记录: erp_sys_notification_read
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpSysNotificationRead extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 通知ID: NOTIFICATION_ID BIGINT */
    ...
    /* relation:  */
    public static final String PROP_NAME_notification = "notification";
    ...
    public _ErpSysNotificationRead(){
        // for debug
    }

    protected ErpSysNotificationRead newInstance(){
        ErpSysNotificationRead entity = new ErpSysNotificationRead();
    ...
    @Override
    public ErpSysNotificationRead cloneInstance() {
        ErpSysNotificationRead entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.notify.dao.entity.ErpSysNotificationRead";
    }
     ...
     * 
     */
    public final app.erp.notify.dao.entity.ErpSysNotification getNotification(){
       return (app.erp.notify.dao.entity.ErpSysNotification)internalGetRefEntity(PROP_NAME_notification);
    }

    public final void setNotification(app.erp.notify.dao.entity.ErpSysNotification refEntity){
           ...
           internalSetRefEntity(PROP_NAME_notification, refEntity,()->{
           
                           this.setNotificationId(refEntity.getId());
