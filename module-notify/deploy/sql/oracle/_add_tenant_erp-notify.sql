    ...
    alter table erp_sys_notification_template add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_sys_notification add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_sys_notification_read add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
