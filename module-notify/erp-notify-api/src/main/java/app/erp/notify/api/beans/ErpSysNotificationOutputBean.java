//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpSysNotificationOutputBean {
        ...
        private String _channel_label;

    
        public String getChannel_label(){
            return _channel_label;
        }

        public void setChannel_label(String value){
            this._channel_label = value;
        }
