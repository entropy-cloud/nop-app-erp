...
/**
 *  发运明细: erp_log_shipment_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpLogShipmentLine extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_quantity = 5;
    
    /* 单位: UNIT VARCHAR */
    public static final String PROP_NAME_unit = "unit";
    public static final int PROP_ID_unit = 6;
    
    /* 包装说明: PACKAGE_DESCRIPTION VARCHAR */
    public static final String PROP_NAME_packageDescription = "packageDescription";
    public static final int PROP_ID_packageDescription = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_packageDescription] = PROP_NAME_packageDescription;
          PROP_NAME_TO_ID.put(PROP_NAME_packageDescription, PROP_ID_packageDescription);
    ...
    public _ErpLogShipmentLine(){
        // for debug
    }

    protected ErpLogShipmentLine newInstance(){
        ErpLogShipmentLine entity = new ErpLogShipmentLine();
    ...
    @Override
    public ErpLogShipmentLine cloneInstance() {
        ErpLogShipmentLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.log.dao.entity.ErpLogShipmentLine";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_packageDescription:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_packageDescription:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_packageDescription));
               }
               setPackageDescription(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_packageDescription:{
               onInitProp(propId);
               this._packageDescription = (java.lang.String)value;
    ...
    public final java.lang.String getPackageDescription(){
         onPropGet(PROP_ID_packageDescription);
     ...
     * 包装说明: PACKAGE_DESCRIPTION
     */
    public final void setPackageDescription(java.lang.String value){
        if(onPropSet(PROP_ID_packageDescription,value)){
            this._packageDescription = value;
            internalClearRefs(PROP_ID_packageDescription);
