...
assertReportRenderedWithValue({
  ...
  query: 'query($reportName:String!,$projectId:String,$startDate:String,$endDate:String){ ErpPrjReport__renderHtml(reportName:$reportName,data:{projectId:$projectId,startDate:$startDate,endDate:$endDate}) }',
