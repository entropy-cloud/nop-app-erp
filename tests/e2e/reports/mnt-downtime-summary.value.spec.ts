...
assertReportRenderedWithValue({
  ...
  query: 'query($reportName:String!,$equipmentId:String,$startDate:String,$endDate:String){ ErpMntReport__renderHtml(reportName:$reportName,data:{equipmentId:$equipmentId,startDate:$startDate,endDate:$endDate}) }',
