 ...
 *
 * <p>非法边直抛领域码 {@link ErpPrjErrors#ERR_TASK_ILLEGAL_STATUS_TRANSITION}（参数 {@code currentStatus}/
 * {@code targetStatus}/{@code action}，键随模板占位符；plan 2026-09-07-2200-1）；任务编号（taskId）与
 * 动作目标态经调用点同码补参。
 *
...
public class ErpPrjTaskStateMachine {
    ...
    private static NopException illegal(String action, String currentStatus, String expectedStatus) {
        return new NopException(ErpPrjErrors.ERR_TASK_ILLEGAL_STATUS_TRANSITION)
                ...
                .param(ErpPrjErrors.ARG_TARGET_STATUS, expectedStatus)
