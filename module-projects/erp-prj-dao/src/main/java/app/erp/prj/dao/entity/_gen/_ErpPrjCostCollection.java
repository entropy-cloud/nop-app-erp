...
/**
 *  项目成本归集: erp_prj_cost_collection
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPrjCostCollection extends DynamicOrmEntity{
    ...
    /* 归集金额合计: TOTAL_AMOUNT DECIMAL */
    public static final String PROP_NAME_totalAmount = "totalAmount";
    public static final int PROP_ID_totalAmount = 7;
    ...
    protected ErpPrjCostCollection newInstance(){
        ErpPrjCostCollection entity = new ErpPrjCostCollection();
    ...
    @Override
    public ErpPrjCostCollection cloneInstance() {
        ErpPrjCostCollection entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.prj.dao.entity.ErpPrjCostCollection";
    }
    ...
    private final OrmEntitySet<app.erp.prj.dao.entity.ErpPrjCostCollectionLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.prj.dao.entity.ErpPrjCostCollectionLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.prj.dao.entity.ErpPrjCostCollectionLine> getLines(){
       return _lines;
    }
