...
/**
 *  项目开票: erp_prj_billing
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPrjBilling extends DynamicOrmEntity{
    ...
    /* 关联里程碑: MILESTONE_ID BIGINT */
    public static final String PROP_NAME_milestoneId = "milestoneId";
    public static final int PROP_ID_milestoneId = 6;
    
    /* 开票日期: BUSINESS_DATE DATE */
    ...
    public static final int PROP_ID_amountSource = 202;
    
    /* 本位币金额: AMOUNT_FUNCTIONAL DECIMAL */
    public static final String PROP_NAME_amountFunctional = "amountFunctional";
    public static final int PROP_ID_amountFunctional = 203;
    

    private static int _PROP_ID_BOUND = 204;
    ...
    private static final String[] PROP_ID_TO_NAME = new String[204];
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_milestoneId] = PROP_NAME_milestoneId;
          PROP_NAME_TO_ID.put(PROP_NAME_milestoneId, PROP_ID_milestoneId);
    ...
    /* 关联里程碑: MILESTONE_ID */
    private java.lang.Long _milestoneId;
    ...
    protected ErpPrjBilling newInstance(){
        ErpPrjBilling entity = new ErpPrjBilling();
    ...
    @Override
    public ErpPrjBilling cloneInstance() {
        ErpPrjBilling entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.prj.dao.entity.ErpPrjBilling";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_milestoneId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLong(value,
                       err-> newTypeConversionError(PROP_NAME_milestoneId));
               }
               setMilestoneId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_milestoneId:{
               onInitProp(propId);
               this._milestoneId = (java.lang.Long)value;
     ...
     * 关联里程碑: MILESTONE_ID
     */
    public final java.lang.Long getMilestoneId(){
         onPropGet(PROP_ID_milestoneId);
         return _milestoneId;
    }
     ...
     * 关联里程碑: MILESTONE_ID
     */
    public final void setMilestoneId(java.lang.Long value){
        if(onPropSet(PROP_ID_milestoneId,value)){
            this._milestoneId = value;
            internalClearRefs(PROP_ID_milestoneId);
     ...
     * 
     */
    public final app.erp.prj.dao.entity.ErpPrjMilestone getMilestone(){
       return (app.erp.prj.dao.entity.ErpPrjMilestone)internalGetRefEntity(PROP_NAME_milestone);
    }

    public final void setMilestone(app.erp.prj.dao.entity.ErpPrjMilestone refEntity){
           ...
           internalSetRefEntity(PROP_NAME_milestone, refEntity,()->{
           
                           this.setMilestoneId(refEntity.getId());
    ...
    private final OrmEntitySet<app.erp.prj.dao.entity.ErpPrjBillingLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.prj.dao.entity.ErpPrjBillingLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.prj.dao.entity.ErpPrjBillingLine> getLines(){
       return _lines;
    }
