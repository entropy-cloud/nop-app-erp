...
public class _ErpPrjBudget extends DynamicOrmEntity{
    ...
    protected ErpPrjBudget newInstance(){
        ErpPrjBudget entity = new ErpPrjBudget();
    ...
    @Override
    public ErpPrjBudget cloneInstance() {
        ErpPrjBudget entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.prj.dao.entity.ErpPrjBudget";
    }
    ...
    private final OrmEntitySet<app.erp.prj.dao.entity.ErpPrjBudgetLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.prj.dao.entity.ErpPrjBudgetLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.prj.dao.entity.ErpPrjBudgetLine> getLines(){
       return _lines;
    }
