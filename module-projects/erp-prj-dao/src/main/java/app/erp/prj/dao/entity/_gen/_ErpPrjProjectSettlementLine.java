...
/**
 *  项目结算明细: erp_prj_project_settlement_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPrjProjectSettlementLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 结算单ID: SETTLEMENT_ID BIGINT */
    public static final String PROP_NAME_settlementId = "settlementId";
    public static final int PROP_ID_settlementId = 2;
    
    /* 行号: LINE_NO INTEGER */
    public static final String PROP_NAME_lineNo = "lineNo";
    public static final int PROP_ID_lineNo = 3;
    
    /* 行类型(INCOME/COST): LINE_TYPE VARCHAR */
    public static final String PROP_NAME_lineType = "lineType";
    public static final int PROP_ID_lineType = 4;
    
    /* 来源单据类型(BILLING/COST_COLLECTION): SOURCE_BILL_TYPE VARCHAR */
    ...
    /* relation:  */
    public static final String PROP_NAME_settlement = "settlement";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_settlementId] = PROP_NAME_settlementId;
          PROP_NAME_TO_ID.put(PROP_NAME_settlementId, PROP_ID_settlementId);
    ...
    /* 行类型(INCOME/COST): LINE_TYPE */
    private java.lang.String _lineType;
    
    /* 来源单据类型(BILLING/COST_COLLECTION): SOURCE_BILL_TYPE */
    ...
    public _ErpPrjProjectSettlementLine(){
        // for debug
    }

    protected ErpPrjProjectSettlementLine newInstance(){
        ErpPrjProjectSettlementLine entity = new ErpPrjProjectSettlementLine();
    ...
    @Override
    public ErpPrjProjectSettlementLine cloneInstance() {
        ErpPrjProjectSettlementLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.prj.dao.entity.ErpPrjProjectSettlementLine";
    }
     ...
     * 
     */
    public final app.erp.prj.dao.entity.ErpPrjProjectSettlement getSettlement(){
       return (app.erp.prj.dao.entity.ErpPrjProjectSettlement)internalGetRefEntity(PROP_NAME_settlement);
    }

    public final void setSettlement(app.erp.prj.dao.entity.ErpPrjProjectSettlement refEntity){
           ...
           internalSetRefEntity(PROP_NAME_settlement, refEntity,()->{
           
                           this.setSettlementId(refEntity.getId());
