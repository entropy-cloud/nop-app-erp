...
/**
 *  项目预算行: erp_prj_budget_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPrjBudgetLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 预算ID: BUDGET_ID BIGINT */
    public static final String PROP_NAME_budgetId = "budgetId";
    public static final int PROP_ID_budgetId = 2;
    ...
    /* 预算金额: PLANNED_AMOUNT DECIMAL */
    public static final String PROP_NAME_plannedAmount = "plannedAmount";
    public static final int PROP_ID_plannedAmount = 7;
    
    /* 已承诺金额: COMMITTED_AMOUNT DECIMAL */
    public static final String PROP_NAME_committedAmount = "committedAmount";
    public static final int PROP_ID_committedAmount = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_budgetId] = PROP_NAME_budgetId;
          PROP_NAME_TO_ID.put(PROP_NAME_budgetId, PROP_ID_budgetId);
    ...
    /* 预算ID: BUDGET_ID */
    private java.lang.String _budgetId;
    ...
    public _ErpPrjBudgetLine(){
        // for debug
    }

    protected ErpPrjBudgetLine newInstance(){
        ErpPrjBudgetLine entity = new ErpPrjBudgetLine();
    ...
    @Override
    public ErpPrjBudgetLine cloneInstance() {
        ErpPrjBudgetLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.prj.dao.entity.ErpPrjBudgetLine";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_budgetId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_budgetId));
               }
               setBudgetId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_budgetId:{
               onInitProp(propId);
               this._budgetId = (java.lang.String)value;
     ...
     * 预算ID: BUDGET_ID
     */
    public final java.lang.String getBudgetId(){
         onPropGet(PROP_ID_budgetId);
         return _budgetId;
    }
     ...
     * 预算ID: BUDGET_ID
     */
    public final void setBudgetId(java.lang.String value){
        if(onPropSet(PROP_ID_budgetId,value)){
            this._budgetId = value;
            internalClearRefs(PROP_ID_budgetId);
     ...
     * 
     */
    public final app.erp.prj.dao.entity.ErpPrjBudget getBudget(){
       return (app.erp.prj.dao.entity.ErpPrjBudget)internalGetRefEntity(PROP_NAME_budget);
    }

    public final void setBudget(app.erp.prj.dao.entity.ErpPrjBudget refEntity){
           ...
           internalSetRefEntity(PROP_NAME_budget, refEntity,()->{
           
                           this.setBudgetId(refEntity.getId());
