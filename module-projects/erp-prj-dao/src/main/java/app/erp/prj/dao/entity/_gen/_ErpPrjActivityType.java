...
/**
 *  活动类型: erp_prj_activity_type
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpPrjActivityType extends DynamicOrmEntity{
    ...
    public _ErpPrjActivityType(){
        // for debug
    }

    protected ErpPrjActivityType newInstance(){
        ErpPrjActivityType entity = new ErpPrjActivityType();
    ...
    @Override
    public ErpPrjActivityType cloneInstance() {
        ErpPrjActivityType entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.prj.dao.entity.ErpPrjActivityType";
    }
