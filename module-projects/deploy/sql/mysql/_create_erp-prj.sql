...
CREATE TABLE erp_prj_project_pnl(
  ...
  PROJECT_ID BIGINT NOT NULL    COMMENT '项目',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  PERIOD_FROM DATE NOT NULL    COMMENT '汇总期间起',
  PERIOD_TO DATE NOT NULL    COMMENT '汇总期间止',
  CURRENCY_ID BIGINT NULL    COMMENT '币种',
  EXCHANGE_RATE DECIMAL(20,8) default 1  NOT NULL    COMMENT '汇率',
  AMOUNT_SOURCE DECIMAL(20,4) default 0  NULL    COMMENT '源币种金额',
  AMOUNT_FUNCTIONAL DECIMAL(20,4) default 0  NULL    COMMENT '本位币金额',
  REVENUE_AMOUNT DECIMAL(20,4) default 0  NULL    COMMENT '收入合计',
  COST_LABOR DECIMAL(20,4) default 0  NULL    COMMENT '人工成本',
  COST_MATERIAL DECIMAL(20,4) default 0  NULL    COMMENT '物料成本',
  COST_EXPENSE DECIMAL(20,4) default 0  NULL    COMMENT '费用成本',
  COST_SUBCONTRACT DECIMAL(20,4) default 0  NULL    COMMENT '分包成本',
  TOTAL_COST DECIMAL(20,4) default 0  NULL    COMMENT '成本合计',
  GROSS_PROFIT DECIMAL(20,4) default 0  NULL    COMMENT '毛利',
  GROSS_MARGIN_PCT DECIMAL(10,4) default 0  NULL    COMMENT '毛利率%',
  COMMITTED_COST DECIMAL(20,4) default 0  NULL    COMMENT '已承诺成本',
  BUDGET_AMOUNT DECIMAL(20,4) default 0  NULL    COMMENT '预算',
  FORECAST_COMPLETE_COST DECIMAL(20,4) default 0  NULL    COMMENT '完工预测成本(EAC)',
  CALC_STATUS VARCHAR(20) NOT NULL    COMMENT '计算状态',
  DOC_STATUS VARCHAR(20) NOT NULL    COMMENT '单据状态',
  APPROVE_STATUS VARCHAR(20) NOT NULL    COMMENT '审核状态',
...
CREATE TABLE erp_prj_project_settlement(
  ...
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  CUSTOMER_ID BIGINT NULL    COMMENT '客户',
  BUSINESS_DATE DATE NOT NULL    COMMENT '结算日期',
  SETTLEMENT_TYPE VARCHAR(20) NOT NULL    COMMENT '结算类型',
  PNL_SNAPSHOT_ID BIGINT NULL    COMMENT '关联损益汇总',
  CURRENCY_ID BIGINT NULL    COMMENT '币种',
  EXCHANGE_RATE DECIMAL(20,8) default 1  NOT NULL    COMMENT '汇率',
  AMOUNT_SOURCE DECIMAL(20,4) default 0  NULL    COMMENT '源币种金额',
  AMOUNT_FUNCTIONAL DECIMAL(20,4) default 0  NULL    COMMENT '本位币金额',
  FINAL_REVENUE DECIMAL(20,4) default 0  NULL    COMMENT '最终结算收入',
  FINAL_COST DECIMAL(20,4) default 0  NULL    COMMENT '最终结算成本',
  FINAL_PROFIT DECIMAL(20,4) default 0  NULL    COMMENT '最终损益',
  RETENTION_AMOUNT DECIMAL(20,4) default 0  NULL    COMMENT '质保金/保留款',
  RETENTION_DUE_DATE DATE NULL    COMMENT '质保金到期',
  TRANSFER_TO_ASSET BOOLEAN default 0  NULL    COMMENT '是否转固定资产',
  ASSET_CARD_ID BIGINT NULL    COMMENT '转固资产卡片',
  SETTLEMENT_VOUCHER_CODE VARCHAR(50) NULL    COMMENT '结算凭证号',
  DOC_STATUS VARCHAR(20) NOT NULL    COMMENT '单据状态',
  APPROVE_STATUS VARCHAR(20) NOT NULL    COMMENT '审核状态',
  POSTED BOOLEAN default 0  NULL    COMMENT '已过账',
  POSTED_AT DATETIME(3) NULL    COMMENT '过账时间',
...
CREATE TABLE erp_prj_project_settlement_line(
  ...
  LINE_NO INTEGER NOT NULL    COMMENT '行号',
  LINE_TYPE VARCHAR(50) NOT NULL    COMMENT '行类型(INCOME/COST)',
  SOURCE_BILL_TYPE VARCHAR(50) NULL    COMMENT '来源单据类型(BILLING/COST_COLLECTION)',
  SOURCE_BILL_CODE VARCHAR(50) NULL    COMMENT '来源单据号',
  SUBJECT_ID BIGINT NULL    COMMENT '科目',
  AMOUNT DECIMAL(20,4) NOT NULL    COMMENT '金额',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  ...
  constraint PK_erp_prj_project_settlement_line primary key (ID)
   ...
   ALTER TABLE erp_prj_project_pnl COMMENT '项目损益汇总';
   ...
   ALTER TABLE erp_prj_project_settlement COMMENT '项目结算单';
                
   ALTER TABLE erp_prj_billing_line COMMENT '项目开票行';
                
   ALTER TABLE erp_prj_project_settlement_line COMMENT '项目结算明细';
