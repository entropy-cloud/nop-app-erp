...
alter table erp_prj_role add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_prj_project_pnl add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_prj_project_settlement add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_prj_billing_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_prj_project_settlement_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
