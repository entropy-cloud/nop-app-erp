 ...
 * 各改调 {@code assertCanXxx}（Bean 直抛领域码 {@code ERR_AST_SPLIT_ILLEGAL_STATUS_TRANSITION}（plan 2026-09-07-2200-1），
...
public class ErpAstSplitApprovalStateMachine {
     ...
     *
     * <p>非法来源态直抛领域码 {@code ERR_AST_SPLIT_ILLEGAL_STATUS_TRANSITION}（携带 {@code action=submitForApproval}/{@code currentStatus}；
