...
public class ErpAstAssetCapitalizationDocumentStateMachine {
     ...
     *
     * <p>非法来源态（CANCELLED）直抛领域码 {@code ERR_CAPITALIZATION_ILLEGAL_DOC_TRANSITION}（携带 {@code action=approve}/{@code currentDocStatus}；
     ...
     *
     * <p>非法来源态（CANCELLED）直抛领域码 {@code ERR_CAPITALIZATION_ILLEGAL_DOC_TRANSITION}（携带 {@code action=reverseApprove}/{@code currentDocStatus}；
     * 实体元数据经调用点同码补参补齐，plan 2026-09-07-2200-1）。
     */
