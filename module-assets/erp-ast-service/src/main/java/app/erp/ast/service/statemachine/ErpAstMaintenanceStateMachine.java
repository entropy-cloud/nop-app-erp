 ...
 *
 * <p>分类：initial={DRAFT}，terminal={POSTED, CANCELLED}。非法边直抛领域码 {@link ErpAstErrors#ERR_AST_MAINTENANCE_ILLEGAL_STATUS_TRANSITION}
 * （参数 {@code action}/{@code currentStatus}/{@code expectedStatus}；plan 2026-09-07-2200-1）；
 * 实体元数据经调用点同码补参补齐。
 */
