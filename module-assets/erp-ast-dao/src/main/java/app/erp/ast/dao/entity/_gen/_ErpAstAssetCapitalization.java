...
/**
 *  资产资本化: erp_ast_asset_capitalization
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpAstAssetCapitalization extends DynamicOrmEntity{
    ...
    /* 资产编码: ASSET_CODE VARCHAR */
    public static final String PROP_NAME_assetCode = "assetCode";
    public static final int PROP_ID_assetCode = 4;
    
    /* 资产名称: ASSET_NAME VARCHAR */
    public static final String PROP_NAME_assetName = "assetName";
    public static final int PROP_ID_assetName = 5;
    ...
    /* 资本化日期: CAPITALIZATION_DATE DATE */
    public static final String PROP_NAME_capitalizationDate = "capitalizationDate";
    public static final int PROP_ID_capitalizationDate = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_assetCode] = PROP_NAME_assetCode;
          PROP_NAME_TO_ID.put(PROP_NAME_assetCode, PROP_ID_assetCode);
      
          PROP_ID_TO_NAME[PROP_ID_assetName] = PROP_NAME_assetName;
          PROP_NAME_TO_ID.put(PROP_NAME_assetName, PROP_ID_assetName);
          ...
          PROP_ID_TO_NAME[PROP_ID_capitalizationDate] = PROP_NAME_capitalizationDate;
          PROP_NAME_TO_ID.put(PROP_NAME_capitalizationDate, PROP_ID_capitalizationDate);
    ...
    public _ErpAstAssetCapitalization(){
        // for debug
    }

    protected ErpAstAssetCapitalization newInstance(){
        ErpAstAssetCapitalization entity = new ErpAstAssetCapitalization();
    ...
    @Override
    public ErpAstAssetCapitalization cloneInstance() {
        ErpAstAssetCapitalization entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.ast.dao.entity.ErpAstAssetCapitalization";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_assetCode:
               return getAssetCode();
        
            case PROP_ID_assetName:
               return getAssetName();
            ...
            case PROP_ID_capitalizationDate:
               return getCapitalizationDate();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_assetCode:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_assetCode));
               }
               setAssetCode(typedValue);
               break;
            }
            ...
            case PROP_ID_assetName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_assetName));
               }
               setAssetName(typedValue);
               break;
            }
            ...
            case PROP_ID_capitalizationDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_capitalizationDate));
               }
               setCapitalizationDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_assetCode:{
               onInitProp(propId);
               this._assetCode = (java.lang.String)value;
            ...
            case PROP_ID_assetName:{
               onInitProp(propId);
               this._assetName = (java.lang.String)value;
            ...
            case PROP_ID_capitalizationDate:{
               onInitProp(propId);
               this._capitalizationDate = (java.time.LocalDate)value;
     ...
     * 资产编码: ASSET_CODE
     */
    public final void setAssetCode(java.lang.String value){
        if(onPropSet(PROP_ID_assetCode,value)){
            this._assetCode = value;
            internalClearRefs(PROP_ID_assetCode);
     ...
     * 资产名称: ASSET_NAME
     */
    public final void setAssetName(java.lang.String value){
        if(onPropSet(PROP_ID_assetName,value)){
            this._assetName = value;
            internalClearRefs(PROP_ID_assetName);
     ...
     * 资本化日期: CAPITALIZATION_DATE
     */
    public final java.time.LocalDate getCapitalizationDate(){
         onPropGet(PROP_ID_capitalizationDate);
     ...
     * 资本化日期: CAPITALIZATION_DATE
     */
    public final void setCapitalizationDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_capitalizationDate,value)){
            this._capitalizationDate = value;
            internalClearRefs(PROP_ID_capitalizationDate);
