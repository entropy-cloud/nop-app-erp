...
public class _ErpAstSplit extends DynamicOrmEntity{
    ...
    /* 被拆分资产: SOURCE_ASSET_ID BIGINT */
    public static final String PROP_NAME_sourceAssetId = "sourceAssetId";
    public static final int PROP_ID_sourceAssetId = 4;
    
    /* 拆分日期: BUSINESS_DATE DATE */
    ...
    /* 拆分原因: SPLIT_REASON VARCHAR */
    public static final String PROP_NAME_splitReason = "splitReason";
    public static final int PROP_ID_splitReason = 7;
    
    /* 单据状态: DOC_STATUS INTEGER */
    public static final String PROP_NAME_docStatus = "docStatus";
    public static final int PROP_ID_docStatus = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_splitReason] = PROP_NAME_splitReason;
          PROP_NAME_TO_ID.put(PROP_NAME_splitReason, PROP_ID_splitReason);
    ...
    /* 拆分原因: SPLIT_REASON */
    private java.lang.String _splitReason;
    ...
    protected ErpAstSplit newInstance(){
        ErpAstSplit entity = new ErpAstSplit();
    ...
    @Override
    public ErpAstSplit cloneInstance() {
        ErpAstSplit entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.ast.dao.entity.ErpAstSplit";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_splitReason:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_splitReason));
               }
               setSplitReason(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_splitReason:{
               onInitProp(propId);
               this._splitReason = (java.lang.String)value;
     ...
     * 拆分原因: SPLIT_REASON
     */
    public final java.lang.String getSplitReason(){
         onPropGet(PROP_ID_splitReason);
         return _splitReason;
    }
     ...
     * 拆分原因: SPLIT_REASON
     */
    public final void setSplitReason(java.lang.String value){
        if(onPropSet(PROP_ID_splitReason,value)){
            this._splitReason = value;
            internalClearRefs(PROP_ID_splitReason);
