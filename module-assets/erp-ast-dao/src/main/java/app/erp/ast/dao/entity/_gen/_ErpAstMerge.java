...
public class _ErpAstMerge extends DynamicOrmEntity{
    ...
    /* 合并目标资产: TARGET_ASSET_ID BIGINT */
    public static final String PROP_NAME_targetAssetId = "targetAssetId";
    public static final int PROP_ID_targetAssetId = 4;
    
    /* 合并日期: BUSINESS_DATE DATE */
    ...
    /* 合并原因: MERGE_REASON VARCHAR */
    public static final String PROP_NAME_mergeReason = "mergeReason";
    public static final int PROP_ID_mergeReason = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_mergeReason] = PROP_NAME_mergeReason;
          PROP_NAME_TO_ID.put(PROP_NAME_mergeReason, PROP_ID_mergeReason);
    ...
    /* 合并原因: MERGE_REASON */
    private java.lang.String _mergeReason;
    ...
    protected ErpAstMerge newInstance(){
        ErpAstMerge entity = new ErpAstMerge();
    ...
    @Override
    public ErpAstMerge cloneInstance() {
        ErpAstMerge entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.ast.dao.entity.ErpAstMerge";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_mergeReason:
               return getMergeReason();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_mergeReason:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_mergeReason));
               }
               setMergeReason(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_mergeReason:{
               onInitProp(propId);
               this._mergeReason = (java.lang.String)value;
     ...
     * 合并原因: MERGE_REASON
     */
    public final java.lang.String getMergeReason(){
         onPropGet(PROP_ID_mergeReason);
         return _mergeReason;
    }
     ...
     * 合并原因: MERGE_REASON
     */
    public final void setMergeReason(java.lang.String value){
        if(onPropSet(PROP_ID_mergeReason,value)){
            this._mergeReason = value;
            internalClearRefs(PROP_ID_mergeReason);
