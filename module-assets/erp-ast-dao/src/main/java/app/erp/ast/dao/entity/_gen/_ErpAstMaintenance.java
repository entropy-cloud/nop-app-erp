...
/**
 *  资产维修工单: erp_ast_maintenance
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpAstMaintenance extends DynamicOrmEntity{
    ...
    /* 资产卡片: ASSET_ID BIGINT */
    public static final String PROP_NAME_assetId = "assetId";
    public static final int PROP_ID_assetId = 5;
    
    /* 维护工单(弱关联): MAINTENANCE_VISIT_ID BIGINT */
    public static final String PROP_NAME_maintenanceVisitId = "maintenanceVisitId";
    public static final int PROP_ID_maintenanceVisitId = 6;
    
    /* 维修状态: STATUS VARCHAR */
    public static final String PROP_NAME_status = "status";
    public static final int PROP_ID_status = 7;
    
    /* 处置裁决: TREATMENT VARCHAR */
    public static final String PROP_NAME_treatment = "treatment";
    public static final int PROP_ID_treatment = 8;
    
    /* 资本化金额: CAPITALIZED_AMOUNT DECIMAL */
    public static final String PROP_NAME_capitalizedAmount = "capitalizedAmount";
    public static final int PROP_ID_capitalizedAmount = 9;
    
    /* 费用合计: TOTAL_COST_AMOUNT DECIMAL */
    public static final String PROP_NAME_totalCostAmount = "totalCostAmount";
    public static final int PROP_ID_totalCostAmount = 10;
    
    /* 维修日期: BUSINESS_DATE DATE */
    ...
    public static final int PROP_ID_exchangeRate = 13;
    
    /* 维修原因: REASON VARCHAR */
    public static final String PROP_NAME_reason = "reason";
    public static final int PROP_ID_reason = 14;
    
    /* 已过账: POSTED BOOLEAN */
    public static final String PROP_NAME_posted = "posted";
    public static final int PROP_ID_posted = 15;
    ...
    public static final int PROP_ID_postedBy = 17;
    
    /* 审核人: APPROVED_BY VARCHAR */
    public static final String PROP_NAME_approvedBy = "approvedBy";
    public static final int PROP_ID_approvedBy = 18;
    
    /* 审核时间: APPROVED_AT TIMESTAMP */
    public static final String PROP_NAME_approvedAt = "approvedAt";
    public static final int PROP_ID_approvedAt = 19;
    
    /* 已红冲: REVERSED BOOLEAN */
    public static final String PROP_NAME_reversed = "reversed";
    public static final int PROP_ID_reversed = 20;
    ...
    /* relation:  */
    public static final String PROP_NAME_costLines = "costLines";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_maintenanceVisitId] = PROP_NAME_maintenanceVisitId;
          PROP_NAME_TO_ID.put(PROP_NAME_maintenanceVisitId, PROP_ID_maintenanceVisitId);
      
          PROP_ID_TO_NAME[PROP_ID_status] = PROP_NAME_status;
          PROP_NAME_TO_ID.put(PROP_NAME_status, PROP_ID_status);
      
          PROP_ID_TO_NAME[PROP_ID_treatment] = PROP_NAME_treatment;
          PROP_NAME_TO_ID.put(PROP_NAME_treatment, PROP_ID_treatment);
      
          PROP_ID_TO_NAME[PROP_ID_capitalizedAmount] = PROP_NAME_capitalizedAmount;
          PROP_NAME_TO_ID.put(PROP_NAME_capitalizedAmount, PROP_ID_capitalizedAmount);
      
          PROP_ID_TO_NAME[PROP_ID_totalCostAmount] = PROP_NAME_totalCostAmount;
          PROP_NAME_TO_ID.put(PROP_NAME_totalCostAmount, PROP_ID_totalCostAmount);
          ...
          PROP_ID_TO_NAME[PROP_ID_reversed] = PROP_NAME_reversed;
          PROP_NAME_TO_ID.put(PROP_NAME_reversed, PROP_ID_reversed);
    ...
    /* 维护工单(弱关联): MAINTENANCE_VISIT_ID */
    private java.lang.String _maintenanceVisitId;
    
    /* 维修状态: STATUS */
    private java.lang.String _status;
    
    /* 处置裁决: TREATMENT */
    private java.lang.String _treatment;
    
    /* 资本化金额: CAPITALIZED_AMOUNT */
    private java.math.BigDecimal _capitalizedAmount;
    
    /* 费用合计: TOTAL_COST_AMOUNT */
    ...
    /* 已红冲: REVERSED */
    private java.lang.Boolean _reversed;
    ...
    public _ErpAstMaintenance(){
        // for debug
    }

    protected ErpAstMaintenance newInstance(){
        ErpAstMaintenance entity = new ErpAstMaintenance();
    ...
    @Override
    public ErpAstMaintenance cloneInstance() {
        ErpAstMaintenance entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.ast.dao.entity.ErpAstMaintenance";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_maintenanceVisitId:
               return getMaintenanceVisitId();
        
            case PROP_ID_status:
               return getStatus();
        
            case PROP_ID_treatment:
               return getTreatment();
        
            case PROP_ID_capitalizedAmount:
               return getCapitalizedAmount();
        
            case PROP_ID_totalCostAmount:
               return getTotalCostAmount();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_maintenanceVisitId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_maintenanceVisitId));
               }
               setMaintenanceVisitId(typedValue);
               break;
            }
            ...
            case PROP_ID_treatment:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_treatment));
               }
               setTreatment(typedValue);
               break;
            }
            ...
            case PROP_ID_capitalizedAmount:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_capitalizedAmount));
               }
               setCapitalizedAmount(typedValue);
               break;
            }
            ...
            case PROP_ID_totalCostAmount:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_totalCostAmount));
               }
               setTotalCostAmount(typedValue);
               break;
            }
            ...
            case PROP_ID_reversed:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBoolean(value,
                       err-> newTypeConversionError(PROP_NAME_reversed));
               }
               setReversed(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_maintenanceVisitId:{
               onInitProp(propId);
               this._maintenanceVisitId = (java.lang.String)value;
            ...
            case PROP_ID_treatment:{
               onInitProp(propId);
               this._treatment = (java.lang.String)value;
            ...
            case PROP_ID_capitalizedAmount:{
               onInitProp(propId);
               this._capitalizedAmount = (java.math.BigDecimal)value;
            ...
            case PROP_ID_totalCostAmount:{
               onInitProp(propId);
               this._totalCostAmount = (java.math.BigDecimal)value;
            ...
            case PROP_ID_reversed:{
               onInitProp(propId);
               this._reversed = (java.lang.Boolean)value;
     ...
     * 维护工单(弱关联): MAINTENANCE_VISIT_ID
     */
    public final java.lang.String getMaintenanceVisitId(){
         onPropGet(PROP_ID_maintenanceVisitId);
     ...
     * 维护工单(弱关联): MAINTENANCE_VISIT_ID
     */
    public final void setMaintenanceVisitId(java.lang.String value){
        if(onPropSet(PROP_ID_maintenanceVisitId,value)){
            this._maintenanceVisitId = value;
            internalClearRefs(PROP_ID_maintenanceVisitId);
     ...
     * 处置裁决: TREATMENT
     */
    public final void setTreatment(java.lang.String value){
        if(onPropSet(PROP_ID_treatment,value)){
            this._treatment = value;
            internalClearRefs(PROP_ID_treatment);
     ...
     * 资本化金额: CAPITALIZED_AMOUNT
     */
    public final java.math.BigDecimal getCapitalizedAmount(){
         onPropGet(PROP_ID_capitalizedAmount);
     ...
     * 资本化金额: CAPITALIZED_AMOUNT
     */
    public final void setCapitalizedAmount(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_capitalizedAmount,value)){
            this._capitalizedAmount = value;
            internalClearRefs(PROP_ID_capitalizedAmount);
     ...
     * 费用合计: TOTAL_COST_AMOUNT
     */
    public final java.math.BigDecimal getTotalCostAmount(){
         onPropGet(PROP_ID_totalCostAmount);
     ...
     * 费用合计: TOTAL_COST_AMOUNT
     */
    public final void setTotalCostAmount(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_totalCostAmount,value)){
            this._totalCostAmount = value;
            internalClearRefs(PROP_ID_totalCostAmount);
     ...
     * 已红冲: REVERSED
     */
    public final java.lang.Boolean getReversed(){
         onPropGet(PROP_ID_reversed);
         return _reversed;
    }
     ...
     * 已红冲: REVERSED
     */
    public final void setReversed(java.lang.Boolean value){
        if(onPropSet(PROP_ID_reversed,value)){
            this._reversed = value;
            internalClearRefs(PROP_ID_reversed);
    ...
    private final OrmEntitySet<app.erp.ast.dao.entity.ErpAstMaintenanceCost> _costLines = new OrmEntitySet<>(this, PROP_NAME_costLines,
        null, null,app.erp.ast.dao.entity.ErpAstMaintenanceCost.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.ast.dao.entity.ErpAstMaintenanceCost> getCostLines(){
       return _costLines;
    }
