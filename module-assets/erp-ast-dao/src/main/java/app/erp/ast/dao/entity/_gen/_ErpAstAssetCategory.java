...
/**
 *  资产类别: erp_ast_asset_category
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpAstAssetCategory extends DynamicOrmEntity{
    ...
    /* 默认使用年限(月): USEFUL_LIFE_MONTHS INTEGER */
    public static final String PROP_NAME_usefulLifeMonths = "usefulLifeMonths";
    public static final int PROP_ID_usefulLifeMonths = 5;
    
    /* 资产科目: SUBJECT_ID BIGINT */
    public static final String PROP_NAME_subjectId = "subjectId";
    public static final int PROP_ID_subjectId = 6;
    
    /* 累计折旧科目: DEPRECIATION_SUBJECT_ID BIGINT */
    public static final String PROP_NAME_depreciationSubjectId = "depreciationSubjectId";
    public static final int PROP_ID_depreciationSubjectId = 7;
    
    /* 折旧费用科目: EXPENSE_SUBJECT_ID BIGINT */
    public static final String PROP_NAME_expenseSubjectId = "expenseSubjectId";
    public static final int PROP_ID_expenseSubjectId = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_depreciationSubjectId] = PROP_NAME_depreciationSubjectId;
          PROP_NAME_TO_ID.put(PROP_NAME_depreciationSubjectId, PROP_ID_depreciationSubjectId);
      
          PROP_ID_TO_NAME[PROP_ID_expenseSubjectId] = PROP_NAME_expenseSubjectId;
          PROP_NAME_TO_ID.put(PROP_NAME_expenseSubjectId, PROP_ID_expenseSubjectId);
    ...
    protected ErpAstAssetCategory newInstance(){
        ErpAstAssetCategory entity = new ErpAstAssetCategory();
    ...
    @Override
    public ErpAstAssetCategory cloneInstance() {
        ErpAstAssetCategory entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.ast.dao.entity.ErpAstAssetCategory";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_depreciationSubjectId:
               return getDepreciationSubjectId();
        
            case PROP_ID_expenseSubjectId:
               return getExpenseSubjectId();
