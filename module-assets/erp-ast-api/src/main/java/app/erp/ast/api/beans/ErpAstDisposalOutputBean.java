//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpAstDisposalOutputBean {
        ...
        private String _disposalType_label;

    
        public String getDisposalType_label(){
            return _disposalType_label;
        }

        public void setDisposalType_label(String value){
            this._disposalType_label = value;
        }
        ...
        public java.math.BigDecimal getDisposalAmount(){
            return _disposalAmount;
        }

        public void setDisposalAmount(java.math.BigDecimal value){
        ...
        public void setGainLoss(java.math.BigDecimal value){
