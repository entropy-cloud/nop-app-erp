...
CREATE TABLE erp_ast_asset_model(
  ...
  CATEGORY_ID BIGINT NULL    COMMENT '所属类别',
  EXT_FIELD_DEFS VARCHAR(4000) NULL    COMMENT '扩展字段集定义',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE erp_ast_inventory(
  ...
  APPROVED_AT DATETIME(3) NULL    COMMENT '复核时间',
  AMOUNT_SOURCE DECIMAL(20,4) default 0  NULL    COMMENT '源币种金额',
  AMOUNT_FUNCTIONAL DECIMAL(20,4) default 0  NULL    COMMENT '本位币金额',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_ast_asset(
  ...
  MODEL_ID BIGINT NULL    COMMENT '资产型号',
  EXT_FIELD_VALUES VARCHAR(4000) NULL    COMMENT '扩展字段值',
  constraint PK_erp_ast_asset primary key (ID)
)CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs;

CREATE TABLE erp_ast_asset_action_log(
  ID BIGINT NOT NULL    COMMENT 'ID',
  ASSET_ID BIGINT NOT NULL    COMMENT '资产',
  EVENT_TYPE VARCHAR(20) NOT NULL    COMMENT '事件类型',
  FROM_STATUS VARCHAR(20) NULL    COMMENT '变更前资产状态',
  TO_STATUS VARCHAR(20) NULL    COMMENT '变更后资产状态',
  FROM_DEPARTMENT_ID BIGINT NULL    COMMENT '变更前部门',
  TO_DEPARTMENT_ID BIGINT NULL    COMMENT '变更后部门',
  FROM_LOCATION_ID BIGINT NULL    COMMENT '变更前地点',
  TO_LOCATION_ID BIGINT NULL    COMMENT '变更后地点',
  FROM_STAFF_ID BIGINT NULL    COMMENT '变更前使用人',
  TO_STAFF_ID BIGINT NULL    COMMENT '变更后使用人',
  REF_ENTITY_NAME VARCHAR(50) NULL    COMMENT '关联单据实体',
  REF_ENTITY_ID BIGINT NULL    COMMENT '关联单据ID',
...
CREATE TABLE erp_ast_cip(
  ...
  AMOUNT_SOURCE DECIMAL(20,4) default 0  NULL    COMMENT '源币种金额',
  AMOUNT_FUNCTIONAL DECIMAL(20,4) default 0  NULL    COMMENT '本位币金额',
  PROJECT_ID BIGINT NULL    COMMENT '关联项目(可空)',
  CIP_ASSET_CATEGORY_SNAPSHOT VARCHAR(500) NULL    COMMENT '转固时类别快照',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE erp_ast_merge(
  ...
  CODE VARCHAR(50) NOT NULL    COMMENT '单号',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  TARGET_ASSET_ID BIGINT NULL    COMMENT '合并目标资产',
...
CREATE TABLE erp_ast_cip_cost_item(
  ...
  ORG_ID BIGINT NULL    COMMENT '所属组织',
  LINE_NO INTEGER NULL    COMMENT '行号',
  COST_TYPE VARCHAR(30) NOT NULL    COMMENT '成本类型',
  AMOUNT_SOURCE DECIMAL(20,4) default 0  NULL    COMMENT '源币种金额',
  EXCHANGE_RATE DECIMAL(20,8) default 1  NOT NULL    COMMENT '汇率',
  AMOUNT_FUNCTIONAL DECIMAL(20,4) default 0  NOT NULL    COMMENT '本位币金额',
  SOURCE_BILL_TYPE VARCHAR(30) NULL    COMMENT '来源单据类型',
  SOURCE_BILL_CODE VARCHAR(50) NULL    COMMENT '来源单据号',
  POSTED_TRANSFER_FLAG BOOLEAN default 0  NULL    COMMENT '已转固标记',
  CAPITALIZATION_ID BIGINT NULL    COMMENT '转固资本化单',
  BUSINESS_DATE DATE NULL    COMMENT '业务日期',
  CURRENCY_ID BIGINT NULL    COMMENT '币种',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_ast_cip_progress_billing(
  ...
  ORG_ID BIGINT NULL    COMMENT '所属组织',
  LINE_NO INTEGER NULL    COMMENT '行号',
  BILLING_DATE DATE NOT NULL    COMMENT '付款日期',
  BILLING_MILESTONE VARCHAR(200) NULL    COMMENT '里程碑',
  AMOUNT_SOURCE DECIMAL(20,4) default 0  NULL    COMMENT '源币种金额',
  EXCHANGE_RATE DECIMAL(20,8) default 1  NOT NULL    COMMENT '汇率',
  AMOUNT_FUNCTIONAL DECIMAL(20,4) default 0  NOT NULL    COMMENT '本位币金额',
  PAYMENT_VOUCHER_CODE VARCHAR(50) NULL    COMMENT '付款凭证号',
  PAID_FLAG BOOLEAN default 0  NULL    COMMENT '已付标记',
  CURRENCY_ID BIGINT NULL    COMMENT '币种',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
...
CREATE TABLE erp_ast_split_line(
  ID BIGINT NOT NULL    COMMENT 'ID',
  SPLIT_ID BIGINT NOT NULL    COMMENT '拆分单',
  ORG_ID BIGINT NULL    COMMENT '所属组织',
  LINE_NO INTEGER NULL    COMMENT '行号',
  TARGET_ASSET_CODE VARCHAR(50) NOT NULL    COMMENT '目标资产编码',
  TARGET_ASSET_NAME VARCHAR(200) NULL    COMMENT '目标资产名称',
  CATEGORY_ID BIGINT NULL    COMMENT '目标资产类别',
  ALLOCATION_METHOD VARCHAR(20) NULL    COMMENT '分摊方式',
  PROPORTION DECIMAL(8,6) default 0  NULL    COMMENT '比例',
  ORIGINAL_COST_AMOUNT DECIMAL(20,4) default 0  NOT NULL    COMMENT '原值金额',
  ACCUMULATED_DEPRECIATION_AMOUNT DECIMAL(20,4) default 0  NULL    COMMENT '累计折旧金额',
  NET_BOOK_VALUE DECIMAL(20,4) default 0  NULL    COMMENT '账面净值',
  TARGET_ASSET_ID BIGINT NULL    COMMENT '目标资产',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE erp_ast_merge_line(
  ID BIGINT NOT NULL    COMMENT 'ID',
  MERGE_ID BIGINT NOT NULL    COMMENT '合并单',
  ORG_ID BIGINT NULL    COMMENT '所属组织',
  LINE_NO INTEGER NULL    COMMENT '行号',
  SOURCE_ASSET_ID BIGINT NOT NULL    COMMENT '源资产',
  CONTRIBUTION_PROPORTION DECIMAL(8,6) default 0  NULL    COMMENT '贡献比例',
  ORIGINAL_COST_AMOUNT DECIMAL(20,4) default 0  NOT NULL    COMMENT '原值金额',
  ACCUMULATED_DEPRECIATION_AMOUNT DECIMAL(20,4) default 0  NULL    COMMENT '累计折旧金额',
  NET_BOOK_VALUE DECIMAL(20,4) default 0  NULL    COMMENT '账面净值',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
...
CREATE TABLE erp_ast_maintenance_cost(
  ...
  constraint PK_erp_ast_maintenance_cost primary key (ID)
   ...
   ALTER TABLE erp_ast_asset_model COMMENT '资产型号';
   ...
   ALTER TABLE erp_ast_asset_action_log COMMENT '资产操作审计';
   ...
   ALTER TABLE erp_ast_cip_progress_billing COMMENT 'CIP进度付款';
