...
public class ErpCtVolumeDiscountBizModel extends CrudBizModel<ErpCtVolumeDiscount>
    ...
    @BizLoader(forType = ErpCtVolumeDiscount.class)
    public List<String> contractLineName(@ContextSource List<ErpCtVolumeDiscount> rows) {
        orm().batchLoadProps(rows, Collections.singleton("contractLine"));
        List<String> result = new ArrayList<>(rows.size());
        for (ErpCtVolumeDiscount row : rows) {
    ...
    @BizLoader(forType = ErpCtVolumeDiscount.class)
    public List<String> orgName(@ContextSource List<ErpCtVolumeDiscount> rows) {
