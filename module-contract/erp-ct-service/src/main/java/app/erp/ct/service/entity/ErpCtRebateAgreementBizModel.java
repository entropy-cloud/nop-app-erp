...
public class ErpCtRebateAgreementBizModel extends CrudBizModel<ErpCtRebateAgreement>
    ...
    @BizLoader(forType = ErpCtRebateAgreement.class)
    public List<String> contractName(@ContextSource List<ErpCtRebateAgreement> rows) {
        orm().batchLoadProps(rows, Collections.singleton("contract"));
        List<String> result = new ArrayList<>(rows.size());
        for (ErpCtRebateAgreement row : rows) {
    ...
    @BizLoader(forType = ErpCtRebateAgreement.class)
    public List<String> orgName(@ContextSource List<ErpCtRebateAgreement> rows) {
    ...
    @BizLoader(forType = ErpCtRebateAgreement.class)
    public List<String> partnerName(@ContextSource List<ErpCtRebateAgreement> rows) {
