...
public class ErpCtRebateSettlementBizModel extends CrudBizModel<ErpCtRebateSettlement>
    ...
    @BizLoader(forType = ErpCtRebateSettlement.class)
    public List<String> rebateAgreementName(@ContextSource List<ErpCtRebateSettlement> rows) {
        orm().batchLoadProps(rows, Collections.singleton("rebateAgreement"));
        List<String> result = new ArrayList<>(rows.size());
        for (ErpCtRebateSettlement row : rows) {
    ...
    @BizLoader(forType = ErpCtRebateSettlement.class)
    public List<String> orgName(@ContextSource List<ErpCtRebateSettlement> rows) {
