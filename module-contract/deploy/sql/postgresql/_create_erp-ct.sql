...
CREATE TABLE erp_ct_rebate_agreement(
  ...
  contract_id INT8  ,
  partner_id INT8 NOT NULL ,
  rebate_type INT4 NOT NULL ,
  agreement_date DATE  ,
  start_date DATE NOT NULL ,
  end_date DATE NOT NULL ,
  accrual_method INT4 NOT NULL ,
  status INT4 NOT NULL ,
  total_accumulated_amount NUMERIC(20,4)  ,
  estimated_rebate_amount NUMERIC(20,4)  ,
  remark VARCHAR(1000)  ,
  del_version INT8 default 0  NOT NULL ,
  version INT4 default 0  NOT NULL ,
  created_by VARCHAR(50) NOT NULL ,
...
CREATE TABLE erp_ct_rebate_accrual(
  ...
  source_bill_type VARCHAR(50)  ,
  source_bill_code VARCHAR(50)  ,
  bill_amount_source NUMERIC(20,4)  ,
  accrued_rebate NUMERIC(20,4)  ,
  accrual_date DATE  ,
...
CREATE TABLE erp_ct_rebate_settlement(
  ...
  total_rebate_amount NUMERIC(20,4)  ,
