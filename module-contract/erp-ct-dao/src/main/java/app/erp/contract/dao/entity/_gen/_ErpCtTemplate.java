...
/**
 *  合同模板: erp_ct_template
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCtTemplate extends DynamicOrmEntity{
    ...
    /* 模板内容: CONTENT_TEMPLATE VARCHAR */
    public static final String PROP_NAME_contentTemplate = "contentTemplate";
    public static final int PROP_ID_contentTemplate = 5;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_contentTemplate] = PROP_NAME_contentTemplate;
          PROP_NAME_TO_ID.put(PROP_NAME_contentTemplate, PROP_ID_contentTemplate);
    ...
    public _ErpCtTemplate(){
        // for debug
    }

    protected ErpCtTemplate newInstance(){
        ErpCtTemplate entity = new ErpCtTemplate();
    ...
    @Override
    public ErpCtTemplate cloneInstance() {
        ErpCtTemplate entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.contract.dao.entity.ErpCtTemplate";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_contentTemplate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_contentTemplate));
               }
               setContentTemplate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_contentTemplate:{
               onInitProp(propId);
               this._contentTemplate = (java.lang.String)value;
    ...
    public final java.lang.String getContentTemplate(){
         onPropGet(PROP_ID_contentTemplate);
     ...
     * 模板内容: CONTENT_TEMPLATE
     */
    public final void setContentTemplate(java.lang.String value){
        if(onPropSet(PROP_ID_contentTemplate,value)){
            this._contentTemplate = value;
            internalClearRefs(PROP_ID_contentTemplate);
