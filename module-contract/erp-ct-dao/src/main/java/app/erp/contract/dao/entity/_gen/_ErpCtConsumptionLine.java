...
/**
 *  消耗计费行: erp_ct_consumption_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCtConsumptionLine extends DynamicOrmEntity{
    ...
    /* 消耗日期: CONSUMPTION_DATE DATE */
    public static final String PROP_NAME_consumptionDate = "consumptionDate";
    public static final int PROP_ID_consumptionDate = 3;
    
    /* 消耗数量: QUANTITY DECIMAL */
    public static final String PROP_NAME_quantity = "quantity";
    public static final int PROP_ID_quantity = 4;
    
    /* 单价: UNIT_PRICE DECIMAL */
    public static final String PROP_NAME_unitPrice = "unitPrice";
    public static final int PROP_ID_unitPrice = 5;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_consumptionDate] = PROP_NAME_consumptionDate;
          PROP_NAME_TO_ID.put(PROP_NAME_consumptionDate, PROP_ID_consumptionDate);
    ...
    public _ErpCtConsumptionLine(){
        // for debug
    }

    protected ErpCtConsumptionLine newInstance(){
        ErpCtConsumptionLine entity = new ErpCtConsumptionLine();
    ...
    @Override
    public ErpCtConsumptionLine cloneInstance() {
        ErpCtConsumptionLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.contract.dao.entity.ErpCtConsumptionLine";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_consumptionDate:
               return getConsumptionDate();
            ...
            case PROP_ID_consumptionDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_consumptionDate));
               }
               setConsumptionDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_consumptionDate:{
               onInitProp(propId);
               this._consumptionDate = (java.time.LocalDate)value;
     ...
     * 消耗日期: CONSUMPTION_DATE
     */
    public final java.time.LocalDate getConsumptionDate(){
         onPropGet(PROP_ID_consumptionDate);
     ...
     * 消耗日期: CONSUMPTION_DATE
     */
    public final void setConsumptionDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_consumptionDate,value)){
            this._consumptionDate = value;
            internalClearRefs(PROP_ID_consumptionDate);
