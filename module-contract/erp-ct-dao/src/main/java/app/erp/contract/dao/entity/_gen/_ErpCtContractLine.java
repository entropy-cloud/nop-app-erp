...
/**
 *  合同行: erp_ct_contract_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCtContractLine extends DynamicOrmEntity{
    ...
    /* relation:  */
    public static final String PROP_NAME_invoicePlans = "invoicePlans";
    ...
    public _ErpCtContractLine(){
        // for debug
    }

    protected ErpCtContractLine newInstance(){
        ErpCtContractLine entity = new ErpCtContractLine();
    ...
    @Override
    public ErpCtContractLine cloneInstance() {
        ErpCtContractLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.contract.dao.entity.ErpCtContractLine";
    }
    ...
    private final OrmEntitySet<app.erp.contract.dao.entity.ErpCtInvoicePlan> _invoicePlans = new OrmEntitySet<>(this, PROP_NAME_invoicePlans,
        null, null,app.erp.contract.dao.entity.ErpCtInvoicePlan.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.contract.dao.entity.ErpCtInvoicePlan> getInvoicePlans(){
       return _invoicePlans;
    }
       
    private final OrmEntitySet<app.erp.contract.dao.entity.ErpCtConsumptionLine> _consumptionLines = new OrmEntitySet<>(this, PROP_NAME_consumptionLines,
        null, null,app.erp.contract.dao.entity.ErpCtConsumptionLine.class);
