...
/**
 *  批量折扣: erp_ct_volume_discount
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCtVolumeDiscount extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 合同行: CONTRACT_LINE_ID BIGINT */
    ...
    /* 起始数量: FROM_QTY DECIMAL */
    public static final String PROP_NAME_fromQty = "fromQty";
    public static final int PROP_ID_fromQty = 4;
    
    /* 截止数量: TO_QTY DECIMAL */
    public static final String PROP_NAME_toQty = "toQty";
    public static final int PROP_ID_toQty = 5;
    
    /* 折扣百分比: DISCOUNT_PERCENT DECIMAL */
    public static final String PROP_NAME_discountPercent = "discountPercent";
    public static final int PROP_ID_discountPercent = 6;
    
    /* 覆盖单价: UNIT_PRICE DECIMAL */
    public static final String PROP_NAME_unitPrice = "unitPrice";
    public static final int PROP_ID_unitPrice = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_fromQty] = PROP_NAME_fromQty;
          PROP_NAME_TO_ID.put(PROP_NAME_fromQty, PROP_ID_fromQty);
      
          PROP_ID_TO_NAME[PROP_ID_toQty] = PROP_NAME_toQty;
          PROP_NAME_TO_ID.put(PROP_NAME_toQty, PROP_ID_toQty);
    ...
    public _ErpCtVolumeDiscount(){
        // for debug
    }

    protected ErpCtVolumeDiscount newInstance(){
        ErpCtVolumeDiscount entity = new ErpCtVolumeDiscount();
    ...
    @Override
    public ErpCtVolumeDiscount cloneInstance() {
        ErpCtVolumeDiscount entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.contract.dao.entity.ErpCtVolumeDiscount";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_fromQty:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_fromQty));
               }
               setFromQty(typedValue);
               break;
            }
            ...
            case PROP_ID_toQty:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_toQty));
               }
               setToQty(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_fromQty:{
               onInitProp(propId);
               this._fromQty = (java.math.BigDecimal)value;
            ...
            case PROP_ID_toQty:{
               onInitProp(propId);
               this._toQty = (java.math.BigDecimal)value;
     ...
     * 起始数量: FROM_QTY
     */
    public final java.math.BigDecimal getFromQty(){
         onPropGet(PROP_ID_fromQty);
         return _fromQty;
    }
     ...
     * 起始数量: FROM_QTY
     */
    public final void setFromQty(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_fromQty,value)){
            this._fromQty = value;
            internalClearRefs(PROP_ID_fromQty);
     ...
     * 截止数量: TO_QTY
     */
    public final java.math.BigDecimal getToQty(){
         onPropGet(PROP_ID_toQty);
         return _toQty;
    }
     ...
     * 截止数量: TO_QTY
     */
    public final void setToQty(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_toQty,value)){
            this._toQty = value;
            internalClearRefs(PROP_ID_toQty);
