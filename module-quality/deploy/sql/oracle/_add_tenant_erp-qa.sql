...
alter table erp_qa_risk_register add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_sampling_plan add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_inspection_template add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_quality_goal add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_review add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_calibration add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_inspection add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_inspection_template_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_spc_chart add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_inspection_line add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_non_conformance add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_spc_sample add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_spc_capability add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_action add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_recall add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_qa_recall_target add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_qa_recall drop constraint PK_erp_qa_recall;
alter table erp_qa_recall add constraint PK_erp_qa_recall primary key (NOP_TENANT_ID, ID);

alter table erp_qa_recall_target drop constraint PK_erp_qa_recall_target;
alter table erp_qa_recall_target add constraint PK_erp_qa_recall_target primary key (NOP_TENANT_ID, ID);
