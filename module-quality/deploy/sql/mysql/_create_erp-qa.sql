...
CREATE TABLE erp_qa_non_conformance(
  ...
  DISPOSITION_TYPE INTEGER NULL    COMMENT '处理决定',
  STATUS INTEGER NOT NULL    COMMENT '状态',
  SUPPLIER_ID BIGINT NULL    COMMENT '供应商',
...
CREATE TABLE erp_qa_recall(
  ...
  TRIGGER_TYPE INTEGER NOT NULL    COMMENT '触发类型',
  ...
  SEVERITY_LEVEL INTEGER NOT NULL    COMMENT '严重程度',
  BUSINESS_DATE DATE NOT NULL    COMMENT '业务日期',
  NOTIFY_CUSTOMER BOOLEAN default 0  NULL    COMMENT '已通知客户',
  STATUS INTEGER NOT NULL    COMMENT '召回状态',
  APPROVE_STATUS INTEGER NOT NULL    COMMENT '审核状态',
...
CREATE TABLE erp_qa_recall_target(
  ...
  RETURN_STATUS INTEGER NOT NULL    COMMENT '退货状态',
