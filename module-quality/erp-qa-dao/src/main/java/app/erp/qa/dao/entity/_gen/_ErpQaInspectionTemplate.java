...
/**
 *  质检模板: erp_qa_inspection_template
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpQaInspectionTemplate extends DynamicOrmEntity{
    ...
    public _ErpQaInspectionTemplate(){
        // for debug
    }

    protected ErpQaInspectionTemplate newInstance(){
        ErpQaInspectionTemplate entity = new ErpQaInspectionTemplate();
    ...
    @Override
    public ErpQaInspectionTemplate cloneInstance() {
        ErpQaInspectionTemplate entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.qa.dao.entity.ErpQaInspectionTemplate";
    }
    ...
    private final OrmEntitySet<app.erp.qa.dao.entity.ErpQaInspectionTemplateLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.qa.dao.entity.ErpQaInspectionTemplateLine.class);
