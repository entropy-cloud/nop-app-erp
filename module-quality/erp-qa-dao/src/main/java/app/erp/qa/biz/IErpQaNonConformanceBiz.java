 ...
 *   <li>{@link #resolve}：IN_REVIEW→RESOLVED（须全部关联 CAPA ErpQaAction.status=COMPLETED + 验证人/验证日期已填；
 *       无 CAPA 措施时须显式提供 {@code noCapaReason}——误开/降级场景，否则抛 ERR_NCR_RESOLVE_NO_CAPA）。</li>
