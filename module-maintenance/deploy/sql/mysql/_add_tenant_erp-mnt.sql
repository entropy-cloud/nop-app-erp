...
alter table erp_mnt_task_template add NOP_TENANT_ID VARCHAR(32) DEFAULT '0' NOT NULL;
...
alter table erp_mnt_task_template_line add NOP_TENANT_ID VARCHAR(32) DEFAULT '0' NOT NULL;
...
alter table erp_mnt_equipment_status_log add NOP_TENANT_ID VARCHAR(32) DEFAULT '0' NOT NULL;
...
alter table erp_mnt_task_template drop primary key;
alter table erp_mnt_task_template add primary key (NOP_TENANT_ID, ID);
...
alter table erp_mnt_task_template_line drop primary key;
alter table erp_mnt_task_template_line add primary key (NOP_TENANT_ID, ID);
...
alter table erp_mnt_equipment_status_log drop primary key;
alter table erp_mnt_equipment_status_log add primary key (NOP_TENANT_ID, ID);
