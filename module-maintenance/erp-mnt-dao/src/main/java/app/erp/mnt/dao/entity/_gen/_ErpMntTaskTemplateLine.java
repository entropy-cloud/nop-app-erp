...
/**
 *  维护任务模板行: erp_mnt_task_template_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntTaskTemplateLine extends DynamicOrmEntity{
    ...
    /* 标准工时(分钟,行级): STANDARD_MINUTES */
    private java.math.BigDecimal _standardMinutes;
    
    /* 标准备件(物料,提示): MATERIAL_ID */
    ...
    public _ErpMntTaskTemplateLine(){
        // for debug
    }

    protected ErpMntTaskTemplateLine newInstance(){
        ErpMntTaskTemplateLine entity = new ErpMntTaskTemplateLine();
    ...
    @Override
    public ErpMntTaskTemplateLine cloneInstance() {
        ErpMntTaskTemplateLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntTaskTemplateLine";
    }
     ...
     * 
     */
    public final app.erp.mnt.dao.entity.ErpMntTaskTemplate getTemplate(){
       return (app.erp.mnt.dao.entity.ErpMntTaskTemplate)internalGetRefEntity(PROP_NAME_template);
    }

    public final void setTemplate(app.erp.mnt.dao.entity.ErpMntTaskTemplate refEntity){
