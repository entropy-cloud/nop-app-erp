...
/**
 *  设备状态日志: erp_mnt_equipment_status_log
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntEquipmentStatusLog extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_changeAt] = PROP_NAME_changeAt;
          PROP_NAME_TO_ID.put(PROP_NAME_changeAt, PROP_ID_changeAt);
    ...
    public _ErpMntEquipmentStatusLog(){
        // for debug
    }

    protected ErpMntEquipmentStatusLog newInstance(){
        ErpMntEquipmentStatusLog entity = new ErpMntEquipmentStatusLog();
    ...
    @Override
    public ErpMntEquipmentStatusLog cloneInstance() {
        ErpMntEquipmentStatusLog entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntEquipmentStatusLog";
    }
            ...
            case PROP_ID_changeAt:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toTimestamp(value,
                       err-> newTypeConversionError(PROP_NAME_changeAt));
               }
               setChangeAt(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_changeAt:{
               onInitProp(propId);
               this._changeAt = (java.sql.Timestamp)value;
     ...
     * 变更时间: CHANGE_AT
     */
    public final java.sql.Timestamp getChangeAt(){
         onPropGet(PROP_ID_changeAt);
         return _changeAt;
    }
     ...
     * 变更时间: CHANGE_AT
     */
    public final void setChangeAt(java.sql.Timestamp value){
        if(onPropSet(PROP_ID_changeAt,value)){
            this._changeAt = value;
            internalClearRefs(PROP_ID_changeAt);
