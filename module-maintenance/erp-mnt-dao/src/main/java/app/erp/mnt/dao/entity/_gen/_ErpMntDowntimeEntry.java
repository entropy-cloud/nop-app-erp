...
/**
 *  停机记录: erp_mnt_downtime_entry
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntDowntimeEntry extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_equipmentId = 2;
    
    /* 开始时间: START_TIME TIMESTAMP */
    public static final String PROP_NAME_startTime = "startTime";
    public static final int PROP_ID_startTime = 3;
    
    /* 结束时间: END_TIME TIMESTAMP */
    public static final String PROP_NAME_endTime = "endTime";
    public static final int PROP_ID_endTime = 4;
    
    /* 总分钟数: TOTAL_MINUTES DECIMAL */
    public static final String PROP_NAME_totalMinutes = "totalMinutes";
    public static final int PROP_ID_totalMinutes = 5;
    
    /* 原因: REASON VARCHAR */
    public static final String PROP_NAME_reason = "reason";
    public static final int PROP_ID_reason = 6;
    
    /* 关联生产工单ID: RELATED_JOB_ORDER_ID BIGINT */
    public static final String PROP_NAME_relatedJobOrderId = "relatedJobOrderId";
    public static final int PROP_ID_relatedJobOrderId = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_relatedJobOrderId] = PROP_NAME_relatedJobOrderId;
          PROP_NAME_TO_ID.put(PROP_NAME_relatedJobOrderId, PROP_ID_relatedJobOrderId);
    ...
    /* 关联生产工单ID: RELATED_JOB_ORDER_ID */
    private java.lang.String _relatedJobOrderId;
    ...
    public _ErpMntDowntimeEntry(){
        // for debug
    }

    protected ErpMntDowntimeEntry newInstance(){
        ErpMntDowntimeEntry entity = new ErpMntDowntimeEntry();
    ...
    @Override
    public ErpMntDowntimeEntry cloneInstance() {
        ErpMntDowntimeEntry entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntDowntimeEntry";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_relatedJobOrderId:
               return getRelatedJobOrderId();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_relatedJobOrderId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_relatedJobOrderId));
               }
               setRelatedJobOrderId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_relatedJobOrderId:{
               onInitProp(propId);
               this._relatedJobOrderId = (java.lang.String)value;
     ...
     * 关联生产工单ID: RELATED_JOB_ORDER_ID
     */
    public final java.lang.String getRelatedJobOrderId(){
         onPropGet(PROP_ID_relatedJobOrderId);
     ...
     * 关联生产工单ID: RELATED_JOB_ORDER_ID
     */
    public final void setRelatedJobOrderId(java.lang.String value){
        if(onPropSet(PROP_ID_relatedJobOrderId,value)){
            this._relatedJobOrderId = value;
            internalClearRefs(PROP_ID_relatedJobOrderId);
