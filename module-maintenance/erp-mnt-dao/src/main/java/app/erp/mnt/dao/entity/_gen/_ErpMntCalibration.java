...
/**
 *  校准记录: erp_mnt_calibration
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntCalibration extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_nextCalibrationDate = 11;
    
    /* 校准人(职员): CALIBRATED_BY BIGINT */
    public static final String PROP_NAME_calibratedBy = "calibratedBy";
    public static final int PROP_ID_calibratedBy = 12;
    ...
    protected ErpMntCalibration newInstance(){
        ErpMntCalibration entity = new ErpMntCalibration();
    ...
    @Override
    public ErpMntCalibration cloneInstance() {
        ErpMntCalibration entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntCalibration";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_measuredValue:{
               onInitProp(propId);
               this._measuredValue = (java.math.BigDecimal)value;
     ...
     * 测量值: MEASURED_VALUE
     */
    public final java.math.BigDecimal getMeasuredValue(){
     ...
     * 测量值: MEASURED_VALUE
     */
    public final void setMeasuredValue(java.math.BigDecimal value){
