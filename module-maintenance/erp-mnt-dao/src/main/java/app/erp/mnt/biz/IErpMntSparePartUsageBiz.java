 ...
 *
 * <p>红冲入口 {@link #reverseConfirm(String, IServiceContext)}：已过账（posted=true + ACTIVE）的备件消耗单可红冲，
...
public interface IErpMntSparePartUsageBiz extends ICrudBiz<ErpMntSparePartUsage> {
    ...
    @BizMutation
    ErpMntSparePartUsage confirm(@Name("usageId") String usageId, IServiceContext context);
     ...
     */
    @BizMutation
    ErpMntSparePartUsage reverseConfirm(@Name("usageId") String usageId, IServiceContext context);
}
