...
/**
 *  维护任务模板: erp_mnt_task_template
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntTaskTemplate extends DynamicOrmEntity{
    ...
    /* 适用设备分类(可空=需显式套用): EQUIPMENT_CATEGORY_ID BIGINT */
    public static final String PROP_NAME_equipmentCategoryId = "equipmentCategoryId";
    public static final int PROP_ID_equipmentCategoryId = 4;
    
    /* 标准工时(分钟): STANDARD_MINUTES DECIMAL */
    public static final String PROP_NAME_standardMinutes = "standardMinutes";
    public static final int PROP_ID_standardMinutes = 5;
    
    /* 操作说明: INSTRUCTION VARCHAR */
    public static final String PROP_NAME_instruction = "instruction";
    public static final int PROP_ID_instruction = 6;
    
    /* 是否启用(空=否): IS_ACTIVE INTEGER */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_equipmentCategoryId] = PROP_NAME_equipmentCategoryId;
          PROP_NAME_TO_ID.put(PROP_NAME_equipmentCategoryId, PROP_ID_equipmentCategoryId);
          ...
          PROP_ID_TO_NAME[PROP_ID_instruction] = PROP_NAME_instruction;
          PROP_NAME_TO_ID.put(PROP_NAME_instruction, PROP_ID_instruction);
    ...
    public _ErpMntTaskTemplate(){
        // for debug
    }

    protected ErpMntTaskTemplate newInstance(){
        ErpMntTaskTemplate entity = new ErpMntTaskTemplate();
    ...
    @Override
    public ErpMntTaskTemplate cloneInstance() {
        ErpMntTaskTemplate entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntTaskTemplate";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_instruction:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_instruction));
               }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_instruction:{
               onInitProp(propId);
               this._instruction = (java.lang.String)value;
     ...
     * 操作说明: INSTRUCTION
     */
    public final void setInstruction(java.lang.String value){
        if(onPropSet(PROP_ID_instruction,value)){
            this._instruction = value;
            internalClearRefs(PROP_ID_instruction);
    ...
    public final void setCategory(app.erp.mnt.dao.entity.ErpMntEquipmentCategory refEntity){
           ...
           if(refEntity == null){
                   ...
                   this.setEquipmentCategoryId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_category, refEntity,()->{
           
                           this.setEquipmentCategoryId(refEntity.getId());
    ...
    private final OrmEntitySet<app.erp.mnt.dao.entity.ErpMntTaskTemplateLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.mnt.dao.entity.ErpMntTaskTemplateLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.mnt.dao.entity.ErpMntTaskTemplateLine> getLines(){
       return _lines;
    }
