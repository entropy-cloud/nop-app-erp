...
/**
 *  维护团队: erp_mnt_maintenance_team
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntMaintenanceTeam extends DynamicOrmEntity{
    ...
    /* 负责人(职员): LEADER_ID BIGINT */
    public static final String PROP_NAME_leaderId = "leaderId";
    public static final int PROP_ID_leaderId = 5;
    ...
    public _ErpMntMaintenanceTeam(){
        // for debug
    }

    protected ErpMntMaintenanceTeam newInstance(){
        ErpMntMaintenanceTeam entity = new ErpMntMaintenanceTeam();
    ...
    @Override
    public ErpMntMaintenanceTeam cloneInstance() {
        ErpMntMaintenanceTeam entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntMaintenanceTeam";
    }
     ...
     */
    public final IOrmEntitySet<app.erp.mnt.dao.entity.ErpMntMaintenanceTeamMember> getMembers(){
       return _members;
    }
