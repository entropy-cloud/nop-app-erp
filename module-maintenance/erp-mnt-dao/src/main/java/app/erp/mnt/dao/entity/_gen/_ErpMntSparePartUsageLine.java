...
/**
 *  备件消耗行: erp_mnt_spare_part_usage_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntSparePartUsageLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 备件消耗单ID: SPARE_PART_USAGE_ID BIGINT */
    public static final String PROP_NAME_sparePartUsageId = "sparePartUsageId";
    public static final int PROP_ID_sparePartUsageId = 2;
    
    /* 行号: LINE_NO INTEGER */
    public static final String PROP_NAME_lineNo = "lineNo";
    public static final int PROP_ID_lineNo = 3;
    
    /* 备件(物料): MATERIAL_ID BIGINT */
    ...
    public static final int PROP_ID_unitCost = 7;
    ...
    public static final int PROP_ID_batchNo = 9;
    ...
    /* relation:  */
    public static final String PROP_NAME_sparePartUsage = "sparePartUsage";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_sparePartUsageId] = PROP_NAME_sparePartUsageId;
          PROP_NAME_TO_ID.put(PROP_NAME_sparePartUsageId, PROP_ID_sparePartUsageId);
    ...
    public _ErpMntSparePartUsageLine(){
        // for debug
    }

    protected ErpMntSparePartUsageLine newInstance(){
        ErpMntSparePartUsageLine entity = new ErpMntSparePartUsageLine();
    ...
    @Override
    public ErpMntSparePartUsageLine cloneInstance() {
        ErpMntSparePartUsageLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntSparePartUsageLine";
    }
     ...
     * 
     */
    public final app.erp.mnt.dao.entity.ErpMntSparePartUsage getSparePartUsage(){
       return (app.erp.mnt.dao.entity.ErpMntSparePartUsage)internalGetRefEntity(PROP_NAME_sparePartUsage);
    }

    public final void setSparePartUsage(app.erp.mnt.dao.entity.ErpMntSparePartUsage refEntity){
   
           if(refEntity == null){
           
                   this.setSparePartUsageId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_sparePartUsage, refEntity,()->{
           
                           this.setSparePartUsageId(refEntity.getId());
