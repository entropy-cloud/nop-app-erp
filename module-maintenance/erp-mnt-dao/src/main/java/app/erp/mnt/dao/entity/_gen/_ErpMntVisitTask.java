...
/**
 *  维护任务: erp_mnt_visit_task
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntVisitTask extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_visitId = 2;
    
    /* 行号: LINE_NO INTEGER */
    public static final String PROP_NAME_lineNo = "lineNo";
    public static final int PROP_ID_lineNo = 3;
    
    /* 任务描述: TASK_DESCRIPTION VARCHAR */
    public static final String PROP_NAME_taskDescription = "taskDescription";
    public static final int PROP_ID_taskDescription = 4;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_taskDescription] = PROP_NAME_taskDescription;
          PROP_NAME_TO_ID.put(PROP_NAME_taskDescription, PROP_ID_taskDescription);
    ...
    public _ErpMntVisitTask(){
        // for debug
    }

    protected ErpMntVisitTask newInstance(){
        ErpMntVisitTask entity = new ErpMntVisitTask();
    ...
    @Override
    public ErpMntVisitTask cloneInstance() {
        ErpMntVisitTask entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntVisitTask";
    }
            ...
            case PROP_ID_taskDescription:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_taskDescription));
               }
               setTaskDescription(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_taskDescription:{
               onInitProp(propId);
               this._taskDescription = (java.lang.String)value;
    ...
    public final java.lang.String getTaskDescription(){
         onPropGet(PROP_ID_taskDescription);
     ...
     * 任务描述: TASK_DESCRIPTION
     */
    public final void setTaskDescription(java.lang.String value){
        if(onPropSet(PROP_ID_taskDescription,value)){
            this._taskDescription = value;
            internalClearRefs(PROP_ID_taskDescription);
