...
/**
 *  设备分类: erp_mnt_equipment_category
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMntEquipmentCategory extends DynamicOrmEntity{
    ...
    public _ErpMntEquipmentCategory(){
        // for debug
    }

    protected ErpMntEquipmentCategory newInstance(){
        ErpMntEquipmentCategory entity = new ErpMntEquipmentCategory();
    ...
    @Override
    public ErpMntEquipmentCategory cloneInstance() {
        ErpMntEquipmentCategory entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mnt.dao.entity.ErpMntEquipmentCategory";
    }
     ...
     * 
     */
    public final app.erp.mnt.dao.entity.ErpMntEquipmentCategory getParent(){
       return (app.erp.mnt.dao.entity.ErpMntEquipmentCategory)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.mnt.dao.entity.ErpMntEquipmentCategory refEntity){
