//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpMntSparePartUsageLineInputBean extends CrudInputBase {
        ...
        private String _sparePartUsageId;

    
        @PropMeta(propId=2)
    
        public String getSparePartUsageId(){
            return _sparePartUsageId;
        }

        public void setSparePartUsageId(String value){
