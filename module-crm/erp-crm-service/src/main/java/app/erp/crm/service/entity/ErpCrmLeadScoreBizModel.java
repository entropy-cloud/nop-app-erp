...
import app.erp.crm.service.processor.ErpCrmLeadScoreRecalculateScoreProcessor;
...
/**
 * 线索评分 BizModel。config 驱动评分计算委托 {@link ErpCrmLeadScoreRecalculateScoreProcessor}
 * （归一化 totalScore + append-only 历史快照 + auto-qualify 阈值触发复用 3.1 qualify）。
 *
