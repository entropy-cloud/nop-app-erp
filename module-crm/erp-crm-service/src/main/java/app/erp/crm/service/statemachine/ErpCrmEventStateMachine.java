 ...
 *
 * <p>非法边直抛领域码 {@link ErpCrmErrors#ERR_EVENT_ILLEGAL_STATUS_TRANSITION}（参数 {@code currentStatus}/
 * {@code expectedStatus}/{@code action}；plan 2026-09-07-2200-1 直抛领域码）；实体元数据（eventCode）
 * 经调用点同码补参补齐。
 *
...
public class ErpCrmEventStateMachine {
    ...
    private static NopException illegal(String action, String currentStatus, String expectedStatus) {
        return new NopException(ErpCrmErrors.ERR_EVENT_ILLEGAL_STATUS_TRANSITION)
