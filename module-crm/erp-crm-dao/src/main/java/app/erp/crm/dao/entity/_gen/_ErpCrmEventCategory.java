...
/**
 *  活动类别: erp_crm_event_category
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmEventCategory extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_color = 4;
    ...
    public _ErpCrmEventCategory(){
        // for debug
    }

    protected ErpCrmEventCategory newInstance(){
        ErpCrmEventCategory entity = new ErpCrmEventCategory();
    ...
    @Override
    public ErpCrmEventCategory cloneInstance() {
        ErpCrmEventCategory entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmEventCategory";
    }
