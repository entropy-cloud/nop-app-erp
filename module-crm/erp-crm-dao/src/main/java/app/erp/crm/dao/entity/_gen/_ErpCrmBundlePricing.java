...
/**
 *  捆绑定价: erp_crm_bundle_pricing
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmBundlePricing extends DynamicOrmEntity{
    ...
    /* 捆绑包名称: BUNDLE_NAME VARCHAR */
    public static final String PROP_NAME_bundleName = "bundleName";
    public static final int PROP_ID_bundleName = 5;
    
    /* 描述: DESCRIPTION VARCHAR */
    public static final String PROP_NAME_description = "description";
    public static final int PROP_ID_description = 6;
    
    /* 折扣类型: DISCOUNT_TYPE VARCHAR */
    public static final String PROP_NAME_discountType = "discountType";
    public static final int PROP_ID_discountType = 7;
    
    /* 折扣值: DISCOUNT_VALUE DECIMAL */
    public static final String PROP_NAME_discountValue = "discountValue";
    public static final int PROP_ID_discountValue = 8;
    
    /* 捆绑包总价: BUNDLE_AMOUNT DECIMAL */
    public static final String PROP_NAME_bundleAmount = "bundleAmount";
    public static final int PROP_ID_bundleAmount = 9;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_bundleName] = PROP_NAME_bundleName;
          PROP_NAME_TO_ID.put(PROP_NAME_bundleName, PROP_ID_bundleName);
          ...
          PROP_ID_TO_NAME[PROP_ID_bundleAmount] = PROP_NAME_bundleAmount;
          PROP_NAME_TO_ID.put(PROP_NAME_bundleAmount, PROP_ID_bundleAmount);
    ...
    public _ErpCrmBundlePricing(){
        // for debug
    }

    protected ErpCrmBundlePricing newInstance(){
        ErpCrmBundlePricing entity = new ErpCrmBundlePricing();
    ...
    @Override
    public ErpCrmBundlePricing cloneInstance() {
        ErpCrmBundlePricing entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmBundlePricing";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_bundleName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_bundleName));
               }
               setBundleName(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_bundleName:{
               onInitProp(propId);
               this._bundleName = (java.lang.String)value;
            ...
            case PROP_ID_discountType:{
               onInitProp(propId);
               this._discountType = (java.lang.String)value;
     ...
     * 捆绑包名称: BUNDLE_NAME
     */
    public final void setBundleName(java.lang.String value){
        if(onPropSet(PROP_ID_bundleName,value)){
            this._bundleName = value;
            internalClearRefs(PROP_ID_bundleName);
     ...
     * 折扣类型: DISCOUNT_TYPE
     */
    public final void setDiscountType(java.lang.String value){
