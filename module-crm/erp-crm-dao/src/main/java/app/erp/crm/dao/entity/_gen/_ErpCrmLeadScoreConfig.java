...
/**
 *  评分规则配置: erp_crm_lead_score_config
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmLeadScoreConfig extends DynamicOrmEntity{
    ...
    /* 规则集名称: CONFIG_NAME VARCHAR */
    public static final String PROP_NAME_configName = "configName";
    public static final int PROP_ID_configName = 4;
    
    /* 是否生效: IS_ACTIVE BOOLEAN */
    public static final String PROP_NAME_isActive = "isActive";
    public static final int PROP_ID_isActive = 5;
    
    /* 生效开始日期: EFFECTIVE_FROM DATE */
    public static final String PROP_NAME_effectiveFrom = "effectiveFrom";
    public static final int PROP_ID_effectiveFrom = 6;
    
    /* 生效结束日期: EFFECTIVE_TO DATE */
    public static final String PROP_NAME_effectiveTo = "effectiveTo";
    public static final int PROP_ID_effectiveTo = 7;
    
    /* 自动转商机阈值: AUTO_QUALIFY_THRESHOLD INTEGER */
    public static final String PROP_NAME_autoQualifyThreshold = "autoQualifyThreshold";
    public static final int PROP_ID_autoQualifyThreshold = 8;
    
    /* 最低跟进分数: MIN_SCORE_FOR_FOLLOW_UP INTEGER */
    public static final String PROP_NAME_minScoreForFollowUp = "minScoreForFollowUp";
    public static final int PROP_ID_minScoreForFollowUp = 9;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_autoQualifyThreshold] = PROP_NAME_autoQualifyThreshold;
          PROP_NAME_TO_ID.put(PROP_NAME_autoQualifyThreshold, PROP_ID_autoQualifyThreshold);
      
          PROP_ID_TO_NAME[PROP_ID_minScoreForFollowUp] = PROP_NAME_minScoreForFollowUp;
          PROP_NAME_TO_ID.put(PROP_NAME_minScoreForFollowUp, PROP_ID_minScoreForFollowUp);
    ...
    /* 自动转商机阈值: AUTO_QUALIFY_THRESHOLD */
    private java.lang.Integer _autoQualifyThreshold;
    
    /* 最低跟进分数: MIN_SCORE_FOR_FOLLOW_UP */
    private java.lang.Integer _minScoreForFollowUp;
    ...
    public _ErpCrmLeadScoreConfig(){
        // for debug
    }

    protected ErpCrmLeadScoreConfig newInstance(){
        ErpCrmLeadScoreConfig entity = new ErpCrmLeadScoreConfig();
    ...
    @Override
    public ErpCrmLeadScoreConfig cloneInstance() {
        ErpCrmLeadScoreConfig entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmLeadScoreConfig";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_autoQualifyThreshold:
               return getAutoQualifyThreshold();
        
            case PROP_ID_minScoreForFollowUp:
               return getMinScoreForFollowUp();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_autoQualifyThreshold:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_autoQualifyThreshold));
               }
               setAutoQualifyThreshold(typedValue);
               break;
            }
            ...
            case PROP_ID_minScoreForFollowUp:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_minScoreForFollowUp));
               }
               setMinScoreForFollowUp(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_autoQualifyThreshold:{
               onInitProp(propId);
               this._autoQualifyThreshold = (java.lang.Integer)value;
            ...
            case PROP_ID_minScoreForFollowUp:{
               onInitProp(propId);
               this._minScoreForFollowUp = (java.lang.Integer)value;
     ...
     * 自动转商机阈值: AUTO_QUALIFY_THRESHOLD
     */
    public final java.lang.Integer getAutoQualifyThreshold(){
         onPropGet(PROP_ID_autoQualifyThreshold);
     ...
     * 自动转商机阈值: AUTO_QUALIFY_THRESHOLD
     */
    public final void setAutoQualifyThreshold(java.lang.Integer value){
        if(onPropSet(PROP_ID_autoQualifyThreshold,value)){
            this._autoQualifyThreshold = value;
            internalClearRefs(PROP_ID_autoQualifyThreshold);
     ...
     * 最低跟进分数: MIN_SCORE_FOR_FOLLOW_UP
     */
    public final java.lang.Integer getMinScoreForFollowUp(){
         onPropGet(PROP_ID_minScoreForFollowUp);
     ...
     * 最低跟进分数: MIN_SCORE_FOR_FOLLOW_UP
     */
    public final void setMinScoreForFollowUp(java.lang.Integer value){
        if(onPropSet(PROP_ID_minScoreForFollowUp,value)){
            this._minScoreForFollowUp = value;
            internalClearRefs(PROP_ID_minScoreForFollowUp);
