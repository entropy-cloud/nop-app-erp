...
public class _ErpCrmTeam extends DynamicOrmEntity{
    ...
    protected ErpCrmTeam newInstance(){
        ErpCrmTeam entity = new ErpCrmTeam();
    ...
    @Override
    public ErpCrmTeam cloneInstance() {
        ErpCrmTeam entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmTeam";
    }
