...
/**
 *  销售序列: erp_crm_sequence
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmSequence extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_templateType] = PROP_NAME_templateType;
          PROP_NAME_TO_ID.put(PROP_NAME_templateType, PROP_ID_templateType);
      
          PROP_ID_TO_NAME[PROP_ID_description] = PROP_NAME_description;
          PROP_NAME_TO_ID.put(PROP_NAME_description, PROP_ID_description);
      
          PROP_ID_TO_NAME[PROP_ID_expectedDuration] = PROP_NAME_expectedDuration;
          PROP_NAME_TO_ID.put(PROP_NAME_expectedDuration, PROP_ID_expectedDuration);
    ...
    /* 序列模板类型: TEMPLATE_TYPE */
    private java.lang.String _templateType;
    
    /* 描述: DESCRIPTION */
    private java.lang.String _description;
    
    /* 预期完成天数: EXPECTED_DURATION */
    private java.lang.Integer _expectedDuration;
    ...
    public _ErpCrmSequence(){
        // for debug
    }

    protected ErpCrmSequence newInstance(){
        ErpCrmSequence entity = new ErpCrmSequence();
    ...
    @Override
    public ErpCrmSequence cloneInstance() {
        ErpCrmSequence entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmSequence";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_templateType:
               return getTemplateType();
        
            case PROP_ID_description:
               return getDescription();
        
            case PROP_ID_expectedDuration:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_templateType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_templateType));
               }
               setTemplateType(typedValue);
               break;
            }
            ...
            case PROP_ID_expectedDuration:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_expectedDuration));
               }
               setExpectedDuration(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_templateType:{
               onInitProp(propId);
               this._templateType = (java.lang.String)value;
            ...
            case PROP_ID_expectedDuration:{
               onInitProp(propId);
               this._expectedDuration = (java.lang.Integer)value;
    ...
    public final java.lang.String getTemplateType(){
         onPropGet(PROP_ID_templateType);
     ...
     * 序列模板类型: TEMPLATE_TYPE
     */
    public final void setTemplateType(java.lang.String value){
        if(onPropSet(PROP_ID_templateType,value)){
            this._templateType = value;
            internalClearRefs(PROP_ID_templateType);
     ...
     * 预期完成天数: EXPECTED_DURATION
     */
    public final java.lang.Integer getExpectedDuration(){
         onPropGet(PROP_ID_expectedDuration);
     ...
     * 预期完成天数: EXPECTED_DURATION
     */
    public final void setExpectedDuration(java.lang.Integer value){
        if(onPropSet(PROP_ID_expectedDuration,value)){
            this._expectedDuration = value;
            internalClearRefs(PROP_ID_expectedDuration);
