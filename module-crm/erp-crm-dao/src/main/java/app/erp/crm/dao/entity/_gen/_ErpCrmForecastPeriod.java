...
/**
 *  预测期间: erp_crm_forecast_period
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmForecastPeriod extends DynamicOrmEntity{
    ...
    public _ErpCrmForecastPeriod(){
        // for debug
    }

    protected ErpCrmForecastPeriod newInstance(){
        ErpCrmForecastPeriod entity = new ErpCrmForecastPeriod();
    ...
    @Override
    public ErpCrmForecastPeriod cloneInstance() {
        ErpCrmForecastPeriod entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmForecastPeriod";
    }
