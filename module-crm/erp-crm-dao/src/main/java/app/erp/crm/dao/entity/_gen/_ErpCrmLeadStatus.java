...
/**
 *  线索状态: erp_crm_lead_status
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmLeadStatus extends DynamicOrmEntity{
    ...
    public _ErpCrmLeadStatus(){
        // for debug
    }

    protected ErpCrmLeadStatus newInstance(){
        ErpCrmLeadStatus entity = new ErpCrmLeadStatus();
    ...
    @Override
    public ErpCrmLeadStatus cloneInstance() {
        ErpCrmLeadStatus entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmLeadStatus";
    }
