...
/**
 *  活动记录: erp_crm_activity
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmActivity extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 关联线索/商机: LEAD_ID BIGINT */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_activityDate] = PROP_NAME_activityDate;
          PROP_NAME_TO_ID.put(PROP_NAME_activityDate, PROP_ID_activityDate);
    ...
    public _ErpCrmActivity(){
        // for debug
    }

    protected ErpCrmActivity newInstance(){
        ErpCrmActivity entity = new ErpCrmActivity();
    ...
    @Override
    public ErpCrmActivity cloneInstance() {
        ErpCrmActivity entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmActivity";
    }
