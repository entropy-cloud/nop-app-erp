...
/**
 *  营销活动: erp_crm_campaign
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmCampaign extends DynamicOrmEntity{
    ...
    /* 活动名称: CAMPAIGN_NAME VARCHAR */
    public static final String PROP_NAME_campaignName = "campaignName";
    public static final int PROP_ID_campaignName = 5;
    
    /* UTM Medium: MEDIUM VARCHAR */
    public static final String PROP_NAME_medium = "medium";
    public static final int PROP_ID_medium = 6;
    
    /* UTM Source: SOURCE VARCHAR */
    public static final String PROP_NAME_source = "source";
    public static final int PROP_ID_source = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_campaignName] = PROP_NAME_campaignName;
          PROP_NAME_TO_ID.put(PROP_NAME_campaignName, PROP_ID_campaignName);
      
          PROP_ID_TO_NAME[PROP_ID_medium] = PROP_NAME_medium;
          PROP_NAME_TO_ID.put(PROP_NAME_medium, PROP_ID_medium);
    ...
    /* 活动名称: CAMPAIGN_NAME */
    private java.lang.String _campaignName;
    
    /* UTM Medium: MEDIUM */
    private java.lang.String _medium;
    ...
    public _ErpCrmCampaign(){
        // for debug
    }

    protected ErpCrmCampaign newInstance(){
        ErpCrmCampaign entity = new ErpCrmCampaign();
    ...
    @Override
    public ErpCrmCampaign cloneInstance() {
        ErpCrmCampaign entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmCampaign";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_campaignName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_campaignName));
               }
            ...
            case PROP_ID_medium:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_medium));
               }
               setMedium(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_campaignName:{
               onInitProp(propId);
               this._campaignName = (java.lang.String)value;
            ...
            case PROP_ID_medium:{
               onInitProp(propId);
               this._medium = (java.lang.String)value;
    ...
    public final java.lang.String getCampaignName(){
         onPropGet(PROP_ID_campaignName);
     ...
     * 活动名称: CAMPAIGN_NAME
     */
    public final void setCampaignName(java.lang.String value){
        if(onPropSet(PROP_ID_campaignName,value)){
            this._campaignName = value;
            internalClearRefs(PROP_ID_campaignName);
     ...
     * UTM Medium: MEDIUM
     */
    public final void setMedium(java.lang.String value){
        if(onPropSet(PROP_ID_medium,value)){
            this._medium = value;
            internalClearRefs(PROP_ID_medium);
