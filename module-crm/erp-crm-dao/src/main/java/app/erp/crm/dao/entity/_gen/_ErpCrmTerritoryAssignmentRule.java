...
/**
 *  区域分配规则: erp_crm_territory_assignment_rule
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmTerritoryAssignmentRule extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_ruleName = 3;
    
    /* 优先级: PRIORITY INTEGER */
    public static final String PROP_NAME_priority = "priority";
    public static final int PROP_ID_priority = 4;
    
    /* 目标区域: TERRITORY_ID BIGINT */
    public static final String PROP_NAME_territoryId = "territoryId";
    public static final int PROP_ID_territoryId = 5;
    
    /* 条件类型: CONDITION_TYPE VARCHAR */
    public static final String PROP_NAME_conditionType = "conditionType";
    public static final int PROP_ID_conditionType = 6;
    
    /* 条件值(JSON): CONDITION_VALUE VARCHAR */
    public static final String PROP_NAME_conditionValue = "conditionValue";
    public static final int PROP_ID_conditionValue = 7;
    
    /* 分配方法: ASSIGNMENT_METHOD VARCHAR */
    public static final String PROP_NAME_assignmentMethod = "assignmentMethod";
    public static final int PROP_ID_assignmentMethod = 8;
    
    /* 目标团队: GROUP_ID BIGINT */
    public static final String PROP_NAME_groupId = "groupId";
    public static final int PROP_ID_groupId = 9;
    
    /* 是否默认规则: IS_DEFAULT BOOLEAN */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_conditionType] = PROP_NAME_conditionType;
          PROP_NAME_TO_ID.put(PROP_NAME_conditionType, PROP_ID_conditionType);
      
          PROP_ID_TO_NAME[PROP_ID_conditionValue] = PROP_NAME_conditionValue;
          PROP_NAME_TO_ID.put(PROP_NAME_conditionValue, PROP_ID_conditionValue);
      
          PROP_ID_TO_NAME[PROP_ID_assignmentMethod] = PROP_NAME_assignmentMethod;
          PROP_NAME_TO_ID.put(PROP_NAME_assignmentMethod, PROP_ID_assignmentMethod);
    ...
    /* 条件值(JSON): CONDITION_VALUE */
    private java.lang.String _conditionValue;
    
    /* 分配方法: ASSIGNMENT_METHOD */
    ...
    public _ErpCrmTerritoryAssignmentRule(){
        // for debug
    }

    protected ErpCrmTerritoryAssignmentRule newInstance(){
        ErpCrmTerritoryAssignmentRule entity = new ErpCrmTerritoryAssignmentRule();
    ...
    @Override
    public ErpCrmTerritoryAssignmentRule cloneInstance() {
        ErpCrmTerritoryAssignmentRule entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmTerritoryAssignmentRule";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_conditionType:
               return getConditionType();
        
            case PROP_ID_conditionValue:
               return getConditionValue();
        
            case PROP_ID_assignmentMethod:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_conditionType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_conditionType));
               }
               setConditionType(typedValue);
               break;
            }
            ...
            case PROP_ID_conditionValue:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_conditionValue));
               }
               setConditionValue(typedValue);
               break;
            }
            ...
            case PROP_ID_assignmentMethod:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_assignmentMethod));
               }
               setAssignmentMethod(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_conditionType:{
               onInitProp(propId);
               this._conditionType = (java.lang.String)value;
            ...
            case PROP_ID_conditionValue:{
               onInitProp(propId);
               this._conditionValue = (java.lang.String)value;
            ...
            case PROP_ID_assignmentMethod:{
               onInitProp(propId);
               this._assignmentMethod = (java.lang.String)value;
    ...
    public final java.lang.String getConditionType(){
         onPropGet(PROP_ID_conditionType);
     ...
     * 条件类型: CONDITION_TYPE
     */
    public final void setConditionType(java.lang.String value){
        if(onPropSet(PROP_ID_conditionType,value)){
            this._conditionType = value;
            internalClearRefs(PROP_ID_conditionType);
     ...
     * 条件值(JSON): CONDITION_VALUE
     */
    public final java.lang.String getConditionValue(){
         onPropGet(PROP_ID_conditionValue);
     ...
     * 条件值(JSON): CONDITION_VALUE
     */
    public final void setConditionValue(java.lang.String value){
        if(onPropSet(PROP_ID_conditionValue,value)){
            this._conditionValue = value;
            internalClearRefs(PROP_ID_conditionValue);
     ...
     * 分配方法: ASSIGNMENT_METHOD
     */
    public final java.lang.String getAssignmentMethod(){
         onPropGet(PROP_ID_assignmentMethod);
     ...
     * 分配方法: ASSIGNMENT_METHOD
     */
    public final void setAssignmentMethod(java.lang.String value){
        if(onPropSet(PROP_ID_assignmentMethod,value)){
            this._assignmentMethod = value;
            internalClearRefs(PROP_ID_assignmentMethod);
