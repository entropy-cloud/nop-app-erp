...
/**
 *  产品配置器: erp_crm_product_configurator
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmProductConfigurator extends DynamicOrmEntity{
    ...
    /* 适用产品品类: PRODUCT_TYPE VARCHAR */
    public static final String PROP_NAME_productType = "productType";
    public static final int PROP_ID_productType = 5;
    
    /* 配置器名称: CONFIG_NAME VARCHAR */
    public static final String PROP_NAME_configName = "configName";
    public static final int PROP_ID_configName = 6;
    
    /* 向导步骤布局(JSON): WIZARD_LAYOUT VARCHAR */
    public static final String PROP_NAME_wizardLayout = "wizardLayout";
    public static final int PROP_ID_wizardLayout = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_productType] = PROP_NAME_productType;
          PROP_NAME_TO_ID.put(PROP_NAME_productType, PROP_ID_productType);
      
          PROP_ID_TO_NAME[PROP_ID_configName] = PROP_NAME_configName;
          PROP_NAME_TO_ID.put(PROP_NAME_configName, PROP_ID_configName);
      
          PROP_ID_TO_NAME[PROP_ID_wizardLayout] = PROP_NAME_wizardLayout;
          PROP_NAME_TO_ID.put(PROP_NAME_wizardLayout, PROP_ID_wizardLayout);
    ...
    /* 向导步骤布局(JSON): WIZARD_LAYOUT */
    private java.lang.String _wizardLayout;
    ...
    public _ErpCrmProductConfigurator(){
        // for debug
    }

    protected ErpCrmProductConfigurator newInstance(){
        ErpCrmProductConfigurator entity = new ErpCrmProductConfigurator();
    ...
    @Override
    public ErpCrmProductConfigurator cloneInstance() {
        ErpCrmProductConfigurator entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmProductConfigurator";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_productType:
               return getProductType();
        
            case PROP_ID_configName:
               return getConfigName();
        
            case PROP_ID_wizardLayout:
               return getWizardLayout();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_productType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_productType));
               }
               setProductType(typedValue);
               break;
            }
            ...
            case PROP_ID_wizardLayout:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_wizardLayout));
               }
               setWizardLayout(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_productType:{
               onInitProp(propId);
               this._productType = (java.lang.String)value;
            ...
            case PROP_ID_wizardLayout:{
               onInitProp(propId);
               this._wizardLayout = (java.lang.String)value;
     ...
     * 适用产品品类: PRODUCT_TYPE
     */
    public final void setProductType(java.lang.String value){
        if(onPropSet(PROP_ID_productType,value)){
            this._productType = value;
            internalClearRefs(PROP_ID_productType);
     ...
     * 向导步骤布局(JSON): WIZARD_LAYOUT
     */
    public final java.lang.String getWizardLayout(){
         onPropGet(PROP_ID_wizardLayout);
     ...
     * 向导步骤布局(JSON): WIZARD_LAYOUT
     */
    public final void setWizardLayout(java.lang.String value){
        if(onPropSet(PROP_ID_wizardLayout,value)){
            this._wizardLayout = value;
            internalClearRefs(PROP_ID_wizardLayout);
