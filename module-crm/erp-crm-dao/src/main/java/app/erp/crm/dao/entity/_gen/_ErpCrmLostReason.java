...
/**
 *  丢单原因: erp_crm_lost_reason
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmLostReason extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_sequence = 4;
    ...
    public _ErpCrmLostReason(){
        // for debug
    }

    protected ErpCrmLostReason newInstance(){
        ErpCrmLostReason entity = new ErpCrmLostReason();
    ...
    @Override
    public ErpCrmLostReason cloneInstance() {
        ErpCrmLostReason entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmLostReason";
    }
