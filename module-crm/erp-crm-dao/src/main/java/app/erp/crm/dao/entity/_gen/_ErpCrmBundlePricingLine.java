...
/**
 *  捆绑包明细: erp_crm_bundle_pricing_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmBundlePricingLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 所属捆绑包: BUNDLE_ID BIGINT */
    public static final String PROP_NAME_bundleId = "bundleId";
    public static final int PROP_ID_bundleId = 2;
    ...
    public static final int PROP_ID_sequence = 7;
    ...
    /* relation:  */
    public static final String PROP_NAME_bundle = "bundle";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_bundleId] = PROP_NAME_bundleId;
          PROP_NAME_TO_ID.put(PROP_NAME_bundleId, PROP_ID_bundleId);
    ...
    public _ErpCrmBundlePricingLine(){
        // for debug
    }

    protected ErpCrmBundlePricingLine newInstance(){
        ErpCrmBundlePricingLine entity = new ErpCrmBundlePricingLine();
    ...
    @Override
    public ErpCrmBundlePricingLine cloneInstance() {
        ErpCrmBundlePricingLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmBundlePricingLine";
    }
     ...
     * 
     */
    public final app.erp.crm.dao.entity.ErpCrmBundlePricing getBundle(){
       return (app.erp.crm.dao.entity.ErpCrmBundlePricing)internalGetRefEntity(PROP_NAME_bundle);
    }

    public final void setBundle(app.erp.crm.dao.entity.ErpCrmBundlePricing refEntity){
           ...
           internalSetRefEntity(PROP_NAME_bundle, refEntity,()->{
           
                           this.setBundleId(refEntity.getId());
