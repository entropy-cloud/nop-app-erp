...
/**
 *  线索序列进度: erp_crm_lead_seq_progress
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmLeadSequenceProgress extends DynamicOrmEntity{
    ...
    /* 当前步骤序号: CURRENT_STEP_INDEX INTEGER */
    public static final String PROP_NAME_currentStepIndex = "currentStepIndex";
    public static final int PROP_ID_currentStepIndex = 5;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_currentStepIndex] = PROP_NAME_currentStepIndex;
          PROP_NAME_TO_ID.put(PROP_NAME_currentStepIndex, PROP_ID_currentStepIndex);
      
          PROP_ID_TO_NAME[PROP_ID_status] = PROP_NAME_status;
          PROP_NAME_TO_ID.put(PROP_NAME_status, PROP_ID_status);
      
          PROP_ID_TO_NAME[PROP_ID_startedAt] = PROP_NAME_startedAt;
          PROP_NAME_TO_ID.put(PROP_NAME_startedAt, PROP_ID_startedAt);
    ...
    /* 当前步骤序号: CURRENT_STEP_INDEX */
    private java.lang.Integer _currentStepIndex;
    ...
    public _ErpCrmLeadSequenceProgress(){
        // for debug
    }

    protected ErpCrmLeadSequenceProgress newInstance(){
        ErpCrmLeadSequenceProgress entity = new ErpCrmLeadSequenceProgress();
    ...
    @Override
    public ErpCrmLeadSequenceProgress cloneInstance() {
        ErpCrmLeadSequenceProgress entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmLeadSequenceProgress";
    }
            ...
            case PROP_ID_currentStepIndex:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_currentStepIndex));
               }
               setCurrentStepIndex(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_currentStepIndex:{
               onInitProp(propId);
               this._currentStepIndex = (java.lang.Integer)value;
     ...
     * 当前步骤序号: CURRENT_STEP_INDEX
     */
    public final java.lang.Integer getCurrentStepIndex(){
         onPropGet(PROP_ID_currentStepIndex);
     ...
     * 当前步骤序号: CURRENT_STEP_INDEX
     */
    public final void setCurrentStepIndex(java.lang.Integer value){
        if(onPropSet(PROP_ID_currentStepIndex,value)){
            this._currentStepIndex = value;
            internalClearRefs(PROP_ID_currentStepIndex);
