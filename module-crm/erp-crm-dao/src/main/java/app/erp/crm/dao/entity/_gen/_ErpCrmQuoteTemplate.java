...
/**
 *  报价模板: erp_crm_quote_template
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmQuoteTemplate extends DynamicOrmEntity{
    ...
    /* 模板内容: TEMPLATE_CONTENT VARCHAR */
    public static final String PROP_NAME_templateContent = "templateContent";
    public static final int PROP_ID_templateContent = 4;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_templateContent] = PROP_NAME_templateContent;
          PROP_NAME_TO_ID.put(PROP_NAME_templateContent, PROP_ID_templateContent);
    ...
    private java.lang.String _templateContent;
    ...
    public _ErpCrmQuoteTemplate(){
        // for debug
    }

    protected ErpCrmQuoteTemplate newInstance(){
        ErpCrmQuoteTemplate entity = new ErpCrmQuoteTemplate();
    ...
    @Override
    public ErpCrmQuoteTemplate cloneInstance() {
        ErpCrmQuoteTemplate entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmQuoteTemplate";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_templateContent:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_templateContent));
               }
               setTemplateContent(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_templateContent:{
               onInitProp(propId);
               this._templateContent = (java.lang.String)value;
    ...
    public final java.lang.String getTemplateContent(){
         onPropGet(PROP_ID_templateContent);
     ...
     * 模板内容: TEMPLATE_CONTENT
     */
    public final void setTemplateContent(java.lang.String value){
        if(onPropSet(PROP_ID_templateContent,value)){
            this._templateContent = value;
            internalClearRefs(PROP_ID_templateContent);
