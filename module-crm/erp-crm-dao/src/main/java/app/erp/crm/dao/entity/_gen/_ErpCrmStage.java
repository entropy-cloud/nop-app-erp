...
public class _ErpCrmStage extends DynamicOrmEntity{
    ...
    /* 阶段名称: STAGE_NAME VARCHAR */
    public static final String PROP_NAME_stageName = "stageName";
    public static final int PROP_ID_stageName = 4;
    
    /* 排序: SEQUENCE INTEGER */
    public static final String PROP_NAME_sequence = "sequence";
    public static final int PROP_ID_sequence = 5;
    
    /* 团队作用域: TEAM_ID BIGINT */
    public static final String PROP_NAME_teamId = "teamId";
    public static final int PROP_ID_teamId = 6;
    
    /* 默认成交概率%: DEFAULT_PROBABILITY INTEGER */
    public static final String PROP_NAME_defaultProbability = "defaultProbability";
    public static final int PROP_ID_defaultProbability = 7;
    
    /* 是否赢单阶段: IS_WON_STAGE BOOLEAN */
    public static final String PROP_NAME_isWonStage = "isWonStage";
    public static final int PROP_ID_isWonStage = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_defaultProbability] = PROP_NAME_defaultProbability;
          PROP_NAME_TO_ID.put(PROP_NAME_defaultProbability, PROP_ID_defaultProbability);
      
          PROP_ID_TO_NAME[PROP_ID_isWonStage] = PROP_NAME_isWonStage;
          PROP_NAME_TO_ID.put(PROP_NAME_isWonStage, PROP_ID_isWonStage);
    ...
    /* 是否赢单阶段: IS_WON_STAGE */
    private java.lang.Boolean _isWonStage;
    ...
    protected ErpCrmStage newInstance(){
        ErpCrmStage entity = new ErpCrmStage();
    ...
    @Override
    public ErpCrmStage cloneInstance() {
        ErpCrmStage entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmStage";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_defaultProbability:
               return getDefaultProbability();
        
            case PROP_ID_isWonStage:
               return getIsWonStage();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_defaultProbability:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_defaultProbability));
               }
               setDefaultProbability(typedValue);
               break;
            }
            ...
            case PROP_ID_isWonStage:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBoolean(value,
                       err-> newTypeConversionError(PROP_NAME_isWonStage));
               }
               setIsWonStage(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_defaultProbability:{
               onInitProp(propId);
               this._defaultProbability = (java.lang.Integer)value;
            ...
            case PROP_ID_isWonStage:{
               onInitProp(propId);
               this._isWonStage = (java.lang.Boolean)value;
     ...
     * 默认成交概率%: DEFAULT_PROBABILITY
     */
    public final java.lang.Integer getDefaultProbability(){
         onPropGet(PROP_ID_defaultProbability);
     ...
     * 默认成交概率%: DEFAULT_PROBABILITY
     */
    public final void setDefaultProbability(java.lang.Integer value){
        if(onPropSet(PROP_ID_defaultProbability,value)){
            this._defaultProbability = value;
            internalClearRefs(PROP_ID_defaultProbability);
     ...
     * 是否赢单阶段: IS_WON_STAGE
     */
    public final java.lang.Boolean getIsWonStage(){
         onPropGet(PROP_ID_isWonStage);
         return _isWonStage;
    }
     ...
     * 是否赢单阶段: IS_WON_STAGE
     */
    public final void setIsWonStage(java.lang.Boolean value){
        if(onPropSet(PROP_ID_isWonStage,value)){
            this._isWonStage = value;
            internalClearRefs(PROP_ID_isWonStage);
