...
/**
 *  序列分配规则: erp_crm_sequence_assignment
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmSequenceAssignment extends DynamicOrmEntity{
    ...
    /* 目标序列: SEQUENCE_ID BIGINT */
    public static final String PROP_NAME_sequenceId = "sequenceId";
    public static final int PROP_ID_sequenceId = 3;
    ...
    public _ErpCrmSequenceAssignment(){
        // for debug
    }

    protected ErpCrmSequenceAssignment newInstance(){
        ErpCrmSequenceAssignment entity = new ErpCrmSequenceAssignment();
    ...
    @Override
    public ErpCrmSequenceAssignment cloneInstance() {
        ErpCrmSequenceAssignment entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmSequenceAssignment";
    }
