...
/**
 *  团队成员: erp_crm_team_member
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpCrmTeamMember extends DynamicOrmEntity{
    ...
    public _ErpCrmTeamMember(){
        // for debug
    }

    protected ErpCrmTeamMember newInstance(){
        ErpCrmTeamMember entity = new ErpCrmTeamMember();
    ...
    @Override
    public ErpCrmTeamMember cloneInstance() {
        ErpCrmTeamMember entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmTeamMember";
    }
