...
public class _ErpCrmSource extends DynamicOrmEntity{
    ...
    public _ErpCrmSource(){
        // for debug
    }

    protected ErpCrmSource newInstance(){
        ErpCrmSource entity = new ErpCrmSource();
    ...
    @Override
    public ErpCrmSource cloneInstance() {
        ErpCrmSource entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.crm.dao.entity.ErpCrmSource";
    }
