...
| `erp-fin-ar-ap-auto-recon` | 定时自动核销（按比例/账龄/到期日） | 每日凌晨 | （待实现） | 大 | **batch-candidate** | DEFERRED | `erp-fin.ar-ap-auto-recon-cron` | `docs/design/finance/ar-ap-reconciliation.md:132`；`plans/2026-07-02-0300-3:153-157` |
