...
sales 域 4 P0 头行对（`ErpSalOrder/Delivery/Invoice/Return` + 对应 Line）头表单内嵌 AMIS input-table 子表编辑。范式与 purchase 域完全同构（见 `docs/design/purchase/ui-patterns.md §子表行内编辑`）。
