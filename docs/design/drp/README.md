...
- `docs/design/manufacturing/simulation-engine.md`（MRP/DRP 仿真引擎；plan 2026-07-22-1000-2）
- `docs/design/inventory/README.md`（库存移动/调拨）
- `docs/design/purchase/README.md`（采购订单）

## DRP 仿真场景对应物（2026-07-22，plan 2026-07-22-1000-2）

本域已落地 DRP 多场景仿真引擎（同构 MRP 侧，详见 [`manufacturing/simulation-engine.md`](../manufacturing/simulation-engine.md) §DRP 对应物）：
