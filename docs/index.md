...
| 执行 ai-check 修复批 / M2.x 族批（每 finding 强制流程、证伪、保护区路由、seed 联动、checker 门控、索引回填、族回填范式） | `docs/architecture/finding-remediation-method.md` | `docs/context/ai-autonomy-policy.md` §保护区域、`docs/architecture/seed-data.md` §快照重录义务、`docs/audits/compliance-baseline.md` §BASELINE |
