...
| 了解持久化模型或字典真相 | `docs/context/source-of-truth-and-precedence.md` | `model/app-erp.orm.xml`、`model/app-erp.api.xml`（代码生成后） |
...
| 从 ORM 模型生成多模块项目 | `model/app-erp.orm.xml` | `../nop-entropy/docs-for-ai/03-runbooks/`（代码生成 runbooks） |
