...
| M5.3 | 最终跨域回归、Delta 覆盖回归、owner doc 对齐及独立 closure audit | **ready**（**CG1-CG5 主会话全通过**；CG6 successor 触发 = 独立子代理通道恢复 或 人工裁决。证据落 `docs/audits/check/2026-08-28-2103-entity-state-machine-m5-3/audit.md`）| 本路线图所有 owner docs | M5.2 | `nop-testing` + `state-machine-business-review-prompt.md` |
