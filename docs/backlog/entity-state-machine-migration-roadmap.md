...
| M4.8 | ErpFinNotesReceivable.status 应收票据生命周期 Bean（plan-first） | ready | `finance/state-machine.md` | M1.3 | `nop-backend-dev` + `nop-testing` |
| M4.9 | ErpFinNotesPayable.status 应付票据生命周期 Bean（plan-first） | ready | `finance/state-machine.md` | M1.3 | `nop-backend-dev` + `nop-testing` |
