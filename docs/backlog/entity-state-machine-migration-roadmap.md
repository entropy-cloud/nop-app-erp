...
| M4.57 | ErpLogShipment.status 发运单生命周期 Bean（plan-first） | ready | `logistics/state-machine.md` §Shipment | M1.3 | `nop-backend-dev` + `nop-testing` |
