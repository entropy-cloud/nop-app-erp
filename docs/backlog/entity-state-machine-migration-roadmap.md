...
| M4.6 | ErpFinEmployeeAdvance.docStatus 预付款生命周期 Bean（plan-first） | ready | `finance/state-machine.md` | M1.3 | `nop-backend-dev` + `nop-testing` |
| M4.7 | ErpFinEmployeeAdvance.approveStatus 预付款审批轴 Bean（plan-first） | ready | `finance/state-machine.md` | M1.3 + M4.6 | `nop-backend-dev` + `nop-testing` |
