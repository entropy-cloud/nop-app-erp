...
| M3.15 | ErpAstMovement.docStatus 资产移动单据生命周期 Bean | ready | `assets/state-machine.md` §Movement | M1.3 | `nop-backend-dev` + `nop-testing` |
| M3.16 | ErpAstMovement.approveStatus 资产移动审批轴 Bean | ready | `assets/state-machine.md` §Movement | M1.3 + M3.15 | `nop-backend-dev` + `nop-testing` |
