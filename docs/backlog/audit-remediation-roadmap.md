...
| A2.5c | finance 状态机审查 — AR/AP 核销（S 级拆分 3/3） | ready | `docs/design/finance/` | 0.3 | `docs/skills/state-machine-business-review-prompt.md` |
