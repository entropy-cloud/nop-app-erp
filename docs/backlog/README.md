...
| -------- | ----------------------------- | -------------------------------------------------- | ------------------------------- | -------------- | ------------------- | ----------- | ---------------------------------------------- | ------------ |
| P0       | ERP business domain selection | `docs/requirements/product-scope.md`               | `docs/architecture/project-vision.md` | `none`         | `needs-requirement` | `ask-first` | `human must decide ERP domains in scope`       | 2026-06-22   |
| P1       | ORM model first entities      | `docs/requirements/product-scope.md`               | `docs/design/app-overview.md`   | `none`         | `blocked`           | `plan-first`| `blocked on ERP domain selection (P0)`         | 2026-06-22   |
| P2       | Multi-module codegen          | `docs/requirements/product-scope.md`               | `docs/architecture/system-baseline.md` | `none`   | `blocked`           | `plan-first`| `blocked on ORM entity design (P1)`            | 2026-06-22   |
