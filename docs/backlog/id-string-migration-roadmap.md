...
| Work Item | 描述 | 状态 | 依赖 |
| --- | --- | --- | --- |
| M4.1 | 全量构建恢复 + 全量测试 + E2E 套件修复 + compliance + baseline + 文档 | `todo` | 全部 M1-M3（含 M2.1 延后的 finance web/app 重生成补做核验） |
