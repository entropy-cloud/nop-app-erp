...
> 最后更新：2026-08-22（**M2.1 done**：finance 域迁移四 Phase 完成，plan `2026-08-22-0002-1`，见 M2/M3 表位次 6 行证据摘要；冻结序位次 7（assets）、8（cs）解锁——注意 finance web/app 重生成延后义务已显式移交 M2.7 后续做载体（M4.1 兜底）。执行期发现并登记五域先例 IoC delta 缺 `x:extends="super"` 潜伏缺陷（bug `docs/bugs/2026-08-22-ioc-delta-missing-extends-super.md`，fin 侧已修正）。此前：2026-08-21 M3.6 done（contract，plan `2026-08-21-2025-3`）、M3.8 done（b2b，plan `2026-08-21-2025-2`）、M3.9 done（aps，plan `2026-08-21-2025-1`）、M1.2 done（notify，plan `2026-08-21-1657-2`）、M0.2 done（前向耦合登记册，plan `2026-08-21-1657-1`）、M1.1 done（先导试点 D6 判据成立）、M0 裁决 Decision D 落盘（D3 闭包收窄/D4 登记册/D6 判据修订）、M1.1 rule-6 停止与恢复、M0.1 done 冻结序写回、M1.3 done）
...
| 7 | M2.4 | assets（ast-service compile 依赖 fin-service） | `todo` | M2.1 + M1.1 + M1.2 |
| 8 | M3.5 | cs | `todo` | M2.1 + M1.1 + M1.2 |
