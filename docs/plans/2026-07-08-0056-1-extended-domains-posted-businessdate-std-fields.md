...
> Last Reviewed: 2026-07-08（迭代 6 mission-driver forEach 复审：无 Blocker/Major，格式/完整性/范围/闭环证据四项合规，核心范式事实逐项实时核实通过；激活因 ORM ask-first 保护区域 ai-autonomy-policy.md §保护区域 model/*.orm.xml=ask first + §9 不得自我移除阻塞 + AGENTS.md 规则 12，维持 draft 延后至人工批准——mission-driver forEach 为通用聚合模板，非对本计划 ORM 变更的明确人工批准；人工放行路径：明确批准或下调 ORM 自主标签）
