...
| 业务动作套件 | `npx playwright test tests/e2e/business-actions/ --workers=1` | 12 代表域自定义 @BizMutation 经 GraphQL 全栈可达 + 状态机迁移 + 跨实体依赖门控 |
