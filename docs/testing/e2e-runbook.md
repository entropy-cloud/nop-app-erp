...
| 业务动作套件 | `npx playwright test tests/e2e/business-actions/ --workers=1` | 44 spec（17 域）自定义 @BizMutation 经 GraphQL 全栈可达 + 状态机迁移 + 跨实体依赖门控 |
...
## 业务动作浏览器层 E2E（`business-actions/`，17 域 44 spec）
...
├── business-actions/                 # 业务动作浏览器层 E2E（0814-2 + 2004-1 + 0335-1 + 0215-3 + 0508-1，自定义 @BizMutation 经 GraphQL，17 域 44 spec）
