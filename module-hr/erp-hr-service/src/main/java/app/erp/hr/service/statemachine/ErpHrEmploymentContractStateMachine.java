 ...
 *
 * <p>非法边直抛领域码 {@link ErpHrErrors#ERR_CONTRACT_ILLEGAL_STATUS_TRANSITION}（参数 {@code action}/
...
public class ErpHrEmploymentContractStateMachine {
    ...
    private static NopException illegal(String action, String currentStatus, String expectedStatus) {
        return new NopException(ErpHrErrors.ERR_CONTRACT_ILLEGAL_STATUS_TRANSITION)
