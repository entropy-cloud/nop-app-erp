//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpHrEmployeeAssessmentOutputBean {
        ...
        private String _assessmentType_label;

    
        public String getAssessmentType_label(){
            return _assessmentType_label;
        }

        public void setAssessmentType_label(String value){
            this._assessmentType_label = value;
        }
        ...
        private Map<String,Object> _assessor;

        public Map<String,Object> getAssessor(){
            return _assessor;
        }

        public void setAssessor(Map<String,Object> value){
            this._assessor = value;
        }


        private List<Map<String,Object>> _details;

        public List<Map<String,Object>> getDetails(){
            return _details;
        }

        public void setDetails(List<Map<String,Object>> value){
            this._details = value;
        }
