//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpHrSalarySimulationItemAdjustmentOutputBean {
        ...
        private String _adjustmentReason_label;

    
        public String getAdjustmentReason_label(){
            return _adjustmentReason_label;
        }

        public void setAdjustmentReason_label(String value){
            this._adjustmentReason_label = value;
        }
        ...
        private Map<String,Object> _simulation;

        public Map<String,Object> getSimulation(){
            return _simulation;
        }

        public void setSimulation(Map<String,Object> value){
