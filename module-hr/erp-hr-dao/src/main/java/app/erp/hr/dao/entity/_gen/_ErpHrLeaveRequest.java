...
/**
 *  休假申请: erp_hr_leave_request
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpHrLeaveRequest extends DynamicOrmEntity{
    ...
    /* 天数: DURATION_DAYS DECIMAL */
    public static final String PROP_NAME_durationDays = "durationDays";
    public static final int PROP_ID_durationDays = 7;
    ...
    public static final int PROP_ID_approverId = 10;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_durationDays] = PROP_NAME_durationDays;
          PROP_NAME_TO_ID.put(PROP_NAME_durationDays, PROP_ID_durationDays);
    ...
    public _ErpHrLeaveRequest(){
        // for debug
    }

    protected ErpHrLeaveRequest newInstance(){
        ErpHrLeaveRequest entity = new ErpHrLeaveRequest();
    ...
    @Override
    public ErpHrLeaveRequest cloneInstance() {
        ErpHrLeaveRequest entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.hr.dao.entity.ErpHrLeaveRequest";
    }
            ...
            case PROP_ID_durationDays:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_durationDays));
               }
               setDurationDays(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_durationDays:{
               onInitProp(propId);
               this._durationDays = (java.math.BigDecimal)value;
     ...
     * 天数: DURATION_DAYS
     */
    public final java.math.BigDecimal getDurationDays(){
         onPropGet(PROP_ID_durationDays);
     ...
     * 天数: DURATION_DAYS
     */
    public final void setDurationDays(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_durationDays,value)){
            this._durationDays = value;
            internalClearRefs(PROP_ID_durationDays);
     ...
     * 
     */
    public final app.erp.hr.dao.entity.ErpHrEmployee getApprover(){
       return (app.erp.hr.dao.entity.ErpHrEmployee)internalGetRefEntity(PROP_NAME_approver);
    }

    public final void setApprover(app.erp.hr.dao.entity.ErpHrEmployee refEntity){
           ...
           internalSetRefEntity(PROP_NAME_approver, refEntity,()->{
           
                           this.setApproverId(refEntity.getId());
