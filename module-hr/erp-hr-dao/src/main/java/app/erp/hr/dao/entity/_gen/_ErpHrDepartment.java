...
/**
 *  部门: erp_hr_department
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpHrDepartment extends DynamicOrmEntity{
    ...
    public _ErpHrDepartment(){
        // for debug
    }

    protected ErpHrDepartment newInstance(){
        ErpHrDepartment entity = new ErpHrDepartment();
    ...
    @Override
    public ErpHrDepartment cloneInstance() {
        ErpHrDepartment entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.hr.dao.entity.ErpHrDepartment";
    }
     ...
     * 
     */
    public final app.erp.hr.dao.entity.ErpHrDepartment getParent(){
       return (app.erp.hr.dao.entity.ErpHrDepartment)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(app.erp.hr.dao.entity.ErpHrDepartment refEntity){
