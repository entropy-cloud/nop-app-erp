...
/**
 *  工时表: erp_hr_timesheet
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpHrTimesheet extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_businessDate = 16;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_totalHours] = PROP_NAME_totalHours;
          PROP_NAME_TO_ID.put(PROP_NAME_totalHours, PROP_ID_totalHours);
    ...
    public _ErpHrTimesheet(){
        // for debug
    }

    protected ErpHrTimesheet newInstance(){
        ErpHrTimesheet entity = new ErpHrTimesheet();
    ...
    @Override
    public ErpHrTimesheet cloneInstance() {
        ErpHrTimesheet entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.hr.dao.entity.ErpHrTimesheet";
    }
            ...
            case PROP_ID_totalHours:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_totalHours));
               }
               setTotalHours(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_totalHours:{
               onInitProp(propId);
               this._totalHours = (java.math.BigDecimal)value;
     ...
     * 总工时: TOTAL_HOURS
     */
    public final java.math.BigDecimal getTotalHours(){
         onPropGet(PROP_ID_totalHours);
         return _totalHours;
    }
     ...
     * 总工时: TOTAL_HOURS
     */
    public final void setTotalHours(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_totalHours,value)){
            this._totalHours = value;
            internalClearRefs(PROP_ID_totalHours);
    ...
    private final OrmEntitySet<app.erp.hr.dao.entity.ErpHrTimesheetLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.hr.dao.entity.ErpHrTimesheetLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.hr.dao.entity.ErpHrTimesheetLine> getLines(){
       return _lines;
    }
