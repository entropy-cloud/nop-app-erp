...
/**
 *  休假额度: erp_hr_leave_balance
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpHrLeaveBalance extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_leaveType = 3;
    
    /* 福利年度: FISCAL_YEAR INTEGER */
    public static final String PROP_NAME_fiscalYear = "fiscalYear";
    public static final int PROP_ID_fiscalYear = 4;
    
    /* 应休额度(天): ENTITLED_DAYS DECIMAL */
    public static final String PROP_NAME_entitledDays = "entitledDays";
    public static final int PROP_ID_entitledDays = 5;
    
    /* 结转额度(天): CARRIED_FORWARD_DAYS DECIMAL */
    public static final String PROP_NAME_carriedForwardDays = "carriedForwardDays";
    public static final int PROP_ID_carriedForwardDays = 6;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_leaveType] = PROP_NAME_leaveType;
          PROP_NAME_TO_ID.put(PROP_NAME_leaveType, PROP_ID_leaveType);
      
          PROP_ID_TO_NAME[PROP_ID_fiscalYear] = PROP_NAME_fiscalYear;
          PROP_NAME_TO_ID.put(PROP_NAME_fiscalYear, PROP_ID_fiscalYear);
      
          PROP_ID_TO_NAME[PROP_ID_entitledDays] = PROP_NAME_entitledDays;
          PROP_NAME_TO_ID.put(PROP_NAME_entitledDays, PROP_ID_entitledDays);
      
          PROP_ID_TO_NAME[PROP_ID_carriedForwardDays] = PROP_NAME_carriedForwardDays;
          PROP_NAME_TO_ID.put(PROP_NAME_carriedForwardDays, PROP_ID_carriedForwardDays);
    ...
    /* 应休额度(天): ENTITLED_DAYS */
    private java.math.BigDecimal _entitledDays;
    
    /* 结转额度(天): CARRIED_FORWARD_DAYS */
    ...
    public _ErpHrLeaveBalance(){
        // for debug
    }

    protected ErpHrLeaveBalance newInstance(){
        ErpHrLeaveBalance entity = new ErpHrLeaveBalance();
    ...
    @Override
    public ErpHrLeaveBalance cloneInstance() {
        ErpHrLeaveBalance entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.hr.dao.entity.ErpHrLeaveBalance";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_entitledDays:
               return getEntitledDays();
        
            case PROP_ID_carriedForwardDays:
               return getCarriedForwardDays();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_entitledDays:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_entitledDays));
               }
               setEntitledDays(typedValue);
               break;
            }
            ...
            case PROP_ID_carriedForwardDays:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_carriedForwardDays));
               }
               setCarriedForwardDays(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_entitledDays:{
               onInitProp(propId);
               this._entitledDays = (java.math.BigDecimal)value;
            ...
            case PROP_ID_carriedForwardDays:{
               onInitProp(propId);
               this._carriedForwardDays = (java.math.BigDecimal)value;
     ...
     * 应休额度(天): ENTITLED_DAYS
     */
    public final java.math.BigDecimal getEntitledDays(){
         onPropGet(PROP_ID_entitledDays);
     ...
     * 应休额度(天): ENTITLED_DAYS
     */
    public final void setEntitledDays(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_entitledDays,value)){
            this._entitledDays = value;
            internalClearRefs(PROP_ID_entitledDays);
     ...
     * 结转额度(天): CARRIED_FORWARD_DAYS
     */
    public final java.math.BigDecimal getCarriedForwardDays(){
         onPropGet(PROP_ID_carriedForwardDays);
     ...
     * 结转额度(天): CARRIED_FORWARD_DAYS
     */
    public final void setCarriedForwardDays(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_carriedForwardDays,value)){
            this._carriedForwardDays = value;
            internalClearRefs(PROP_ID_carriedForwardDays);
