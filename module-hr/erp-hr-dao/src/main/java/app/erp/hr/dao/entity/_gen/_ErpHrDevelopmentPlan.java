...
/**
 *  发展计划: erp_hr_development_plan
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpHrDevelopmentPlan extends DynamicOrmEntity{
    ...
    /* relation:  */
    public static final String PROP_NAME_items = "items";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_targetDate] = PROP_NAME_targetDate;
          PROP_NAME_TO_ID.put(PROP_NAME_targetDate, PROP_ID_targetDate);
    ...
    protected ErpHrDevelopmentPlan newInstance(){
        ErpHrDevelopmentPlan entity = new ErpHrDevelopmentPlan();
    ...
    @Override
    public ErpHrDevelopmentPlan cloneInstance() {
        ErpHrDevelopmentPlan entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.hr.dao.entity.ErpHrDevelopmentPlan";
    }
            ...
            case PROP_ID_targetDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_targetDate));
               }
               setTargetDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_targetDate:{
               onInitProp(propId);
               this._targetDate = (java.time.LocalDate)value;
     ...
     * 目标完成日期: TARGET_DATE
     */
    public final void setTargetDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_targetDate,value)){
            this._targetDate = value;
            internalClearRefs(PROP_ID_targetDate);
    ...
    private final OrmEntitySet<app.erp.hr.dao.entity.ErpHrDevelopmentPlanItem> _items = new OrmEntitySet<>(this, PROP_NAME_items,
        null, null,app.erp.hr.dao.entity.ErpHrDevelopmentPlanItem.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.hr.dao.entity.ErpHrDevelopmentPlanItem> getItems(){
       return _items;
    }
