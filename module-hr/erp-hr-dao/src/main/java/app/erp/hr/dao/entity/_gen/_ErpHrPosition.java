...
public class _ErpHrPosition extends DynamicOrmEntity{
    ...
    /* 所属部门: DEPARTMENT_ID BIGINT */
    public static final String PROP_NAME_departmentId = "departmentId";
    public static final int PROP_ID_departmentId = 4;
    
    /* 职级: JOB_GRADE VARCHAR */
    public static final String PROP_NAME_jobGrade = "jobGrade";
    public static final int PROP_ID_jobGrade = 5;
    
    /* 职位类别: JOB_CATEGORY VARCHAR */
    public static final String PROP_NAME_jobCategory = "jobCategory";
    public static final int PROP_ID_jobCategory = 6;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_jobGrade] = PROP_NAME_jobGrade;
          PROP_NAME_TO_ID.put(PROP_NAME_jobGrade, PROP_ID_jobGrade);
    ...
    public _ErpHrPosition(){
        // for debug
    }

    protected ErpHrPosition newInstance(){
        ErpHrPosition entity = new ErpHrPosition();
    ...
    @Override
    public ErpHrPosition cloneInstance() {
        ErpHrPosition entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.hr.dao.entity.ErpHrPosition";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_jobGrade:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_jobGrade));
               }
               setJobGrade(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_jobGrade:{
               onInitProp(propId);
               this._jobGrade = (java.lang.String)value;
     ...
     * 职级: JOB_GRADE
     */
    public final java.lang.String getJobGrade(){
         onPropGet(PROP_ID_jobGrade);
         return _jobGrade;
    }
     ...
     * 职级: JOB_GRADE
     */
    public final void setJobGrade(java.lang.String value){
        if(onPropSet(PROP_ID_jobGrade,value)){
            this._jobGrade = value;
            internalClearRefs(PROP_ID_jobGrade);
