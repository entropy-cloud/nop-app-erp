...
public class _ErpHrShiftAssignment extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_businessDate = 20;
    ...
    /* relation:  */
    public static final String PROP_NAME_swapRequest = "swapRequest";
    
    /* relation:  */
    public static final String PROP_NAME_replacedByAssignment = "replacedByAssignment";
    ...
    /* 班次: SHIFT_ID */
    private java.lang.String _shiftId;
    ...
    private java.lang.String _leaveRequestId;
    
    /* 关联调换: SWAP_REQUEST_ID */
    private java.lang.String _swapRequestId;
    
    /* 被替换排班: REPLACED_BY_ASSIGNMENT_ID */
    private java.lang.String _replacedByAssignmentId;
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_shiftId:{
               onInitProp(propId);
               this._shiftId = (java.lang.String)value;
            ...
            case PROP_ID_leaveRequestId:{
               onInitProp(propId);
               this._leaveRequestId = (java.lang.String)value;
            ...
            case PROP_ID_swapRequestId:{
               onInitProp(propId);
               this._swapRequestId = (java.lang.String)value;
            ...
            case PROP_ID_replacedByAssignmentId:{
               onInitProp(propId);
               this._replacedByAssignmentId = (java.lang.String)value;
     ...
     * 班次: SHIFT_ID
     */
    public final void setShiftId(java.lang.String value){
     ...
     * 关联休假: LEAVE_REQUEST_ID
     */
    public final java.lang.String getLeaveRequestId(){
     ...
     * 关联休假: LEAVE_REQUEST_ID
     */
    public final void setLeaveRequestId(java.lang.String value){
     ...
     * 关联调换: SWAP_REQUEST_ID
     */
    public final java.lang.String getSwapRequestId(){
     ...
     * 关联调换: SWAP_REQUEST_ID
     */
    public final void setSwapRequestId(java.lang.String value){
     ...
     * 被替换排班: REPLACED_BY_ASSIGNMENT_ID
     */
    public final java.lang.String getReplacedByAssignmentId(){
     ...
     * 被替换排班: REPLACED_BY_ASSIGNMENT_ID
     */
    public final void setReplacedByAssignmentId(java.lang.String value){
     ...
     * 
     */
    public final app.erp.hr.dao.entity.ErpHrShiftSwapRequest getSwapRequest(){
       return (app.erp.hr.dao.entity.ErpHrShiftSwapRequest)internalGetRefEntity(PROP_NAME_swapRequest);
    }

    public final void setSwapRequest(app.erp.hr.dao.entity.ErpHrShiftSwapRequest refEntity){
   
           if(refEntity == null){
           
                   this.setSwapRequestId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_swapRequest, refEntity,()->{
           
                           this.setSwapRequestId(refEntity.getId());
     ...
     * 
     */
    public final app.erp.hr.dao.entity.ErpHrShiftAssignment getReplacedByAssignment(){
       return (app.erp.hr.dao.entity.ErpHrShiftAssignment)internalGetRefEntity(PROP_NAME_replacedByAssignment);
    }

    public final void setReplacedByAssignment(app.erp.hr.dao.entity.ErpHrShiftAssignment refEntity){
   
           if(refEntity == null){
           
                   this.setReplacedByAssignmentId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_replacedByAssignment, refEntity,()->{
           
                           this.setReplacedByAssignmentId(refEntity.getId());
