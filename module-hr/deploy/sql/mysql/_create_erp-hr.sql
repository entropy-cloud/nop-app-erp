...
CREATE TABLE erp_prj_task(
  ...
  CODE VARCHAR(50) NULL    COMMENT 'null',
  NAME VARCHAR(200) NULL    COMMENT 'null',
  TITLE VARCHAR(200) NULL    COMMENT 'null',
...
CREATE TABLE erp_hr_salary_item(
  ...
  CODE VARCHAR(50) NOT NULL    COMMENT '编码',
  NAME VARCHAR(200) NOT NULL    COMMENT '名称',
  ITEM_CATEGORY VARCHAR(20) NOT NULL    COMMENT '类别',
  ITEM_GROUP VARCHAR(20) NOT NULL    COMMENT '分组',
  CALC_METHOD VARCHAR(20) NOT NULL    COMMENT '计算方式',
  FORMULA VARCHAR(1000) NULL    COMMENT '计算公式',
  IS_TAXABLE BOOLEAN default 0  NULL    COMMENT '是否应税',
  IS_SOCIAL_INSURANCE_BASE BOOLEAN default 0  NULL    COMMENT '计入社保基数',
  IS_MANDATORY BOOLEAN default 0  NULL    COMMENT '是否必含',
  SORT_ORDER INTEGER default 0  NULL    COMMENT '排序号',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_hr_social_insurance_config(
  ID BIGINT NOT NULL    COMMENT 'ID',
  CITY_CODE VARCHAR(20) NOT NULL    COMMENT '城市',
  INSURANCE_TYPE VARCHAR(20) NOT NULL    COMMENT '险种',
  COMPANY_RATE DECIMAL(8,6) default 0  NULL    COMMENT '公司比例',
  EMPLOYEE_RATE DECIMAL(8,6) default 0  NULL    COMMENT '个人比例',
  BASE_LOWER_LIMIT DECIMAL(18,2) NULL    COMMENT '基数下限',
  BASE_UPPER_LIMIT DECIMAL(18,2) NULL    COMMENT '基数上限',
...
CREATE TABLE erp_hr_tax_config(
  ...
  TAX_THRESHOLD DECIMAL(18,2) NOT NULL    COMMENT '起征点(月)',
  TAX_BRACKETS VARCHAR(4000) NULL    COMMENT '税率表',
  SPECIAL_DEDUCTION_ITEMS VARCHAR(2000) NULL    COMMENT '专项附加扣除项配置',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_hr_payroll_bank_file(
  ...
  RECORD_COUNT INTEGER default 0  NOT NULL    COMMENT '记录数',
  FILE_FORMAT VARCHAR(20) NOT NULL    COMMENT '文件格式',
  FILE_CONTENT LONGTEXT NULL    COMMENT '文件内容',
  STATUS VARCHAR(20) default 'GENERATED'  NOT NULL    COMMENT '状态',
  BANK_ID BIGINT NULL    COMMENT '开户银行',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_hr_survey(
  ...
  SURVEY_TYPE VARCHAR(20) NOT NULL    COMMENT '调研类型',
...
CREATE TABLE erp_hr_employee(
  ...
  EMPLOYMENT_STATUS VARCHAR(20) NOT NULL    COMMENT '雇佣状态',
...
CREATE TABLE erp_hr_survey_question(
  ...
  DRIVER_CATEGORY VARCHAR(20) NULL    COMMENT '驱动因子分类',
...
CREATE TABLE erp_hr_survey_result(
  ...
  LAST_CALCULATED_AT DATETIME(3) NULL    COMMENT '最后计算时间',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE erp_hr_employment_contract(
  ...
  ANNUAL_SALARY DECIMAL(18,2) NULL    COMMENT '年薪(税前)',
  MONTHLY_SALARY DECIMAL(18,2) NULL    COMMENT '月薪(税前)',
  SALARY_CURRENCY_ID BIGINT NULL    COMMENT '薪资币种',
  SALARY_PAY_METHOD VARCHAR(50) NULL    COMMENT '发薪方式',
  SOCIAL_INSURANCE_BASE DECIMAL(18,2) NULL    COMMENT '社保基数',
  HOUSING_FUND_BASE DECIMAL(18,2) NULL    COMMENT '公积金基数',
...
CREATE TABLE erp_hr_salary(
  ...
  BASIC_SALARY DECIMAL(18,2) NULL    COMMENT '基本工资',
  POSITION_ALLOWANCE DECIMAL(18,2) NULL    COMMENT '岗位津贴',
  PERFORMANCE_BONUS DECIMAL(18,2) NULL    COMMENT '绩效奖金',
  OVERTIME_PAY DECIMAL(18,2) NULL    COMMENT '加班费',
  MEAL_ALLOWANCE DECIMAL(18,2) NULL    COMMENT '餐补',
  TRANSPORT_ALLOWANCE DECIMAL(18,2) NULL    COMMENT '交通补贴',
  OTHER_ALLOWANCE DECIMAL(18,2) NULL    COMMENT '其他补贴',
  GROSS_SALARY DECIMAL(18,2) NULL    COMMENT '应发合计',
  SOCIAL_INSURANCE DECIMAL(18,2) NULL    COMMENT '社保个人部分',
  HOUSING_FUND DECIMAL(18,2) NULL    COMMENT '公积金个人部分',
  TAX_AMOUNT DECIMAL(18,2) NULL    COMMENT '个税',
  OTHER_DEDUCTIONS DECIMAL(18,2) NULL    COMMENT '其他扣款',
  ...
  TOTAL_OVERTIME_HOURS DECIMAL(10,2) NULL    COMMENT '月总加班小时',
  UNPAID_LEAVE_DAYS DECIMAL(10,2) NULL    COMMENT '无薪假天数',
  CUMULATIVE_DATA VARCHAR(2000) NULL    COMMENT '累计个税数据',
  REVIEW_NOTE VARCHAR(1000) NULL    COMMENT '审核备注',
  PAYMENT_BATCH_NO VARCHAR(100) NULL    COMMENT '发放批次号',
  BANK_FILE_ID BIGINT NULL    COMMENT '银行文件',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_hr_recruitment(
  ...
  OFFER_SALARY DECIMAL(18,2) NULL    COMMENT 'Offer薪资',
...
CREATE TABLE erp_hr_social_insurance_base(
  ID BIGINT NOT NULL    COMMENT 'ID',
  EMPLOYEE_ID BIGINT NOT NULL    COMMENT '员工',
  CITY_CODE VARCHAR(20) NOT NULL    COMMENT '参保城市',
  SOCIAL_INSURANCE_BASE DECIMAL(18,2) NOT NULL    COMMENT '社保基数',
  HOUSING_FUND_BASE DECIMAL(18,2) NULL    COMMENT '公积金基数',
...
CREATE TABLE erp_hr_tax_special_deduction(
  ...
  MONTHLY_AMOUNT DECIMAL(18,2) NOT NULL    COMMENT '每月扣除金额',
  VERIFIED BOOLEAN default 0  NULL    COMMENT '是否已核验',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
...
CREATE TABLE erp_hr_gap_analysis(
  ...
  GAP_SEVERITY VARCHAR(20) NULL    COMMENT '差距严重程度',
  ASSESSMENT_DATE DATE NULL    COMMENT '评估日期',
  ANALYSIS_DATE DATE NULL    COMMENT '分析日期',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE erp_hr_attendance(
  ...
  CLOCK_IN DATETIME(3) NULL    COMMENT '签到时间',
  CLOCK_OUT DATETIME(3) NULL    COMMENT '签退时间',
...
CREATE TABLE erp_hr_shift_assignment(
  ...
  ACTUAL_START_TIME DATETIME(3) NULL    COMMENT '实际签到时间',
  ACTUAL_END_TIME DATETIME(3) NULL    COMMENT '实际签退时间',
...
CREATE TABLE erp_hr_salary_simulation(
  ...
  CONVERTED_AT DATETIME(3) NULL    COMMENT '转正式时间',
...
CREATE TABLE erp_hr_salary_simulation_item_adj(
  ...
  ADJUSTED_AT DATETIME(3) NULL    COMMENT '调整时间',
  ORG_ID BIGINT NULL    COMMENT '业务组织',
  REMARK VARCHAR(1000) NULL    COMMENT '备注',
  DEL_VERSION BIGINT default 0  NOT NULL    COMMENT '逻辑删除版本',
  VERSION INTEGER default 0  NOT NULL    COMMENT '数据版本',
  ...
  constraint PK_erp_hr_salary_simulation_item_adj primary key (ID)
   ...
   ALTER TABLE erp_hr_salary_item COMMENT '薪酬项目';
                
   ALTER TABLE erp_hr_social_insurance_config COMMENT '社保配置';
                
   ALTER TABLE erp_hr_tax_config COMMENT '个税配置';
                
   ALTER TABLE erp_hr_payroll_bank_file COMMENT '银行代发文件';
   ...
   ALTER TABLE erp_hr_social_insurance_base COMMENT '员工社保基数';
                
   ALTER TABLE erp_hr_tax_special_deduction COMMENT '员工专项附加扣除';
