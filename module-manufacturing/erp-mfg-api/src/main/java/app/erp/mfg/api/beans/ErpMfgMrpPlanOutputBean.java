//__XGEN_FORCE_OVERRIDE__
    ...
    public class ErpMfgMrpPlanOutputBean {
        ...
        private List<Map<String,Object>> _demands;

        public List<Map<String,Object>> getDemands(){
            return _demands;
        }

        public void setDemands(List<Map<String,Object>> value){
            this._demands = value;
        }
