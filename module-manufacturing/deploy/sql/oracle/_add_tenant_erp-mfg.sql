...
alter table erp_mfg_workcenter_calendar add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_mfg_workcenter_capacity add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_mfg_mrp_scenario add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_mfg_mrp_scenario_version add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_mfg_mrp_scenario_param add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_mfg_crp_load add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_mfg_workcenter_calendar drop constraint PK_erp_mfg_workcenter_calendar;
alter table erp_mfg_workcenter_calendar add constraint PK_erp_mfg_workcenter_calendar primary key (NOP_TENANT_ID, ID);

alter table erp_mfg_workcenter_capacity drop constraint PK_erp_mfg_workcenter_capacity;
alter table erp_mfg_workcenter_capacity add constraint PK_erp_mfg_workcenter_capacity primary key (NOP_TENANT_ID, ID);
