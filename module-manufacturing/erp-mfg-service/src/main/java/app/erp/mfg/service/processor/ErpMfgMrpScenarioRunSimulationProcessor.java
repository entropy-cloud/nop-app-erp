...
/**
 * ErpMfgMrpScenario runSimulation per-mutation Processor（R6.2，{@code processor-extension-pattern.md} 每 mutation 一 Processor）。
 * 自包含 MRP 仿真运行编排（config-gate + 委托 {@link SimulationMrpEngine}）；从 ErpMfgMrpScenarioBizModel 内联 @BizMutation 提取。
 */
public class ErpMfgMrpScenarioRunSimulationProcessor {
