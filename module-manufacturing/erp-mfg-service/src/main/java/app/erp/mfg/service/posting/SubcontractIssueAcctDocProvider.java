...
/**
 * 委外发料过账 Provider（manufacturing 域，非默认 Provider，plan 2026-07-13-0455-1 §Phase 3）。
 *
 * <p>支持业务类型：{@link ErpFinBusinessType#SUBCONTRACT_ISSUE}。
 * 委外发料凭证：Dr: 委外物资 1408（config {@code erp-mfg.subcontract-subject-code}）/ Cr: 原材料存货 1401。
 * 镜像 {@link ManufacturingIssueAcctDocProvider} 范式（Dr 汇总委外物资 / Cr 按物料分列原材料）。
 */
public class SubcontractIssueAcctDocProvider implements IErpFinAcctDocProvider {
