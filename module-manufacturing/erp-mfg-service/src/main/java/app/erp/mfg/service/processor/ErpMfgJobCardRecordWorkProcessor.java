...
public class ErpMfgJobCardRecordWorkProcessor {
    ...
    public ErpMfgJobCard recordWork(JobCardWorkRecord record, IServiceContext context) {
        ...
        validateStatusForRecordWork(jc);
    ...
    protected void validateStatusForRecordWork(ErpMfgJobCard jc) {
        ...
        if (status == null || (!Objects.equals(status, ErpMfgConstants.JOB_CARD_STATUS_WORK_IN_PROGRESS)
            ...
            throw facade.illegalTransition(jc, status, "WORK_IN_PROGRESS 或 SUBMITTED");
        }
    }
