...
/**
 *  工单BOM快照工艺: erp_mfg_work_order_bom_operation_snapshot
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgWorkOrderBomOperationSnapshot extends DynamicOrmEntity{
    ...
    public _ErpMfgWorkOrderBomOperationSnapshot(){
        // for debug
    }

    protected ErpMfgWorkOrderBomOperationSnapshot newInstance(){
        ErpMfgWorkOrderBomOperationSnapshot entity = new ErpMfgWorkOrderBomOperationSnapshot();
    ...
    @Override
    public ErpMfgWorkOrderBomOperationSnapshot cloneInstance() {
        ErpMfgWorkOrderBomOperationSnapshot entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgWorkOrderBomOperationSnapshot";
    }
