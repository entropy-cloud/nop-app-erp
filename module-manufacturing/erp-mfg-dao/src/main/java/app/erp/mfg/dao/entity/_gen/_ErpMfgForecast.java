...
/**
 *  需求预测: erp_mfg_forecast
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgForecast extends DynamicOrmEntity{
    ...
    public _ErpMfgForecast(){
        // for debug
    }

    protected ErpMfgForecast newInstance(){
        ErpMfgForecast entity = new ErpMfgForecast();
    ...
    @Override
    public ErpMfgForecast cloneInstance() {
        ErpMfgForecast entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgForecast";
    }
    ...
    private final OrmEntitySet<app.erp.mfg.dao.entity.ErpMfgForecastLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.mfg.dao.entity.ErpMfgForecastLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.mfg.dao.entity.ErpMfgForecastLine> getLines(){
       return _lines;
    }
