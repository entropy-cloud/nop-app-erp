...
/**
 *  MRP仿真版本: erp_mfg_mrp_scenario_version
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgMrpScenarioVersion extends DynamicOrmEntity{
    ...
    /* 计算结果MRP计划: COMPUTED_MRP_PLAN_ID BIGINT */
    public static final String PROP_NAME_computedMrpPlanId = "computedMrpPlanId";
    public static final int PROP_ID_computedMrpPlanId = 4;
    ...
    /* relation:  */
    public static final String PROP_NAME_computedMrpPlan = "computedMrpPlan";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_computedMrpPlanId] = PROP_NAME_computedMrpPlanId;
          PROP_NAME_TO_ID.put(PROP_NAME_computedMrpPlanId, PROP_ID_computedMrpPlanId);
    ...
    /* 计算结果MRP计划: COMPUTED_MRP_PLAN_ID */
    private java.lang.String _computedMrpPlanId;
    ...
    public _ErpMfgMrpScenarioVersion(){
        // for debug
    }

    protected ErpMfgMrpScenarioVersion newInstance(){
        ErpMfgMrpScenarioVersion entity = new ErpMfgMrpScenarioVersion();
    ...
    @Override
    public ErpMfgMrpScenarioVersion cloneInstance() {
        ErpMfgMrpScenarioVersion entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgMrpScenarioVersion";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_computedMrpPlanId:
               return getComputedMrpPlanId();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_computedMrpPlanId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_computedMrpPlanId));
               }
               setComputedMrpPlanId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_computedMrpPlanId:{
               onInitProp(propId);
               this._computedMrpPlanId = (java.lang.String)value;
     ...
     * 计算结果MRP计划: COMPUTED_MRP_PLAN_ID
     */
    public final java.lang.String getComputedMrpPlanId(){
         onPropGet(PROP_ID_computedMrpPlanId);
     ...
     * 计算结果MRP计划: COMPUTED_MRP_PLAN_ID
     */
    public final void setComputedMrpPlanId(java.lang.String value){
        if(onPropSet(PROP_ID_computedMrpPlanId,value)){
            this._computedMrpPlanId = value;
            internalClearRefs(PROP_ID_computedMrpPlanId);
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgMrpScenario getScenario(){
       return (app.erp.mfg.dao.entity.ErpMfgMrpScenario)internalGetRefEntity(PROP_NAME_scenario);
    }

    public final void setScenario(app.erp.mfg.dao.entity.ErpMfgMrpScenario refEntity){
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgMrpPlan getComputedMrpPlan(){
       return (app.erp.mfg.dao.entity.ErpMfgMrpPlan)internalGetRefEntity(PROP_NAME_computedMrpPlan);
    }

    public final void setComputedMrpPlan(app.erp.mfg.dao.entity.ErpMfgMrpPlan refEntity){
   
           if(refEntity == null){
           
                   this.setComputedMrpPlanId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_computedMrpPlan, refEntity,()->{
           
                           this.setComputedMrpPlanId(refEntity.getId());
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgMrpPlan getPromotedPlan(){
       return (app.erp.mfg.dao.entity.ErpMfgMrpPlan)internalGetRefEntity(PROP_NAME_promotedPlan);
    }

    public final void setPromotedPlan(app.erp.mfg.dao.entity.ErpMfgMrpPlan refEntity){
