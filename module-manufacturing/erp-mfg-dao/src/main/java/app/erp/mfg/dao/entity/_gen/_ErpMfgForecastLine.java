...
/**
 *  需求预测行: erp_mfg_forecast_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgForecastLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 需求预测ID: FORECAST_ID BIGINT */
    ...
    /* 仓库（可选，空=产品级 MRP 消费，填=仓级 DRP 消费）: WAREHOUSE_ID BIGINT */
    ...
    /* 桶起始日期: PERIOD_START DATE */
    public static final String PROP_NAME_periodStart = "periodStart";
    public static final int PROP_ID_periodStart = 7;
    
    /* 桶结束日期: PERIOD_END DATE */
    public static final String PROP_NAME_periodEnd = "periodEnd";
    public static final int PROP_ID_periodEnd = 8;
    
    /* 预测数量: FORECAST_QTY DECIMAL */
    public static final String PROP_NAME_forecastQty = "forecastQty";
    public static final int PROP_ID_forecastQty = 9;
    
    /* 来源标记: SOURCED_FLAG VARCHAR */
    public static final String PROP_NAME_sourcedFlag = "sourcedFlag";
    public static final int PROP_ID_sourcedFlag = 10;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_forecastQty] = PROP_NAME_forecastQty;
          PROP_NAME_TO_ID.put(PROP_NAME_forecastQty, PROP_ID_forecastQty);
      
          PROP_ID_TO_NAME[PROP_ID_sourcedFlag] = PROP_NAME_sourcedFlag;
          PROP_NAME_TO_ID.put(PROP_NAME_sourcedFlag, PROP_ID_sourcedFlag);
    ...
    /* 需求预测ID: FORECAST_ID */
    private java.lang.String _forecastId;
    ...
    /* 仓库（可选，空=产品级 MRP 消费，填=仓级 DRP 消费）: WAREHOUSE_ID */
    ...
    /* 来源标记: SOURCED_FLAG */
    private java.lang.String _sourcedFlag;
    ...
    public _ErpMfgForecastLine(){
        // for debug
    }

    protected ErpMfgForecastLine newInstance(){
        ErpMfgForecastLine entity = new ErpMfgForecastLine();
    ...
    @Override
    public ErpMfgForecastLine cloneInstance() {
        ErpMfgForecastLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgForecastLine";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_forecastQty:
               return getForecastQty();
        
            case PROP_ID_sourcedFlag:
               return getSourcedFlag();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_forecastQty:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_forecastQty));
               }
               setForecastQty(typedValue);
               break;
            }
            ...
            case PROP_ID_sourcedFlag:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_sourcedFlag));
               }
               setSourcedFlag(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_forecastId:{
               onInitProp(propId);
               this._forecastId = (java.lang.String)value;
            ...
            case PROP_ID_forecastQty:{
               onInitProp(propId);
               this._forecastQty = (java.math.BigDecimal)value;
            ...
            case PROP_ID_sourcedFlag:{
               onInitProp(propId);
               this._sourcedFlag = (java.lang.String)value;
     ...
     * 需求预测ID: FORECAST_ID
     */
    public final java.lang.String getForecastId(){
     ...
     * 需求预测ID: FORECAST_ID
     */
    public final void setForecastId(java.lang.String value){
     ...
     * 预测数量: FORECAST_QTY
     */
    public final java.math.BigDecimal getForecastQty(){
         onPropGet(PROP_ID_forecastQty);
         return _forecastQty;
    }
     ...
     * 预测数量: FORECAST_QTY
     */
    public final void setForecastQty(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_forecastQty,value)){
            this._forecastQty = value;
            internalClearRefs(PROP_ID_forecastQty);
     ...
     * 来源标记: SOURCED_FLAG
     */
    public final java.lang.String getSourcedFlag(){
         onPropGet(PROP_ID_sourcedFlag);
         return _sourcedFlag;
    }
     ...
     * 来源标记: SOURCED_FLAG
     */
    public final void setSourcedFlag(java.lang.String value){
        if(onPropSet(PROP_ID_sourcedFlag,value)){
            this._sourcedFlag = value;
            internalClearRefs(PROP_ID_sourcedFlag);
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgForecast getForecast(){
       return (app.erp.mfg.dao.entity.ErpMfgForecast)internalGetRefEntity(PROP_NAME_forecast);
    }

    public final void setForecast(app.erp.mfg.dao.entity.ErpMfgForecast refEntity){
