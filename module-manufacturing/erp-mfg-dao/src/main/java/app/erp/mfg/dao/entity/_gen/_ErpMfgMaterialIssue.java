...
/**
 *  领料单: erp_mfg_material_issue
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgMaterialIssue extends DynamicOrmEntity{
    ...
    public _ErpMfgMaterialIssue(){
        // for debug
    }

    protected ErpMfgMaterialIssue newInstance(){
        ErpMfgMaterialIssue entity = new ErpMfgMaterialIssue();
    ...
    @Override
    public ErpMfgMaterialIssue cloneInstance() {
        ErpMfgMaterialIssue entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgMaterialIssue";
    }
    ...
    private final OrmEntitySet<app.erp.mfg.dao.entity.ErpMfgMaterialIssueLine> _lines = new OrmEntitySet<>(this, PROP_NAME_lines,
        null, null,app.erp.mfg.dao.entity.ErpMfgMaterialIssueLine.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.mfg.dao.entity.ErpMfgMaterialIssueLine> getLines(){
       return _lines;
    }
