...
/**
 *  工艺路线: erp_mfg_routing
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgRouting extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_isActive = 4;
    ...
    public _ErpMfgRouting(){
        // for debug
    }

    protected ErpMfgRouting newInstance(){
        ErpMfgRouting entity = new ErpMfgRouting();
    ...
    @Override
    public ErpMfgRouting cloneInstance() {
        ErpMfgRouting entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgRouting";
    }
    ...
    private final OrmEntitySet<app.erp.mfg.dao.entity.ErpMfgRoutingOperation> _operations = new OrmEntitySet<>(this, PROP_NAME_operations,
        null, null,app.erp.mfg.dao.entity.ErpMfgRoutingOperation.class);

    /**
     * 。 refPropName: , keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<app.erp.mfg.dao.entity.ErpMfgRoutingOperation> getOperations(){
       return _operations;
    }
