...
/**
 *  工作中心产能: erp_mfg_workcenter_capacity
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgWorkcenterCapacity extends DynamicOrmEntity{
    ...
    /* 关联物料: MATERIAL_ID BIGINT */
    public static final String PROP_NAME_materialId = "materialId";
    public static final int PROP_ID_materialId = 4;
    
    /* 每小时产能: CAPACITY_PER_HOUR DECIMAL */
    public static final String PROP_NAME_capacityPerHour = "capacityPerHour";
    public static final int PROP_ID_capacityPerHour = 5;
    
    /* 换模时间(分钟): SETUP_TIME DECIMAL */
    public static final String PROP_NAME_setupTime = "setupTime";
    public static final int PROP_ID_setupTime = 6;
    
    /* 清理时间(分钟): CLEANUP_TIME DECIMAL */
    public static final String PROP_NAME_cleanupTime = "cleanupTime";
    public static final int PROP_ID_cleanupTime = 7;
    
    /* 效率系数: EFFICIENCY_FACTOR DECIMAL */
    public static final String PROP_NAME_efficiencyFactor = "efficiencyFactor";
    public static final int PROP_ID_efficiencyFactor = 8;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_capacityPerHour] = PROP_NAME_capacityPerHour;
          PROP_NAME_TO_ID.put(PROP_NAME_capacityPerHour, PROP_ID_capacityPerHour);
      
          PROP_ID_TO_NAME[PROP_ID_setupTime] = PROP_NAME_setupTime;
          PROP_NAME_TO_ID.put(PROP_NAME_setupTime, PROP_ID_setupTime);
      
          PROP_ID_TO_NAME[PROP_ID_cleanupTime] = PROP_NAME_cleanupTime;
          PROP_NAME_TO_ID.put(PROP_NAME_cleanupTime, PROP_ID_cleanupTime);
      
          PROP_ID_TO_NAME[PROP_ID_efficiencyFactor] = PROP_NAME_efficiencyFactor;
          PROP_NAME_TO_ID.put(PROP_NAME_efficiencyFactor, PROP_ID_efficiencyFactor);
    ...
    public _ErpMfgWorkcenterCapacity(){
        // for debug
    }

    protected ErpMfgWorkcenterCapacity newInstance(){
        ErpMfgWorkcenterCapacity entity = new ErpMfgWorkcenterCapacity();
    ...
    @Override
    public ErpMfgWorkcenterCapacity cloneInstance() {
        ErpMfgWorkcenterCapacity entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgWorkcenterCapacity";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_capacityPerHour:
               return getCapacityPerHour();
        
            case PROP_ID_setupTime:
               return getSetupTime();
        
            case PROP_ID_cleanupTime:
               return getCleanupTime();
        
            case PROP_ID_efficiencyFactor:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_capacityPerHour:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_capacityPerHour));
               }
               setCapacityPerHour(typedValue);
               break;
            }
            ...
            case PROP_ID_cleanupTime:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_cleanupTime));
               }
               setCleanupTime(typedValue);
               break;
            }
            ...
            case PROP_ID_efficiencyFactor:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_efficiencyFactor));
               }
               setEfficiencyFactor(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_capacityPerHour:{
               onInitProp(propId);
               this._capacityPerHour = (java.math.BigDecimal)value;
            ...
            case PROP_ID_cleanupTime:{
               onInitProp(propId);
               this._cleanupTime = (java.math.BigDecimal)value;
            ...
            case PROP_ID_efficiencyFactor:{
               onInitProp(propId);
               this._efficiencyFactor = (java.math.BigDecimal)value;
     ...
     * 每小时产能: CAPACITY_PER_HOUR
     */
    public final java.math.BigDecimal getCapacityPerHour(){
         onPropGet(PROP_ID_capacityPerHour);
     ...
     * 每小时产能: CAPACITY_PER_HOUR
     */
    public final void setCapacityPerHour(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_capacityPerHour,value)){
            this._capacityPerHour = value;
            internalClearRefs(PROP_ID_capacityPerHour);
     ...
     * 清理时间(分钟): CLEANUP_TIME
     */
    public final java.math.BigDecimal getCleanupTime(){
         onPropGet(PROP_ID_cleanupTime);
         return _cleanupTime;
    }
     ...
     * 清理时间(分钟): CLEANUP_TIME
     */
    public final void setCleanupTime(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_cleanupTime,value)){
            this._cleanupTime = value;
            internalClearRefs(PROP_ID_cleanupTime);
     ...
     * 效率系数: EFFICIENCY_FACTOR
     */
    public final java.math.BigDecimal getEfficiencyFactor(){
         onPropGet(PROP_ID_efficiencyFactor);
     ...
     * 效率系数: EFFICIENCY_FACTOR
     */
    public final void setEfficiencyFactor(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_efficiencyFactor,value)){
            this._efficiencyFactor = value;
            internalClearRefs(PROP_ID_efficiencyFactor);
