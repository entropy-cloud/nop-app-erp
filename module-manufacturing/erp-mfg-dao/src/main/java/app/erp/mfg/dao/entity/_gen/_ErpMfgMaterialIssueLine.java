...
/**
 *  领料单行: erp_mfg_material_issue_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgMaterialIssueLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 领料单ID: ISSUE_ID BIGINT */
    public static final String PROP_NAME_issueId = "issueId";
    public static final int PROP_ID_issueId = 2;
    ...
    /* 对应工单投入行: WORK_ORDER_LINE_ID BIGINT */
    public static final String PROP_NAME_workOrderLineId = "workOrderLineId";
    public static final int PROP_ID_workOrderLineId = 7;
    
    /* 应领数量: REQUIRED_QUANTITY DECIMAL */
    public static final String PROP_NAME_requiredQuantity = "requiredQuantity";
    public static final int PROP_ID_requiredQuantity = 8;
    
    /* 实领数量: ISSUED_QUANTITY DECIMAL */
    public static final String PROP_NAME_issuedQuantity = "issuedQuantity";
    public static final int PROP_ID_issuedQuantity = 9;
    
    /* 单位成本: UNIT_COST DECIMAL */
    public static final String PROP_NAME_unitCost = "unitCost";
    public static final int PROP_ID_unitCost = 10;
    
    /* 总成本: TOTAL_COST DECIMAL */
    public static final String PROP_NAME_totalCost = "totalCost";
    public static final int PROP_ID_totalCost = 11;
    ...
    public static final int PROP_ID_locationId = 13;
    ...
    /* relation:  */
    public static final String PROP_NAME_workOrderLine = "workOrderLine";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_issueId] = PROP_NAME_issueId;
          PROP_NAME_TO_ID.put(PROP_NAME_issueId, PROP_ID_issueId);
          ...
          PROP_ID_TO_NAME[PROP_ID_workOrderLineId] = PROP_NAME_workOrderLineId;
          PROP_NAME_TO_ID.put(PROP_NAME_workOrderLineId, PROP_ID_workOrderLineId);
      
          PROP_ID_TO_NAME[PROP_ID_requiredQuantity] = PROP_NAME_requiredQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_requiredQuantity, PROP_ID_requiredQuantity);
      
          PROP_ID_TO_NAME[PROP_ID_issuedQuantity] = PROP_NAME_issuedQuantity;
          PROP_NAME_TO_ID.put(PROP_NAME_issuedQuantity, PROP_ID_issuedQuantity);
    ...
    /* 领料单ID: ISSUE_ID */
    private java.lang.String _issueId;
    ...
    /* 对应工单投入行: WORK_ORDER_LINE_ID */
    private java.lang.String _workOrderLineId;
    ...
    public _ErpMfgMaterialIssueLine(){
        // for debug
    }

    protected ErpMfgMaterialIssueLine newInstance(){
        ErpMfgMaterialIssueLine entity = new ErpMfgMaterialIssueLine();
    ...
    @Override
    public ErpMfgMaterialIssueLine cloneInstance() {
        ErpMfgMaterialIssueLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgMaterialIssueLine";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_issueId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_issueId));
               }
               setIssueId(typedValue);
               break;
            }
            ...
            case PROP_ID_workOrderLineId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_workOrderLineId));
               }
               setWorkOrderLineId(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_issueId:{
               onInitProp(propId);
               this._issueId = (java.lang.String)value;
            ...
            case PROP_ID_workOrderLineId:{
               onInitProp(propId);
               this._workOrderLineId = (java.lang.String)value;
     ...
     * 领料单ID: ISSUE_ID
     */
    public final void setIssueId(java.lang.String value){
        if(onPropSet(PROP_ID_issueId,value)){
            this._issueId = value;
            internalClearRefs(PROP_ID_issueId);
     ...
     * 对应工单投入行: WORK_ORDER_LINE_ID
     */
    public final java.lang.String getWorkOrderLineId(){
         onPropGet(PROP_ID_workOrderLineId);
     ...
     * 对应工单投入行: WORK_ORDER_LINE_ID
     */
    public final void setWorkOrderLineId(java.lang.String value){
        if(onPropSet(PROP_ID_workOrderLineId,value)){
            this._workOrderLineId = value;
            internalClearRefs(PROP_ID_workOrderLineId);
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgMaterialIssue getIssue(){
       return (app.erp.mfg.dao.entity.ErpMfgMaterialIssue)internalGetRefEntity(PROP_NAME_issue);
    }

    public final void setIssue(app.erp.mfg.dao.entity.ErpMfgMaterialIssue refEntity){
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgWorkOrderLine getWorkOrderLine(){
       return (app.erp.mfg.dao.entity.ErpMfgWorkOrderLine)internalGetRefEntity(PROP_NAME_workOrderLine);
    }

    public final void setWorkOrderLine(app.erp.mfg.dao.entity.ErpMfgWorkOrderLine refEntity){
   
           if(refEntity == null){
           
                   this.setWorkOrderLineId(null);
               
           }else{
           internalSetRefEntity(PROP_NAME_workOrderLine, refEntity,()->{
           
                           this.setWorkOrderLineId(refEntity.getId());
