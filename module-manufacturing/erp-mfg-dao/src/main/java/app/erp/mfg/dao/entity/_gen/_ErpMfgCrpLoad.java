...
/**
 *  CRP负荷: erp_mfg_crp_load
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgCrpLoad extends DynamicOrmEntity{
    ...
    /* 工单(弱指针): WORK_ORDER_ID BIGINT */
    public static final String PROP_NAME_workOrderId = "workOrderId";
    public static final int PROP_ID_workOrderId = 4;
    
    /* 负荷日期: LOAD_DATE DATE */
    public static final String PROP_NAME_loadDate = "loadDate";
    public static final int PROP_ID_loadDate = 5;
    
    /* 占用工时: LOAD_HOURS DECIMAL */
    public static final String PROP_NAME_loadHours = "loadHours";
    public static final int PROP_ID_loadHours = 6;
    
    /* 换模工时: SETUP_HOURS DECIMAL */
    public static final String PROP_NAME_setupHours = "setupHours";
    public static final int PROP_ID_setupHours = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_loadDate] = PROP_NAME_loadDate;
          PROP_NAME_TO_ID.put(PROP_NAME_loadDate, PROP_ID_loadDate);
      
          PROP_ID_TO_NAME[PROP_ID_loadHours] = PROP_NAME_loadHours;
          PROP_NAME_TO_ID.put(PROP_NAME_loadHours, PROP_ID_loadHours);
      
          PROP_ID_TO_NAME[PROP_ID_setupHours] = PROP_NAME_setupHours;
          PROP_NAME_TO_ID.put(PROP_NAME_setupHours, PROP_ID_setupHours);
    ...
    public _ErpMfgCrpLoad(){
        // for debug
    }

    protected ErpMfgCrpLoad newInstance(){
        ErpMfgCrpLoad entity = new ErpMfgCrpLoad();
    ...
    @Override
    public ErpMfgCrpLoad cloneInstance() {
        ErpMfgCrpLoad entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgCrpLoad";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_loadDate:
               return getLoadDate();
        
            case PROP_ID_loadHours:
               return getLoadHours();
        
            case PROP_ID_setupHours:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_loadDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_loadDate));
               }
               setLoadDate(typedValue);
               break;
            }
            ...
            case PROP_ID_loadHours:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_loadHours));
               }
               setLoadHours(typedValue);
               break;
            }
            ...
            case PROP_ID_setupHours:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_setupHours));
               }
               setSetupHours(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_loadDate:{
               onInitProp(propId);
               this._loadDate = (java.time.LocalDate)value;
            ...
            case PROP_ID_loadHours:{
               onInitProp(propId);
               this._loadHours = (java.math.BigDecimal)value;
            ...
            case PROP_ID_setupHours:{
               onInitProp(propId);
               this._setupHours = (java.math.BigDecimal)value;
     ...
     * 负荷日期: LOAD_DATE
     */
    public final java.time.LocalDate getLoadDate(){
         onPropGet(PROP_ID_loadDate);
         return _loadDate;
    }
     ...
     * 负荷日期: LOAD_DATE
     */
    public final void setLoadDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_loadDate,value)){
            this._loadDate = value;
            internalClearRefs(PROP_ID_loadDate);
     ...
     * 占用工时: LOAD_HOURS
     */
    public final java.math.BigDecimal getLoadHours(){
         onPropGet(PROP_ID_loadHours);
         return _loadHours;
    }
     ...
     * 占用工时: LOAD_HOURS
     */
    public final void setLoadHours(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_loadHours,value)){
            this._loadHours = value;
            internalClearRefs(PROP_ID_loadHours);
     ...
     * 换模工时: SETUP_HOURS
     */
    public final java.math.BigDecimal getSetupHours(){
         onPropGet(PROP_ID_setupHours);
         return _setupHours;
    }
     ...
     * 换模工时: SETUP_HOURS
     */
    public final void setSetupHours(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_setupHours,value)){
            this._setupHours = value;
            internalClearRefs(PROP_ID_setupHours);
