...
/**
 *  MRP仿真参数: erp_mfg_mrp_scenario_param
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgMrpScenarioParam extends DynamicOrmEntity{
    ...
    /* 物料(空=全局覆盖): MATERIAL_ID BIGINT */
    public static final String PROP_NAME_materialId = "materialId";
    public static final int PROP_ID_materialId = 3;
    
    /* 参数类型: PARAM_TYPE VARCHAR */
    public static final String PROP_NAME_paramType = "paramType";
    public static final int PROP_ID_paramType = 4;
    
    /* 参数值: PARAM_VALUE DECIMAL */
    public static final String PROP_NAME_paramValue = "paramValue";
    public static final int PROP_ID_paramValue = 5;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_paramType] = PROP_NAME_paramType;
          PROP_NAME_TO_ID.put(PROP_NAME_paramType, PROP_ID_paramType);
      
          PROP_ID_TO_NAME[PROP_ID_paramValue] = PROP_NAME_paramValue;
          PROP_NAME_TO_ID.put(PROP_NAME_paramValue, PROP_ID_paramValue);
    ...
    public _ErpMfgMrpScenarioParam(){
        // for debug
    }

    protected ErpMfgMrpScenarioParam newInstance(){
        ErpMfgMrpScenarioParam entity = new ErpMfgMrpScenarioParam();
    ...
    @Override
    public ErpMfgMrpScenarioParam cloneInstance() {
        ErpMfgMrpScenarioParam entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgMrpScenarioParam";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_paramType:
               return getParamType();
        
            case PROP_ID_paramValue:
            ...
            case PROP_ID_paramType:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_paramType));
               }
               setParamType(typedValue);
               break;
            }
            ...
            case PROP_ID_paramValue:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBigDecimal(value,
                       err-> newTypeConversionError(PROP_NAME_paramValue));
               }
               setParamValue(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_paramType:{
               onInitProp(propId);
               this._paramType = (java.lang.String)value;
            ...
            case PROP_ID_paramValue:{
               onInitProp(propId);
               this._paramValue = (java.math.BigDecimal)value;
     ...
     * 参数类型: PARAM_TYPE
     */
    public final java.lang.String getParamType(){
         onPropGet(PROP_ID_paramType);
         return _paramType;
    }
     ...
     * 参数类型: PARAM_TYPE
     */
    public final void setParamType(java.lang.String value){
        if(onPropSet(PROP_ID_paramType,value)){
            this._paramType = value;
            internalClearRefs(PROP_ID_paramType);
     ...
     * 参数值: PARAM_VALUE
     */
    public final java.math.BigDecimal getParamValue(){
         onPropGet(PROP_ID_paramValue);
         return _paramValue;
    }
     ...
     * 参数值: PARAM_VALUE
     */
    public final void setParamValue(java.math.BigDecimal value){
        if(onPropSet(PROP_ID_paramValue,value)){
            this._paramValue = value;
            internalClearRefs(PROP_ID_paramValue);
