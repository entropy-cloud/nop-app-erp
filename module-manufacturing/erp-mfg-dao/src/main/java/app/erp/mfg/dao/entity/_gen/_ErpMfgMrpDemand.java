...
/**
 *  MRP独立需求: erp_mfg_mrp_demand
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgMrpDemand extends DynamicOrmEntity{
    ...
    /* 需求数量: QUANTITY DECIMAL */
    public static final String PROP_NAME_quantity = "quantity";
    public static final int PROP_ID_quantity = 9;
    
    /* 需求日期: REQUIREMENT_DATE DATE */
    public static final String PROP_NAME_requirementDate = "requirementDate";
    public static final int PROP_ID_requirementDate = 10;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_demandSource] = PROP_NAME_demandSource;
          PROP_NAME_TO_ID.put(PROP_NAME_demandSource, PROP_ID_demandSource);
          ...
          PROP_ID_TO_NAME[PROP_ID_requirementDate] = PROP_NAME_requirementDate;
          PROP_NAME_TO_ID.put(PROP_NAME_requirementDate, PROP_ID_requirementDate);
    ...
    public _ErpMfgMrpDemand(){
        // for debug
    }

    protected ErpMfgMrpDemand newInstance(){
        ErpMfgMrpDemand entity = new ErpMfgMrpDemand();
    ...
    @Override
    public ErpMfgMrpDemand cloneInstance() {
        ErpMfgMrpDemand entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgMrpDemand";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_requirementDate:
               return getRequirementDate();
            ...
            case PROP_ID_requirementDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_requirementDate));
               }
               setRequirementDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_requirementDate:{
               onInitProp(propId);
               this._requirementDate = (java.time.LocalDate)value;
     ...
     * 需求日期: REQUIREMENT_DATE
     */
    public final java.time.LocalDate getRequirementDate(){
         onPropGet(PROP_ID_requirementDate);
     ...
     * 需求日期: REQUIREMENT_DATE
     */
    public final void setRequirementDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_requirementDate,value)){
            this._requirementDate = value;
            internalClearRefs(PROP_ID_requirementDate);
