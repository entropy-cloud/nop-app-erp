...
/**
 *  BOM行: erp_mfg_bom_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgBomLine extends DynamicOrmEntity{
    ...
    public _ErpMfgBomLine(){
        // for debug
    }

    protected ErpMfgBomLine newInstance(){
        ErpMfgBomLine entity = new ErpMfgBomLine();
    ...
    @Override
    public ErpMfgBomLine cloneInstance() {
        ErpMfgBomLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgBomLine";
    }
