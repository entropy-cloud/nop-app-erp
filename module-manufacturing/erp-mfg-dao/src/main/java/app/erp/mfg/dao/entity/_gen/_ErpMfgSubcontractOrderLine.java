...
/**
 *  委外加工单行: erp_mfg_subcontract_order_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpMfgSubcontractOrderLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 委外单ID: SUBCONTRACT_ORDER_ID BIGINT */
    public static final String PROP_NAME_subcontractOrderId = "subcontractOrderId";
    public static final int PROP_ID_subcontractOrderId = 2;
    ...
    /* 委外数量: QUANTITY DECIMAL */
    public static final String PROP_NAME_quantity = "quantity";
    public static final int PROP_ID_quantity = 6;
    
    /* 单位加工费: UNIT_PROCESSING_FEE DECIMAL */
    public static final String PROP_NAME_unitProcessingFee = "unitProcessingFee";
    public static final int PROP_ID_unitProcessingFee = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_subcontractOrderId] = PROP_NAME_subcontractOrderId;
          PROP_NAME_TO_ID.put(PROP_NAME_subcontractOrderId, PROP_ID_subcontractOrderId);
          ...
          PROP_ID_TO_NAME[PROP_ID_unitProcessingFee] = PROP_NAME_unitProcessingFee;
          PROP_NAME_TO_ID.put(PROP_NAME_unitProcessingFee, PROP_ID_unitProcessingFee);
    ...
    /* 委外单ID: SUBCONTRACT_ORDER_ID */
    private java.lang.Long _subcontractOrderId;
    ...
    /* 单位加工费: UNIT_PROCESSING_FEE */
    private java.lang.String _unitProcessingFee;
    ...
    public _ErpMfgSubcontractOrderLine(){
        // for debug
    }

    protected ErpMfgSubcontractOrderLine newInstance(){
        ErpMfgSubcontractOrderLine entity = new ErpMfgSubcontractOrderLine();
    ...
    @Override
    public ErpMfgSubcontractOrderLine cloneInstance() {
        ErpMfgSubcontractOrderLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.mfg.dao.entity.ErpMfgSubcontractOrderLine";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_subcontractOrderId:
               return getSubcontractOrderId();
            ...
            case PROP_ID_unitProcessingFee:
               return getUnitProcessingFee();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_subcontractOrderId:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLong(value,
                       err-> newTypeConversionError(PROP_NAME_subcontractOrderId));
               }
               setSubcontractOrderId(typedValue);
               break;
            }
            ...
            case PROP_ID_unitProcessingFee:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_unitProcessingFee));
               }
               setUnitProcessingFee(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_subcontractOrderId:{
               onInitProp(propId);
               this._subcontractOrderId = (java.lang.Long)value;
            ...
            case PROP_ID_unitProcessingFee:{
               onInitProp(propId);
               this._unitProcessingFee = (java.lang.String)value;
     ...
     * 委外单ID: SUBCONTRACT_ORDER_ID
     */
    public final java.lang.Long getSubcontractOrderId(){
         onPropGet(PROP_ID_subcontractOrderId);
     ...
     * 委外单ID: SUBCONTRACT_ORDER_ID
     */
    public final void setSubcontractOrderId(java.lang.Long value){
        if(onPropSet(PROP_ID_subcontractOrderId,value)){
            this._subcontractOrderId = value;
            internalClearRefs(PROP_ID_subcontractOrderId);
     ...
     * 单位加工费: UNIT_PROCESSING_FEE
     */
    public final java.lang.String getUnitProcessingFee(){
         onPropGet(PROP_ID_unitProcessingFee);
     ...
     * 单位加工费: UNIT_PROCESSING_FEE
     */
    public final void setUnitProcessingFee(java.lang.String value){
        if(onPropSet(PROP_ID_unitProcessingFee,value)){
            this._unitProcessingFee = value;
            internalClearRefs(PROP_ID_unitProcessingFee);
     ...
     * 
     */
    public final app.erp.mfg.dao.entity.ErpMfgSubcontractOrder getSubcontractOrder(){
       return (app.erp.mfg.dao.entity.ErpMfgSubcontractOrder)internalGetRefEntity(PROP_NAME_subcontractOrder);
    }

    public final void setSubcontractOrder(app.erp.mfg.dao.entity.ErpMfgSubcontractOrder refEntity){
   
           if(refEntity == null){
           
                   this.setSubcontractOrderId(null);
