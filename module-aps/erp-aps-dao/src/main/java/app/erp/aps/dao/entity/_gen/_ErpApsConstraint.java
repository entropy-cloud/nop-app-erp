...
/**
 *  排产约束: erp_aps_constraint
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpApsConstraint extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_constraintType] = PROP_NAME_constraintType;
          PROP_NAME_TO_ID.put(PROP_NAME_constraintType, PROP_ID_constraintType);
    ...
    public _ErpApsConstraint(){
        // for debug
    }

    protected ErpApsConstraint newInstance(){
        ErpApsConstraint entity = new ErpApsConstraint();
    ...
    @Override
    public ErpApsConstraint cloneInstance() {
        ErpApsConstraint entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.aps.dao.entity.ErpApsConstraint";
    }
