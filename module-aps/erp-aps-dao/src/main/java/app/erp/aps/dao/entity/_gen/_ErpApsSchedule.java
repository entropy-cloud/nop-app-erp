...
/**
 *  排产方案: erp_aps_schedule
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpApsSchedule extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_scheduleDate] = PROP_NAME_scheduleDate;
          PROP_NAME_TO_ID.put(PROP_NAME_scheduleDate, PROP_ID_scheduleDate);
      
          PROP_ID_TO_NAME[PROP_ID_schedulingMode] = PROP_NAME_schedulingMode;
          PROP_NAME_TO_ID.put(PROP_NAME_schedulingMode, PROP_ID_schedulingMode);
      
          PROP_ID_TO_NAME[PROP_ID_horizonStart] = PROP_NAME_horizonStart;
          PROP_NAME_TO_ID.put(PROP_NAME_horizonStart, PROP_ID_horizonStart);
      
          PROP_ID_TO_NAME[PROP_ID_horizonEnd] = PROP_NAME_horizonEnd;
          PROP_NAME_TO_ID.put(PROP_NAME_horizonEnd, PROP_ID_horizonEnd);
    ...
    public _ErpApsSchedule(){
        // for debug
    }

    protected ErpApsSchedule newInstance(){
        ErpApsSchedule entity = new ErpApsSchedule();
    ...
    @Override
    public ErpApsSchedule cloneInstance() {
        ErpApsSchedule entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.aps.dao.entity.ErpApsSchedule";
    }
            ...
            case PROP_ID_scheduleDate:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toLocalDate(value,
                       err-> newTypeConversionError(PROP_NAME_scheduleDate));
               }
               setScheduleDate(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_scheduleDate:{
               onInitProp(propId);
               this._scheduleDate = (java.time.LocalDate)value;
     ...
     * 排产日期: SCHEDULE_DATE
     */
    public final java.time.LocalDate getScheduleDate(){
         onPropGet(PROP_ID_scheduleDate);
     ...
     * 排产日期: SCHEDULE_DATE
     */
    public final void setScheduleDate(java.time.LocalDate value){
        if(onPropSet(PROP_ID_scheduleDate,value)){
            this._scheduleDate = value;
            internalClearRefs(PROP_ID_scheduleDate);
