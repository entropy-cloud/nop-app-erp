...
alter table erp_b2b_partner_profile add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_b2b_mft_certificate add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_b2b_edi_doc add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_b2b_partner_credential add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_b2b_test_exchange add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_b2b_certification_checklist add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table erp_b2b_mft_config add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table erp_b2b_mft_log add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
