...
public interface IErpB2bPartnerProfileBiz extends ICrudBiz<ErpB2bPartnerProfile>{
     ...
     */
    @BizMutation
    ErpB2bPartnerProfile promoteToTesting(@Name("profileId") Long profileId, IServiceContext context);
     ...
     */
    @BizMutation
    ErpB2bPartnerProfile promoteToCertified(@Name("profileId") Long profileId, IServiceContext context);
