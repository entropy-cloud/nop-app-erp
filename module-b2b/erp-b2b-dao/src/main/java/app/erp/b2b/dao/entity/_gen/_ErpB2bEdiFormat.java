...
/**
 *  EDI 格式配置: erp_b2b_edi_format
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpB2bEdiFormat extends DynamicOrmEntity{
    ...
    /* 需要 WebService: NEEDS_WEB_SERVICE INTEGER */
    public static final String PROP_NAME_needsWebService = "needsWebService";
    public static final int PROP_ID_needsWebService = 7;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_formatName] = PROP_NAME_formatName;
          PROP_NAME_TO_ID.put(PROP_NAME_formatName, PROP_ID_formatName);
      
          PROP_ID_TO_NAME[PROP_ID_formatStandard] = PROP_NAME_formatStandard;
          PROP_NAME_TO_ID.put(PROP_NAME_formatStandard, PROP_ID_formatStandard);
      
          PROP_ID_TO_NAME[PROP_ID_direction] = PROP_NAME_direction;
          PROP_NAME_TO_ID.put(PROP_NAME_direction, PROP_ID_direction);
      
          PROP_ID_TO_NAME[PROP_ID_needsWebService] = PROP_NAME_needsWebService;
          PROP_NAME_TO_ID.put(PROP_NAME_needsWebService, PROP_ID_needsWebService);
    ...
    public _ErpB2bEdiFormat(){
        // for debug
    }

    protected ErpB2bEdiFormat newInstance(){
        ErpB2bEdiFormat entity = new ErpB2bEdiFormat();
    ...
    @Override
    public ErpB2bEdiFormat cloneInstance() {
        ErpB2bEdiFormat entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.b2b.dao.entity.ErpB2bEdiFormat";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_formatName:
               return getFormatName();
        
            case PROP_ID_formatStandard:
               return getFormatStandard();
        
            case PROP_ID_direction:
               return getDirection();
        
            case PROP_ID_needsWebService:
               return getNeedsWebService();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_formatName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_formatName));
               }
               setFormatName(typedValue);
               break;
            }
            ...
            case PROP_ID_needsWebService:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_needsWebService));
               }
               setNeedsWebService(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_formatName:{
               onInitProp(propId);
               this._formatName = (java.lang.String)value;
            ...
            case PROP_ID_needsWebService:{
               onInitProp(propId);
               this._needsWebService = (java.lang.Integer)value;
     ...
     * 格式名称: FORMAT_NAME
     */
    public final void setFormatName(java.lang.String value){
        if(onPropSet(PROP_ID_formatName,value)){
            this._formatName = value;
            internalClearRefs(PROP_ID_formatName);
     ...
     * 需要 WebService: NEEDS_WEB_SERVICE
     */
    public final java.lang.Integer getNeedsWebService(){
         onPropGet(PROP_ID_needsWebService);
     ...
     * 需要 WebService: NEEDS_WEB_SERVICE
     */
    public final void setNeedsWebService(java.lang.Integer value){
        if(onPropSet(PROP_ID_needsWebService,value)){
            this._needsWebService = value;
            internalClearRefs(PROP_ID_needsWebService);
