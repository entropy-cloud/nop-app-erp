...
/**
 *  ASN 明细行: erp_b2b_asn_line
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpB2bAsnLine extends DynamicOrmEntity{
    
    /* ID: ID BIGINT */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* ASN ID: ASN_ID BIGINT */
    public static final String PROP_NAME_asnId = "asnId";
    public static final int PROP_ID_asnId = 2;
    ...
    /* 供应商料号: SUPPLIER_PART_NO VARCHAR */
    public static final String PROP_NAME_supplierPartNo = "supplierPartNo";
    public static final int PROP_ID_supplierPartNo = 5;
    
    /* 订单数量: QUANTITY DECIMAL */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_asnId] = PROP_NAME_asnId;
          PROP_NAME_TO_ID.put(PROP_NAME_asnId, PROP_ID_asnId);
          ...
          PROP_ID_TO_NAME[PROP_ID_supplierPartNo] = PROP_NAME_supplierPartNo;
          PROP_NAME_TO_ID.put(PROP_NAME_supplierPartNo, PROP_ID_supplierPartNo);
    ...
    public _ErpB2bAsnLine(){
        // for debug
    }

    protected ErpB2bAsnLine newInstance(){
        ErpB2bAsnLine entity = new ErpB2bAsnLine();
    ...
    @Override
    public ErpB2bAsnLine cloneInstance() {
        ErpB2bAsnLine entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.b2b.dao.entity.ErpB2bAsnLine";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_supplierPartNo:
               return getSupplierPartNo();
            ...
            case PROP_ID_supplierPartNo:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_supplierPartNo));
               }
               setSupplierPartNo(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_supplierPartNo:{
               onInitProp(propId);
               this._supplierPartNo = (java.lang.String)value;
     ...
     * 供应商料号: SUPPLIER_PART_NO
     */
    public final java.lang.String getSupplierPartNo(){
         onPropGet(PROP_ID_supplierPartNo);
     ...
     * 供应商料号: SUPPLIER_PART_NO
     */
    public final void setSupplierPartNo(java.lang.String value){
        if(onPropSet(PROP_ID_supplierPartNo,value)){
            this._supplierPartNo = value;
            internalClearRefs(PROP_ID_supplierPartNo);
     ...
     * 
     */
    public final app.erp.b2b.dao.entity.ErpB2bAsn getAsn(){
       return (app.erp.b2b.dao.entity.ErpB2bAsn)internalGetRefEntity(PROP_NAME_asn);
    }

    public final void setAsn(app.erp.b2b.dao.entity.ErpB2bAsn refEntity){
