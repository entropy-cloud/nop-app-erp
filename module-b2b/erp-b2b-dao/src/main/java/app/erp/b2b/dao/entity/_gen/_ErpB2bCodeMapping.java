...
/**
 *  内外代码映射: erp_b2b_code_mapping
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _ErpB2bCodeMapping extends DynamicOrmEntity{
    ...
    /* 内部代码: INTERNAL_CODE VARCHAR */
    public static final String PROP_NAME_internalCode = "internalCode";
    public static final int PROP_ID_internalCode = 4;
    
    /* 外部代码: EXTERNAL_CODE VARCHAR */
    public static final String PROP_NAME_externalCode = "externalCode";
    public static final int PROP_ID_externalCode = 5;
    
    /* Trading Partner: PARTNER_ID BIGINT */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_mappingType] = PROP_NAME_mappingType;
          PROP_NAME_TO_ID.put(PROP_NAME_mappingType, PROP_ID_mappingType);
      
          PROP_ID_TO_NAME[PROP_ID_internalCode] = PROP_NAME_internalCode;
          PROP_NAME_TO_ID.put(PROP_NAME_internalCode, PROP_ID_internalCode);
      
          PROP_ID_TO_NAME[PROP_ID_externalCode] = PROP_NAME_externalCode;
          PROP_NAME_TO_ID.put(PROP_NAME_externalCode, PROP_ID_externalCode);
    ...
    /* 外部代码: EXTERNAL_CODE */
    private java.lang.String _externalCode;
    
    /* Trading Partner: PARTNER_ID */
    ...
    public _ErpB2bCodeMapping(){
        // for debug
    }

    protected ErpB2bCodeMapping newInstance(){
        ErpB2bCodeMapping entity = new ErpB2bCodeMapping();
    ...
    @Override
    public ErpB2bCodeMapping cloneInstance() {
        ErpB2bCodeMapping entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.erp.b2b.dao.entity.ErpB2bCodeMapping";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_internalCode:
               return getInternalCode();
        
            case PROP_ID_externalCode:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_internalCode:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_internalCode));
               }
               setInternalCode(typedValue);
               break;
            }
            ...
            case PROP_ID_externalCode:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_externalCode));
               }
               setExternalCode(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_internalCode:{
               onInitProp(propId);
               this._internalCode = (java.lang.String)value;
            ...
            case PROP_ID_externalCode:{
               onInitProp(propId);
               this._externalCode = (java.lang.String)value;
     ...
     * 内部代码: INTERNAL_CODE
     */
    public final java.lang.String getInternalCode(){
         onPropGet(PROP_ID_internalCode);
     ...
     * 内部代码: INTERNAL_CODE
     */
    public final void setInternalCode(java.lang.String value){
        if(onPropSet(PROP_ID_internalCode,value)){
            this._internalCode = value;
            internalClearRefs(PROP_ID_internalCode);
    ...
    public final java.lang.String getExternalCode(){
         onPropGet(PROP_ID_externalCode);
     ...
     * 外部代码: EXTERNAL_CODE
     */
    public final void setExternalCode(java.lang.String value){
        if(onPropSet(PROP_ID_externalCode,value)){
            this._externalCode = value;
            internalClearRefs(PROP_ID_externalCode);
