 ...
 *
 * <p>非法边直抛领域码 {@link ErpB2bErrors#ERR_B2B_ASN_ILLEGAL_TRANSITION}（参数 {@code action}/
 * {@code currentState}/{@code expectedState}——键对齐终码模板占位符；plan 2026-09-07-2200-1 直抛领域码，
 * {@code asnCode} 实体元数据经调用点同码补参补齐）。
 *
 * <h2>已实现迁移矩阵（2 边）</h2>
 * <ul>
...
public class ErpB2bAsnStateMachine {
    ...
    private static NopException illegal(String action, String currentStatus, String expectedStatus) {
        return new NopException(ErpB2bErrors.ERR_B2B_ASN_ILLEGAL_TRANSITION)
